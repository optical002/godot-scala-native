...
// semver, e.g. `0.1.6`). Local builds (`sbt publishLocal`) have no VERSION and
...
// first). Plain semver, matching godot-scala-native-utilities.
ThisBuild / version := sys.env.getOrElse("VERSION", "0.1.6")
