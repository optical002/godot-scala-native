...
abstract class ArrayMesh extends Mesh {
  ...
  final def addBlendShape(name: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def getBlendShapeName(index: Long): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.StringName](MethodBind.get("ArrayMesh", "get_blend_shape_name", 659327637L), hostObject.objectPtr, index)

  /** ArrayMesh.set_blend_shape_name */
  final def setBlendShapeName(index: Long, name: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def lightmapUnwrap(transform: io.github.optical002.godot.builtin.Transform3D, texel_size: Double): Long =
    Ptrcall.call2[io.github.optical002.godot.builtin.Transform3D, Double, Long](MethodBind.get("ArrayMesh", "lightmap_unwrap", 1476641071L), hostObject.objectPtr, transform, texel_size)
  ...
  final def getCustomAabb(): io.github.optical002.godot.builtin.AABB =
    Ptrcall.call0[io.github.optical002.godot.builtin.AABB](MethodBind.get("ArrayMesh", "get_custom_aabb", 1068685055L), hostObject.objectPtr)
