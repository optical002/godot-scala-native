...
abstract class InputEventAction extends InputEvent {
  ...
  final def setAction(action: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def getAction(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("InputEventAction", "get_action", 2002593661L), hostObject.objectPtr)
