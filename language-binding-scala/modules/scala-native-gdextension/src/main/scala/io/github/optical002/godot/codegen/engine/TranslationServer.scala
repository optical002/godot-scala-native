...
abstract class TranslationServer extends Object {
  ...
  final def translate(message: io.github.optical002.godot.builtin.StringName, context: io.github.optical002.godot.builtin.StringName): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call2[io.github.optical002.godot.builtin.StringName, io.github.optical002.godot.builtin.StringName, io.github.optical002.godot.builtin.StringName](MethodBind.get("TranslationServer", "translate", 1829228469L), hostObject.objectPtr, message, context)

  /** TranslationServer.translate_plural */
  final def translatePlural(message: io.github.optical002.godot.builtin.StringName, plural_message: io.github.optical002.godot.builtin.StringName, n: Long, context: io.github.optical002.godot.builtin.StringName): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call4[io.github.optical002.godot.builtin.StringName, io.github.optical002.godot.builtin.StringName, Long, io.github.optical002.godot.builtin.StringName, io.github.optical002.godot.builtin.StringName](MethodBind.get("TranslationServer", "translate_plural", 229954002L), hostObject.objectPtr, message, plural_message, n, context)
  ...
  final def hasDomain(domain: io.github.optical002.godot.builtin.StringName): Boolean =
    Ptrcall.call1[io.github.optical002.godot.builtin.StringName, Boolean](MethodBind.get("TranslationServer", "has_domain", 2619796661L), hostObject.objectPtr, domain)

  /** TranslationServer.get_or_add_domain */
  final def getOrAddDomain(domain: io.github.optical002.godot.builtin.StringName): GodotObject =
    Ptrcall.call1[io.github.optical002.godot.builtin.StringName, GodotObject](MethodBind.get("TranslationServer", "get_or_add_domain", 397200075L), hostObject.objectPtr, domain)

  /** TranslationServer.remove_domain */
  final def removeDomain(domain: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def pseudolocalize(message: io.github.optical002.godot.builtin.StringName): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call1[io.github.optical002.godot.builtin.StringName, io.github.optical002.godot.builtin.StringName](MethodBind.get("TranslationServer", "pseudolocalize", 1965194235L), hostObject.objectPtr, message)
