...
abstract class AnimatedSprite2D extends Node2D {
  ...
  final def setAnimation(name: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def getAnimation(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("AnimatedSprite2D", "get_animation", 2002593661L), hostObject.objectPtr)
  ...
  final def play(name: io.github.optical002.godot.builtin.StringName, custom_speed: Double, from_end: Boolean): Unit =
  ...
  final def playBackwards(name: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def getOffset(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("AnimatedSprite2D", "get_offset", 3341600327L), hostObject.objectPtr)
