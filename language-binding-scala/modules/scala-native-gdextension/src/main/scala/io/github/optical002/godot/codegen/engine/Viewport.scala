...
abstract class Viewport extends Node {
  ...
  final def setCanvasTransform(xform: io.github.optical002.godot.builtin.Transform2D): Unit =
  ...
  final def getCanvasTransform(): io.github.optical002.godot.builtin.Transform2D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform2D](MethodBind.get("Viewport", "get_canvas_transform", 3814499831L), hostObject.objectPtr)

  /** Viewport.set_global_canvas_transform */
  final def setGlobalCanvasTransform(xform: io.github.optical002.godot.builtin.Transform2D): Unit =
  ...
  final def getGlobalCanvasTransform(): io.github.optical002.godot.builtin.Transform2D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform2D](MethodBind.get("Viewport", "get_global_canvas_transform", 3814499831L), hostObject.objectPtr)

  /** Viewport.get_stretch_transform */
  final def getStretchTransform(): io.github.optical002.godot.builtin.Transform2D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform2D](MethodBind.get("Viewport", "get_stretch_transform", 3814499831L), hostObject.objectPtr)

  /** Viewport.get_final_transform */
  final def getFinalTransform(): io.github.optical002.godot.builtin.Transform2D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform2D](MethodBind.get("Viewport", "get_final_transform", 3814499831L), hostObject.objectPtr)

  /** Viewport.get_screen_transform */
  final def getScreenTransform(): io.github.optical002.godot.builtin.Transform2D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform2D](MethodBind.get("Viewport", "get_screen_transform", 3814499831L), hostObject.objectPtr)

  /** Viewport.get_visible_rect */
  final def getVisibleRect(): io.github.optical002.godot.builtin.Rect2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Rect2](MethodBind.get("Viewport", "get_visible_rect", 1639390495L), hostObject.objectPtr)
  ...
  final def getMousePosition(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("Viewport", "get_mouse_position", 3341600327L), hostObject.objectPtr)
