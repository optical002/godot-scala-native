...
abstract class XRNode3D extends Node3D {
  ...
  final def setTracker(tracker_name: io.github.optical002.godot.builtin.StringName): Unit =
    Ptrcall.callVoid1(MethodBind.get("XRNode3D", "set_tracker", 3304788590L), hostObject.objectPtr, tracker_name)

  /** XRNode3D.get_tracker */
  final def getTracker(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("XRNode3D", "get_tracker", 2002593661L), hostObject.objectPtr)

  /** XRNode3D.set_pose_name */
  final def setPoseName(pose: io.github.optical002.godot.builtin.StringName): Unit =
    Ptrcall.callVoid1(MethodBind.get("XRNode3D", "set_pose_name", 3304788590L), hostObject.objectPtr, pose)

  /** XRNode3D.get_pose_name */
  final def getPoseName(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("XRNode3D", "get_pose_name", 2002593661L), hostObject.objectPtr)
