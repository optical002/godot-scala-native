...
abstract class Engine extends Object {
  ...
  final def getMainLoop(): GodotObject =
    Ptrcall.call0[GodotObject](MethodBind.get("Engine", "get_main_loop", 1016888095L), hostObject.objectPtr)
  ...
  final def hasSingleton(name: io.github.optical002.godot.builtin.StringName): Boolean =
    Ptrcall.call1[io.github.optical002.godot.builtin.StringName, Boolean](MethodBind.get("Engine", "has_singleton", 2619796661L), hostObject.objectPtr, name)

  /** Engine.get_singleton */
  final def getSingleton(name: io.github.optical002.godot.builtin.StringName): GodotObject =
    Ptrcall.call1[io.github.optical002.godot.builtin.StringName, GodotObject](MethodBind.get("Engine", "get_singleton", 1371597918L), hostObject.objectPtr, name)

  /** Engine.register_singleton */
  final def registerSingleton(name: io.github.optical002.godot.builtin.StringName, instance: Object): Unit =
    Ptrcall.callVoid2(MethodBind.get("Engine", "register_singleton", 965313290L), hostObject.objectPtr, name, instance.hostObject)

  /** Engine.unregister_singleton */
  final def unregisterSingleton(name: io.github.optical002.godot.builtin.StringName): Unit =
    Ptrcall.callVoid1(MethodBind.get("Engine", "unregister_singleton", 3304788590L), hostObject.objectPtr, name)

  /** Engine.register_script_language */
  final def registerScriptLanguage(language: ScriptLanguage): Long =
    Ptrcall.call1[GodotObject, Long](MethodBind.get("Engine", "register_script_language", 1850254898L), hostObject.objectPtr, language.hostObject)

  /** Engine.unregister_script_language */
  final def unregisterScriptLanguage(language: ScriptLanguage): Long =
    Ptrcall.call1[GodotObject, Long](MethodBind.get("Engine", "unregister_script_language", 1850254898L), hostObject.objectPtr, language.hostObject)
  ...
  /** Engine.get_script_language */
  final def getScriptLanguage(index: Long): GodotObject =
    Ptrcall.call1[Long, GodotObject](MethodBind.get("Engine", "get_script_language", 2151255799L), hostObject.objectPtr, index)
