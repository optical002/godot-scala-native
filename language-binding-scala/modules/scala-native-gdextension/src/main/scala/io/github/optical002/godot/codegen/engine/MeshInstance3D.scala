...
abstract class MeshInstance3D extends GeometryInstance3D {
  ...
  final def findBlendShapeByName(name: io.github.optical002.godot.builtin.StringName): Long =
    Ptrcall.call1[io.github.optical002.godot.builtin.StringName, Long](MethodBind.get("MeshInstance3D", "find_blend_shape_by_name", 4150868206L), hostObject.objectPtr, name)
