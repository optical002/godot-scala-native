...
abstract class EditorDock extends MarginContainer {
  ...
  final def setIconName(icon_name: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def getIconName(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("EditorDock", "get_icon_name", 2002593661L), hostObject.objectPtr)
  ...
  final def setTitleColor(color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getTitleColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("EditorDock", "get_title_color", 3444240500L), hostObject.objectPtr)
