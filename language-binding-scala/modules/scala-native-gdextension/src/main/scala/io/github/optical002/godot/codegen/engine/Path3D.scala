...
abstract class Path3D extends Node3D {
  ...
  final def setDebugCustomColor(debug_custom_color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getDebugCustomColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("Path3D", "get_debug_custom_color", 3444240500L), hostObject.objectPtr)
