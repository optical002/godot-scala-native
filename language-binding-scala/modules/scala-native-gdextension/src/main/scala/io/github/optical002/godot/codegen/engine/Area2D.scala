...
abstract class Area2D extends CollisionObject2D {
  ...
  final def setGravityPointCenter(center: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getGravityPointCenter(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("Area2D", "get_gravity_point_center", 3341600327L), hostObject.objectPtr)

  /** Area2D.set_gravity_direction */
  final def setGravityDirection(direction: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getGravityDirection(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("Area2D", "get_gravity_direction", 3341600327L), hostObject.objectPtr)
  ...
  final def getAudioBusName(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("Area2D", "get_audio_bus_name", 2002593661L), hostObject.objectPtr)
