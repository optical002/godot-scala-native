...
abstract class PlaneMesh extends PrimitiveMesh {
  ...
  final def getSize(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("PlaneMesh", "get_size", 3341600327L), hostObject.objectPtr)
  ...
  final def setCenterOffset(offset: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getCenterOffset(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("PlaneMesh", "get_center_offset", 3360562783L), hostObject.objectPtr)
