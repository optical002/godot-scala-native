...
abstract class PhysicsBody3D extends CollisionObject3D {
  ...
  final def moveAndCollide(motion: io.github.optical002.godot.builtin.Vector3, test_only: Boolean, safe_margin: Double, recovery_as_collision: Boolean, max_collisions: Long): GodotObject =
    Ptrcall.call5[io.github.optical002.godot.builtin.Vector3, Boolean, Double, Boolean, Long, GodotObject](MethodBind.get("PhysicsBody3D", "move_and_collide", 3208792678L), hostObject.objectPtr, motion, test_only, safe_margin, recovery_as_collision, max_collisions)

  /** PhysicsBody3D.test_move */
  final def testMove(from: io.github.optical002.godot.builtin.Transform3D, motion: io.github.optical002.godot.builtin.Vector3, collision: KinematicCollision3D, safe_margin: Double, recovery_as_collision: Boolean, max_collisions: Long): Boolean =
    Ptrcall.call6[io.github.optical002.godot.builtin.Transform3D, io.github.optical002.godot.builtin.Vector3, GodotObject, Double, Boolean, Long, Boolean](MethodBind.get("PhysicsBody3D", "test_move", 2481691619L), hostObject.objectPtr, from, motion, collision.hostObject, safe_margin, recovery_as_collision, max_collisions)

  /** PhysicsBody3D.get_gravity */
  final def getGravity(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("PhysicsBody3D", "get_gravity", 3360562783L), hostObject.objectPtr)
