...
abstract class Skin extends Resource {
  ...
  /** Skin.add_bind */
  final def addBind(bone: Long, pose: io.github.optical002.godot.builtin.Transform3D): Unit =
    Ptrcall.callVoid2(MethodBind.get("Skin", "add_bind", 3616898986L), hostObject.objectPtr, bone, pose)

  /** Skin.add_named_bind */
  final def addNamedBind(name: String, pose: io.github.optical002.godot.builtin.Transform3D): Unit =
    Ptrcall.callVoid2(MethodBind.get("Skin", "add_named_bind", 3154712474L), hostObject.objectPtr, name, pose)

  /** Skin.set_bind_pose */
  final def setBindPose(bind_index: Long, pose: io.github.optical002.godot.builtin.Transform3D): Unit =
    Ptrcall.callVoid2(MethodBind.get("Skin", "set_bind_pose", 3616898986L), hostObject.objectPtr, bind_index, pose)

  /** Skin.get_bind_pose */
  final def getBindPose(bind_index: Long): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Transform3D](MethodBind.get("Skin", "get_bind_pose", 1965739696L), hostObject.objectPtr, bind_index)

  /** Skin.set_bind_name */
  final def setBindName(bind_index: Long, name: io.github.optical002.godot.builtin.StringName): Unit =
    Ptrcall.callVoid2(MethodBind.get("Skin", "set_bind_name", 3780747571L), hostObject.objectPtr, bind_index, name)

  /** Skin.get_bind_name */
  final def getBindName(bind_index: Long): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.StringName](MethodBind.get("Skin", "get_bind_name", 659327637L), hostObject.objectPtr, bind_index)
