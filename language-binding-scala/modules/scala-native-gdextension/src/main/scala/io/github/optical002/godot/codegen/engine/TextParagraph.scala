...
abstract class TextParagraph extends RefCounted {
  ...
  final def setDropcap(text: String, font: Font, font_size: Long, dropcap_margins: io.github.optical002.godot.builtin.Rect2, language: String): Boolean =
    Ptrcall.call5[String, GodotObject, Long, io.github.optical002.godot.builtin.Rect2, String, Boolean](MethodBind.get("TextParagraph", "set_dropcap", 2498990330L), hostObject.objectPtr, text, font.hostObject, font_size, dropcap_margins, language)
  ...
  final def getNonWrappedSize(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("TextParagraph", "get_non_wrapped_size", 3341600327L), hostObject.objectPtr)

  /** TextParagraph.get_size */
  final def getSize(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("TextParagraph", "get_size", 3341600327L), hostObject.objectPtr)

  /** TextParagraph.get_range */
  final def getRange(): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2i](MethodBind.get("TextParagraph", "get_range", 3690982128L), hostObject.objectPtr)
  ...
  final def getLineSize(line: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("TextParagraph", "get_line_size", 2299179447L), hostObject.objectPtr, line)

  /** TextParagraph.get_line_range */
  final def getLineRange(line: Long): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2i](MethodBind.get("TextParagraph", "get_line_range", 880721226L), hostObject.objectPtr, line)
  ...
  final def getDropcapSize(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("TextParagraph", "get_dropcap_size", 3341600327L), hostObject.objectPtr)
  ...
  final def hitTest(coords: io.github.optical002.godot.builtin.Vector2): Long =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2, Long](MethodBind.get("TextParagraph", "hit_test", 3820158470L), hostObject.objectPtr, coords)
