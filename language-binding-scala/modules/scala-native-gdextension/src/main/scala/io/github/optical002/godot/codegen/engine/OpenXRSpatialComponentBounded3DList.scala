...
abstract class OpenXRSpatialComponentBounded3DList extends OpenXRSpatialComponentData {
  ...
  final def getCenterPose(index: Long): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Transform3D](MethodBind.get("OpenXRSpatialComponentBounded3DList", "get_center_pose", 1965739696L), hostObject.objectPtr, index)

  /** OpenXRSpatialComponentBounded3DList.get_size */
  final def getSize(index: Long): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector3](MethodBind.get("OpenXRSpatialComponentBounded3DList", "get_size", 711720468L), hostObject.objectPtr, index)
