...
abstract class RayCast3D extends Node3D {
  ...
  final def getTargetPosition(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("RayCast3D", "get_target_position", 3360562783L), hostObject.objectPtr)
  ...
  final def getCollisionPoint(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("RayCast3D", "get_collision_point", 3360562783L), hostObject.objectPtr)

  /** RayCast3D.get_collision_normal */
  final def getCollisionNormal(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("RayCast3D", "get_collision_normal", 3360562783L), hostObject.objectPtr)
  ...
  final def getDebugShapeCustomColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("RayCast3D", "get_debug_shape_custom_color", 3444240500L), hostObject.objectPtr)
