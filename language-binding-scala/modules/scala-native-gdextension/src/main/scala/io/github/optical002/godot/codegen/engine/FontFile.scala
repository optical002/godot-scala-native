...
abstract class FontFile extends Font {
  ...
  final def removeSizeCache(cache_index: Long, size: io.github.optical002.godot.builtin.Vector2i): Unit =
  ...
  final def setTransform(cache_index: Long, transform: io.github.optical002.godot.builtin.Transform2D): Unit =
  ...
  final def getTransform(cache_index: Long): io.github.optical002.godot.builtin.Transform2D =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Transform2D](MethodBind.get("FontFile", "get_transform", 3836996910L), hostObject.objectPtr, cache_index)
  ...
  final def getTextureCount(cache_index: Long, size: io.github.optical002.godot.builtin.Vector2i): Long =
    Ptrcall.call2[Long, io.github.optical002.godot.builtin.Vector2i, Long](MethodBind.get("FontFile", "get_texture_count", 1987661582L), hostObject.objectPtr, cache_index, size)

  /** FontFile.clear_textures */
  final def clearTextures(cache_index: Long, size: io.github.optical002.godot.builtin.Vector2i): Unit =
  ...
  final def removeTexture(cache_index: Long, size: io.github.optical002.godot.builtin.Vector2i, texture_index: Long): Unit =
  ...
  final def setTextureImage(cache_index: Long, size: io.github.optical002.godot.builtin.Vector2i, texture_index: Long, image: Image): Unit =
  ...
  final def getTextureImage(cache_index: Long, size: io.github.optical002.godot.builtin.Vector2i, texture_index: Long): GodotObject =
    Ptrcall.call3[Long, io.github.optical002.godot.builtin.Vector2i, Long, GodotObject](MethodBind.get("FontFile", "get_texture_image", 3878418953L), hostObject.objectPtr, cache_index, size, texture_index)

  /** FontFile.clear_glyphs */
  final def clearGlyphs(cache_index: Long, size: io.github.optical002.godot.builtin.Vector2i): Unit =
  ...
  final def removeGlyph(cache_index: Long, size: io.github.optical002.godot.builtin.Vector2i, glyph: Long): Unit =
  ...
  final def setGlyphAdvance(cache_index: Long, size: Long, glyph: Long, advance: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getGlyphAdvance(cache_index: Long, size: Long, glyph: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call3[Long, Long, Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("FontFile", "get_glyph_advance", 1601573536L), hostObject.objectPtr, cache_index, size, glyph)

  /** FontFile.set_glyph_offset */
  final def setGlyphOffset(cache_index: Long, size: io.github.optical002.godot.builtin.Vector2i, glyph: Long, offset: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getGlyphOffset(cache_index: Long, size: io.github.optical002.godot.builtin.Vector2i, glyph: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call3[Long, io.github.optical002.godot.builtin.Vector2i, Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("FontFile", "get_glyph_offset", 3205412300L), hostObject.objectPtr, cache_index, size, glyph)

  /** FontFile.set_glyph_size */
  final def setGlyphSize(cache_index: Long, size: io.github.optical002.godot.builtin.Vector2i, glyph: Long, gl_size: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getGlyphSize(cache_index: Long, size: io.github.optical002.godot.builtin.Vector2i, glyph: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call3[Long, io.github.optical002.godot.builtin.Vector2i, Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("FontFile", "get_glyph_size", 3205412300L), hostObject.objectPtr, cache_index, size, glyph)

  /** FontFile.set_glyph_uv_rect */
  final def setGlyphUvRect(cache_index: Long, size: io.github.optical002.godot.builtin.Vector2i, glyph: Long, uv_rect: io.github.optical002.godot.builtin.Rect2): Unit =
  ...
  final def getGlyphUvRect(cache_index: Long, size: io.github.optical002.godot.builtin.Vector2i, glyph: Long): io.github.optical002.godot.builtin.Rect2 =
    Ptrcall.call3[Long, io.github.optical002.godot.builtin.Vector2i, Long, io.github.optical002.godot.builtin.Rect2](MethodBind.get("FontFile", "get_glyph_uv_rect", 3927917900L), hostObject.objectPtr, cache_index, size, glyph)

  /** FontFile.set_glyph_texture_idx */
  final def setGlyphTextureIdx(cache_index: Long, size: io.github.optical002.godot.builtin.Vector2i, glyph: Long, texture_idx: Long): Unit =
  ...
  final def getGlyphTextureIdx(cache_index: Long, size: io.github.optical002.godot.builtin.Vector2i, glyph: Long): Long =
    Ptrcall.call3[Long, io.github.optical002.godot.builtin.Vector2i, Long, Long](MethodBind.get("FontFile", "get_glyph_texture_idx", 1629411054L), hostObject.objectPtr, cache_index, size, glyph)
  ...
  final def removeKerning(cache_index: Long, size: Long, glyph_pair: io.github.optical002.godot.builtin.Vector2i): Unit =
  ...
  final def setKerning(cache_index: Long, size: Long, glyph_pair: io.github.optical002.godot.builtin.Vector2i, kerning: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getKerning(cache_index: Long, size: Long, glyph_pair: io.github.optical002.godot.builtin.Vector2i): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call3[Long, Long, io.github.optical002.godot.builtin.Vector2i, io.github.optical002.godot.builtin.Vector2](MethodBind.get("FontFile", "get_kerning", 1611912865L), hostObject.objectPtr, cache_index, size, glyph_pair)

  /** FontFile.render_range */
  final def renderRange(cache_index: Long, size: io.github.optical002.godot.builtin.Vector2i, start: Long, end: Long): Unit =
  ...
  final def renderGlyph(cache_index: Long, size: io.github.optical002.godot.builtin.Vector2i, index: Long): Unit =
