...
abstract class MobileVRInterface extends XRInterface {
  ...
  final def setOffsetRect(offset_rect: io.github.optical002.godot.builtin.Rect2): Unit =
  ...
  final def getOffsetRect(): io.github.optical002.godot.builtin.Rect2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Rect2](MethodBind.get("MobileVRInterface", "get_offset_rect", 1639390495L), hostObject.objectPtr)
