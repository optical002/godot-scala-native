...
abstract class VisualShaderNodeVec3Parameter extends VisualShaderNodeParameter {
  ...
  final def setDefaultValue(value: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getDefaultValue(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("VisualShaderNodeVec3Parameter", "get_default_value", 3360562783L), hostObject.objectPtr)
