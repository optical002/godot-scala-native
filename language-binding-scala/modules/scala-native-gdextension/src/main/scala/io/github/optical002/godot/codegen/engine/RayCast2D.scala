...
abstract class RayCast2D extends Node2D {
  ...
  final def getTargetPosition(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("RayCast2D", "get_target_position", 3341600327L), hostObject.objectPtr)
  ...
  final def getCollisionPoint(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("RayCast2D", "get_collision_point", 3341600327L), hostObject.objectPtr)

  /** RayCast2D.get_collision_normal */
  final def getCollisionNormal(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("RayCast2D", "get_collision_normal", 3341600327L), hostObject.objectPtr)
