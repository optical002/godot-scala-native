...
abstract class CanvasTexture extends Texture2D {
  ...
  final def setSpecularColor(color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getSpecularColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("CanvasTexture", "get_specular_color", 3444240500L), hostObject.objectPtr)
