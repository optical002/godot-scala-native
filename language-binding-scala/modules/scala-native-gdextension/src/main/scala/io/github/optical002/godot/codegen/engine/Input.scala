...
abstract class Input extends Object {
  ...
  final def isActionPressed(action: io.github.optical002.godot.builtin.StringName, exact_match: Boolean): Boolean =
    Ptrcall.call2[io.github.optical002.godot.builtin.StringName, Boolean, Boolean](MethodBind.get("Input", "is_action_pressed", 1558498928L), hostObject.objectPtr, action, exact_match)

  /** Input.is_action_just_pressed */
  final def isActionJustPressed(action: io.github.optical002.godot.builtin.StringName, exact_match: Boolean): Boolean =
    Ptrcall.call2[io.github.optical002.godot.builtin.StringName, Boolean, Boolean](MethodBind.get("Input", "is_action_just_pressed", 1558498928L), hostObject.objectPtr, action, exact_match)

  /** Input.is_action_just_released */
  final def isActionJustReleased(action: io.github.optical002.godot.builtin.StringName, exact_match: Boolean): Boolean =
    Ptrcall.call2[io.github.optical002.godot.builtin.StringName, Boolean, Boolean](MethodBind.get("Input", "is_action_just_released", 1558498928L), hostObject.objectPtr, action, exact_match)

  /** Input.is_action_just_pressed_by_event */
  final def isActionJustPressedByEvent(action: io.github.optical002.godot.builtin.StringName, event: InputEvent, exact_match: Boolean): Boolean =
    Ptrcall.call3[io.github.optical002.godot.builtin.StringName, GodotObject, Boolean, Boolean](MethodBind.get("Input", "is_action_just_pressed_by_event", 551972873L), hostObject.objectPtr, action, event.hostObject, exact_match)

  /** Input.is_action_just_released_by_event */
  final def isActionJustReleasedByEvent(action: io.github.optical002.godot.builtin.StringName, event: InputEvent, exact_match: Boolean): Boolean =
    Ptrcall.call3[io.github.optical002.godot.builtin.StringName, GodotObject, Boolean, Boolean](MethodBind.get("Input", "is_action_just_released_by_event", 551972873L), hostObject.objectPtr, action, event.hostObject, exact_match)
  ...
  final def getActionStrength(action: io.github.optical002.godot.builtin.StringName, exact_match: Boolean): Double =
    Ptrcall.call2[io.github.optical002.godot.builtin.StringName, Boolean, Double](MethodBind.get("Input", "get_action_strength", 801543509L), hostObject.objectPtr, action, exact_match)

  /** Input.get_action_raw_strength */
  final def getActionRawStrength(action: io.github.optical002.godot.builtin.StringName, exact_match: Boolean): Double =
    Ptrcall.call2[io.github.optical002.godot.builtin.StringName, Boolean, Double](MethodBind.get("Input", "get_action_raw_strength", 801543509L), hostObject.objectPtr, action, exact_match)

  /** Input.get_axis */
  final def getAxis(negative_action: io.github.optical002.godot.builtin.StringName, positive_action: io.github.optical002.godot.builtin.StringName): Double =
    Ptrcall.call2[io.github.optical002.godot.builtin.StringName, io.github.optical002.godot.builtin.StringName, Double](MethodBind.get("Input", "get_axis", 1958752504L), hostObject.objectPtr, negative_action, positive_action)

  /** Input.get_vector */
  final def getVector(negative_x: io.github.optical002.godot.builtin.StringName, positive_x: io.github.optical002.godot.builtin.StringName, negative_y: io.github.optical002.godot.builtin.StringName, positive_y: io.github.optical002.godot.builtin.StringName, deadzone: Double): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call5[io.github.optical002.godot.builtin.StringName, io.github.optical002.godot.builtin.StringName, io.github.optical002.godot.builtin.StringName, io.github.optical002.godot.builtin.StringName, Double, io.github.optical002.godot.builtin.Vector2](MethodBind.get("Input", "get_vector", 2479607902L), hostObject.objectPtr, negative_x, positive_x, negative_y, positive_y, deadzone)
  ...
  final def getJoyVibrationStrength(device: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("Input", "get_joy_vibration_strength", 3114997196L), hostObject.objectPtr, device)
  ...
  /** Input.get_gravity */
  final def getGravity(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("Input", "get_gravity", 3360562783L), hostObject.objectPtr)

  /** Input.get_accelerometer */
  final def getAccelerometer(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("Input", "get_accelerometer", 3360562783L), hostObject.objectPtr)

  /** Input.get_magnetometer */
  final def getMagnetometer(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("Input", "get_magnetometer", 3360562783L), hostObject.objectPtr)

  /** Input.get_gyroscope */
  final def getGyroscope(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("Input", "get_gyroscope", 3360562783L), hostObject.objectPtr)

  /** Input.set_gravity */
  final def setGravity(value: io.github.optical002.godot.builtin.Vector3): Unit =
    Ptrcall.callVoid1(MethodBind.get("Input", "set_gravity", 3460891852L), hostObject.objectPtr, value)

  /** Input.set_accelerometer */
  final def setAccelerometer(value: io.github.optical002.godot.builtin.Vector3): Unit =
    Ptrcall.callVoid1(MethodBind.get("Input", "set_accelerometer", 3460891852L), hostObject.objectPtr, value)

  /** Input.set_magnetometer */
  final def setMagnetometer(value: io.github.optical002.godot.builtin.Vector3): Unit =
    Ptrcall.callVoid1(MethodBind.get("Input", "set_magnetometer", 3460891852L), hostObject.objectPtr, value)

  /** Input.set_gyroscope */
  final def setGyroscope(value: io.github.optical002.godot.builtin.Vector3): Unit =
    Ptrcall.callVoid1(MethodBind.get("Input", "set_gyroscope", 3460891852L), hostObject.objectPtr, value)

  /** Input.set_joy_light */
  final def setJoyLight(device: Long, color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getLastMouseVelocity(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("Input", "get_last_mouse_velocity", 1497962370L), hostObject.objectPtr)

  /** Input.get_last_mouse_screen_velocity */
  final def getLastMouseScreenVelocity(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("Input", "get_last_mouse_screen_velocity", 1497962370L), hostObject.objectPtr)
  ...
  /** Input.action_press */
  final def actionPress(action: io.github.optical002.godot.builtin.StringName, strength: Double): Unit =
    Ptrcall.callVoid2(MethodBind.get("Input", "action_press", 1713091165L), hostObject.objectPtr, action, strength)

  /** Input.action_release */
  final def actionRelease(action: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def setCustomMouseCursor(image: Resource, shape: Long, hotspot: io.github.optical002.godot.builtin.Vector2): Unit =
