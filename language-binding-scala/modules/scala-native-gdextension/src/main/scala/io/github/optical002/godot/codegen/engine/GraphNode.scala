...
abstract class GraphNode extends GraphElement {
  ...
  final def setSlotColorLeft(slot_index: Long, color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getSlotColorLeft(slot_index: Long): io.github.optical002.godot.builtin.Color =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Color](MethodBind.get("GraphNode", "get_slot_color_left", 3457211756L), hostObject.objectPtr, slot_index)
  ...
  final def setSlotColorRight(slot_index: Long, color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getSlotColorRight(slot_index: Long): io.github.optical002.godot.builtin.Color =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Color](MethodBind.get("GraphNode", "get_slot_color_right", 3457211756L), hostObject.objectPtr, slot_index)
  ...
  final def getInputPortPosition(port_idx: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("GraphNode", "get_input_port_position", 3114997196L), hostObject.objectPtr, port_idx)
  ...
  final def getInputPortColor(port_idx: Long): io.github.optical002.godot.builtin.Color =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Color](MethodBind.get("GraphNode", "get_input_port_color", 2624840992L), hostObject.objectPtr, port_idx)
  ...
  final def getOutputPortPosition(port_idx: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("GraphNode", "get_output_port_position", 3114997196L), hostObject.objectPtr, port_idx)
  ...
  final def getOutputPortColor(port_idx: Long): io.github.optical002.godot.builtin.Color =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Color](MethodBind.get("GraphNode", "get_output_port_color", 2624840992L), hostObject.objectPtr, port_idx)
