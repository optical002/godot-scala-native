...
abstract class Image extends Resource {
  ...
  final def getSize(): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2i](MethodBind.get("Image", "get_size", 3690982128L), hostObject.objectPtr)
  ...
  /** Image.blit_rect */
  final def blitRect(src: Image, src_rect: io.github.optical002.godot.builtin.Rect2i, dst: io.github.optical002.godot.builtin.Vector2i): Unit =
    Ptrcall.callVoid3(MethodBind.get("Image", "blit_rect", 2903928755L), hostObject.objectPtr, src.hostObject, src_rect, dst)

  /** Image.blit_rect_mask */
  final def blitRectMask(src: Image, mask: Image, src_rect: io.github.optical002.godot.builtin.Rect2i, dst: io.github.optical002.godot.builtin.Vector2i): Unit =
  ...
  /** Image.blend_rect */
  final def blendRect(src: Image, src_rect: io.github.optical002.godot.builtin.Rect2i, dst: io.github.optical002.godot.builtin.Vector2i): Unit =
  ...
  final def blendRectMask(src: Image, mask: Image, src_rect: io.github.optical002.godot.builtin.Rect2i, dst: io.github.optical002.godot.builtin.Vector2i): Unit =
  ...
  /** Image.fill */
  final def fill(color: io.github.optical002.godot.builtin.Color): Unit =
    Ptrcall.callVoid1(MethodBind.get("Image", "fill", 2920490490L), hostObject.objectPtr, color)

  /** Image.fill_rect */
  final def fillRect(rect: io.github.optical002.godot.builtin.Rect2i, color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getUsedRect(): io.github.optical002.godot.builtin.Rect2i =
    Ptrcall.call0[io.github.optical002.godot.builtin.Rect2i](MethodBind.get("Image", "get_used_rect", 410525958L), hostObject.objectPtr)

  /** Image.get_region */
  final def getRegion(region: io.github.optical002.godot.builtin.Rect2i): GodotObject =
    Ptrcall.call1[io.github.optical002.godot.builtin.Rect2i, GodotObject](MethodBind.get("Image", "get_region", 2601441065L), hostObject.objectPtr, region)
  ...
  /** Image.get_pixelv */
  final def getPixelv(point: io.github.optical002.godot.builtin.Vector2i): io.github.optical002.godot.builtin.Color =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2i, io.github.optical002.godot.builtin.Color](MethodBind.get("Image", "get_pixelv", 1532707496L), hostObject.objectPtr, point)

  /** Image.get_pixel */
  final def getPixel(x: Long, y: Long): io.github.optical002.godot.builtin.Color =
    Ptrcall.call2[Long, Long, io.github.optical002.godot.builtin.Color](MethodBind.get("Image", "get_pixel", 2165839948L), hostObject.objectPtr, x, y)

  /** Image.set_pixelv */
  final def setPixelv(point: io.github.optical002.godot.builtin.Vector2i, color: io.github.optical002.godot.builtin.Color): Unit =
    Ptrcall.callVoid2(MethodBind.get("Image", "set_pixelv", 287851464L), hostObject.objectPtr, point, color)

  /** Image.set_pixel */
  final def setPixel(x: Long, y: Long, color: io.github.optical002.godot.builtin.Color): Unit =
