...
abstract class VisualShaderNodeVec2Constant extends VisualShaderNodeConstant {
  ...
  final def setConstant(constant: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getConstant(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("VisualShaderNodeVec2Constant", "get_constant", 3341600327L), hostObject.objectPtr)
