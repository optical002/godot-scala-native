...
abstract class Sprite3D extends SpriteBase3D {
  ...
  final def getRegionRect(): io.github.optical002.godot.builtin.Rect2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Rect2](MethodBind.get("Sprite3D", "get_region_rect", 1639390495L), hostObject.objectPtr)
  ...
  final def getFrameCoords(): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2i](MethodBind.get("Sprite3D", "get_frame_coords", 3690982128L), hostObject.objectPtr)
