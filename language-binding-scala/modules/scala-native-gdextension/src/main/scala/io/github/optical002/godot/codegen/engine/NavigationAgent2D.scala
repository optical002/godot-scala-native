...
abstract class NavigationAgent2D extends Node {
  ...
  final def setTargetPosition(position: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getTargetPosition(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("NavigationAgent2D", "get_target_position", 3341600327L), hostObject.objectPtr)
  ...
  final def getNextPathPosition(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("NavigationAgent2D", "get_next_path_position", 1497962370L), hostObject.objectPtr)

  /** NavigationAgent2D.set_velocity_forced */
  final def setVelocityForced(velocity: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getVelocity(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("NavigationAgent2D", "get_velocity", 1497962370L), hostObject.objectPtr)
  ...
  final def getFinalPosition(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("NavigationAgent2D", "get_final_position", 1497962370L), hostObject.objectPtr)
  ...
  final def getDebugPathCustomColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("NavigationAgent2D", "get_debug_path_custom_color", 3444240500L), hostObject.objectPtr)
