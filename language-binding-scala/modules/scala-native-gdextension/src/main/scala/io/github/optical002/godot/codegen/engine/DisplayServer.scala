...
abstract class DisplayServer extends Object {
  ...
  final def getAccentColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("DisplayServer", "get_accent_color", 3444240500L), hostObject.objectPtr)

  /** DisplayServer.get_base_color */
  final def getBaseColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("DisplayServer", "get_base_color", 3444240500L), hostObject.objectPtr)
  ...
  final def warpMouse(position: io.github.optical002.godot.builtin.Vector2i): Unit =
    Ptrcall.callVoid1(MethodBind.get("DisplayServer", "warp_mouse", 1130785943L), hostObject.objectPtr, position)

  /** DisplayServer.mouse_get_position */
  final def mouseGetPosition(): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2i](MethodBind.get("DisplayServer", "mouse_get_position", 3690982128L), hostObject.objectPtr)
  ...
  final def getDisplaySafeArea(): io.github.optical002.godot.builtin.Rect2i =
    Ptrcall.call0[io.github.optical002.godot.builtin.Rect2i](MethodBind.get("DisplayServer", "get_display_safe_area", 410525958L), hostObject.objectPtr)
  ...
  final def getScreenFromRect(rect: io.github.optical002.godot.builtin.Rect2): Long =
    Ptrcall.call1[io.github.optical002.godot.builtin.Rect2, Long](MethodBind.get("DisplayServer", "get_screen_from_rect", 741354659L), hostObject.objectPtr, rect)

  /** DisplayServer.screen_get_position */
  final def screenGetPosition(screen: Long): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2i](MethodBind.get("DisplayServer", "screen_get_position", 1725937825L), hostObject.objectPtr, screen)

  /** DisplayServer.screen_get_size */
  final def screenGetSize(screen: Long): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2i](MethodBind.get("DisplayServer", "screen_get_size", 1725937825L), hostObject.objectPtr, screen)

  /** DisplayServer.screen_get_usable_rect */
  final def screenGetUsableRect(screen: Long): io.github.optical002.godot.builtin.Rect2i =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Rect2i](MethodBind.get("DisplayServer", "screen_get_usable_rect", 2439012528L), hostObject.objectPtr, screen)
  ...
  final def screenGetPixel(position: io.github.optical002.godot.builtin.Vector2i): io.github.optical002.godot.builtin.Color =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2i, io.github.optical002.godot.builtin.Color](MethodBind.get("DisplayServer", "screen_get_pixel", 1532707496L), hostObject.objectPtr, position)
  ...
  final def screenGetImageRect(rect: io.github.optical002.godot.builtin.Rect2i): GodotObject =
    Ptrcall.call1[io.github.optical002.godot.builtin.Rect2i, GodotObject](MethodBind.get("DisplayServer", "screen_get_image_rect", 2601441065L), hostObject.objectPtr, rect)
  ...
  final def getWindowAtScreenPosition(position: io.github.optical002.godot.builtin.Vector2i): Long =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2i, Long](MethodBind.get("DisplayServer", "get_window_at_screen_position", 2485466453L), hostObject.objectPtr, position)
  ...
  final def windowSetPopupSafeRect(window: Long, rect: io.github.optical002.godot.builtin.Rect2i): Unit =
  ...
  final def windowGetPopupSafeRect(window: Long): io.github.optical002.godot.builtin.Rect2i =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Rect2i](MethodBind.get("DisplayServer", "window_get_popup_safe_rect", 2161169500L), hostObject.objectPtr, window)
  ...
  final def windowGetTitleSize(title: String, window_id: Long): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call2[String, Long, io.github.optical002.godot.builtin.Vector2i](MethodBind.get("DisplayServer", "window_get_title_size", 2925301799L), hostObject.objectPtr, title, window_id)
  ...
  final def windowGetPosition(window_id: Long): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2i](MethodBind.get("DisplayServer", "window_get_position", 763922886L), hostObject.objectPtr, window_id)

  /** DisplayServer.window_get_position_with_decorations */
  final def windowGetPositionWithDecorations(window_id: Long): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2i](MethodBind.get("DisplayServer", "window_get_position_with_decorations", 763922886L), hostObject.objectPtr, window_id)

  /** DisplayServer.window_set_position */
  final def windowSetPosition(position: io.github.optical002.godot.builtin.Vector2i, window_id: Long): Unit =
  ...
  final def windowGetSize(window_id: Long): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2i](MethodBind.get("DisplayServer", "window_get_size", 763922886L), hostObject.objectPtr, window_id)

  /** DisplayServer.window_set_size */
  final def windowSetSize(size: io.github.optical002.godot.builtin.Vector2i, window_id: Long): Unit =
  ...
  final def windowGetMaxSize(window_id: Long): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2i](MethodBind.get("DisplayServer", "window_get_max_size", 763922886L), hostObject.objectPtr, window_id)

  /** DisplayServer.window_set_max_size */
  final def windowSetMaxSize(max_size: io.github.optical002.godot.builtin.Vector2i, window_id: Long): Unit =
  ...
  final def windowGetMinSize(window_id: Long): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2i](MethodBind.get("DisplayServer", "window_get_min_size", 763922886L), hostObject.objectPtr, window_id)

  /** DisplayServer.window_set_min_size */
  final def windowSetMinSize(min_size: io.github.optical002.godot.builtin.Vector2i, window_id: Long): Unit =
  ...
  final def windowGetSizeWithDecorations(window_id: Long): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2i](MethodBind.get("DisplayServer", "window_get_size_with_decorations", 763922886L), hostObject.objectPtr, window_id)
  ...
  final def windowSetWindowButtonsOffset(offset: io.github.optical002.godot.builtin.Vector2i, window_id: Long): Unit =
  ...
  final def windowGetSafeTitleMargins(window_id: Long): io.github.optical002.godot.builtin.Vector3i =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector3i](MethodBind.get("DisplayServer", "window_get_safe_title_margins", 2295066620L), hostObject.objectPtr, window_id)
  ...
  final def windowSetImePosition(position: io.github.optical002.godot.builtin.Vector2i, window_id: Long): Unit =
  ...
  final def windowSetColor(color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def accessibilitySetWindowRect(window_id: Long, rect_out: io.github.optical002.godot.builtin.Rect2, rect_in: io.github.optical002.godot.builtin.Rect2): Unit =
  ...
  final def imeGetSelection(): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2i](MethodBind.get("DisplayServer", "ime_get_selection", 3690982128L), hostObject.objectPtr)
  ...
  final def virtualKeyboardShow(existing_text: String, position: io.github.optical002.godot.builtin.Rect2, `type`: Long, max_length: Long, cursor_start: Long, cursor_end: Long): Unit =
  ...
  final def cursorSetCustomImage(cursor: Resource, shape: Long, hotspot: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def statusIndicatorGetRect(id: Long): io.github.optical002.godot.builtin.Rect2 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Rect2](MethodBind.get("DisplayServer", "status_indicator_get_rect", 3327874267L), hostObject.objectPtr, id)
