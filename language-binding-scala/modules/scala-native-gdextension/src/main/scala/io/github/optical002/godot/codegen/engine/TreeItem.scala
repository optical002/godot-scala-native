...
abstract class TreeItem extends Object {
  ...
  final def setIconRegion(column: Long, region: io.github.optical002.godot.builtin.Rect2): Unit =
  ...
  final def getIconRegion(column: Long): io.github.optical002.godot.builtin.Rect2 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Rect2](MethodBind.get("TreeItem", "get_icon_region", 3327874267L), hostObject.objectPtr, column)
  ...
  final def setIconModulate(column: Long, modulate: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getIconModulate(column: Long): io.github.optical002.godot.builtin.Color =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Color](MethodBind.get("TreeItem", "get_icon_modulate", 3457211756L), hostObject.objectPtr, column)
  ...
  final def setCustomDraw(column: Long, `object`: Object, callback: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def setCustomColor(column: Long, color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getCustomColor(column: Long): io.github.optical002.godot.builtin.Color =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Color](MethodBind.get("TreeItem", "get_custom_color", 3457211756L), hostObject.objectPtr, column)
  ...
  final def setCustomBgColor(column: Long, color: io.github.optical002.godot.builtin.Color, just_outline: Boolean): Unit =
  ...
  final def getCustomBgColor(column: Long): io.github.optical002.godot.builtin.Color =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Color](MethodBind.get("TreeItem", "get_custom_bg_color", 3457211756L), hostObject.objectPtr, column)
  ...
  final def getButtonColor(column: Long, id: Long): io.github.optical002.godot.builtin.Color =
    Ptrcall.call2[Long, Long, io.github.optical002.godot.builtin.Color](MethodBind.get("TreeItem", "get_button_color", 2165839948L), hostObject.objectPtr, column, id)
  ...
  final def setButtonColor(column: Long, button_index: Long, color: io.github.optical002.godot.builtin.Color): Unit =
