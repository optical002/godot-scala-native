...
abstract class PhysicsDirectBodyState2D extends Object {
  ...
  final def getTotalGravity(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("PhysicsDirectBodyState2D", "get_total_gravity", 3341600327L), hostObject.objectPtr)
  ...
  final def getCenterOfMass(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("PhysicsDirectBodyState2D", "get_center_of_mass", 3341600327L), hostObject.objectPtr)

  /** PhysicsDirectBodyState2D.get_center_of_mass_local */
  final def getCenterOfMassLocal(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("PhysicsDirectBodyState2D", "get_center_of_mass_local", 3341600327L), hostObject.objectPtr)
  ...
  final def setLinearVelocity(velocity: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getLinearVelocity(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("PhysicsDirectBodyState2D", "get_linear_velocity", 3341600327L), hostObject.objectPtr)
  ...
  final def getTransform(): io.github.optical002.godot.builtin.Transform2D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform2D](MethodBind.get("PhysicsDirectBodyState2D", "get_transform", 3814499831L), hostObject.objectPtr)

  /** PhysicsDirectBodyState2D.get_velocity_at_local_position */
  final def getVelocityAtLocalPosition(local_position: io.github.optical002.godot.builtin.Vector2): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2, io.github.optical002.godot.builtin.Vector2](MethodBind.get("PhysicsDirectBodyState2D", "get_velocity_at_local_position", 2656412154L), hostObject.objectPtr, local_position)

  /** PhysicsDirectBodyState2D.apply_central_impulse */
  final def applyCentralImpulse(impulse: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def applyImpulse(impulse: io.github.optical002.godot.builtin.Vector2, position: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def applyCentralForce(force: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def applyForce(force: io.github.optical002.godot.builtin.Vector2, position: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def addConstantCentralForce(force: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def addConstantForce(force: io.github.optical002.godot.builtin.Vector2, position: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def setConstantForce(force: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getConstantForce(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("PhysicsDirectBodyState2D", "get_constant_force", 3341600327L), hostObject.objectPtr)
  ...
  final def getContactLocalPosition(contact_idx: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("PhysicsDirectBodyState2D", "get_contact_local_position", 2299179447L), hostObject.objectPtr, contact_idx)

  /** PhysicsDirectBodyState2D.get_contact_local_normal */
  final def getContactLocalNormal(contact_idx: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("PhysicsDirectBodyState2D", "get_contact_local_normal", 2299179447L), hostObject.objectPtr, contact_idx)
  ...
  final def getContactLocalVelocityAtPosition(contact_idx: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("PhysicsDirectBodyState2D", "get_contact_local_velocity_at_position", 2299179447L), hostObject.objectPtr, contact_idx)

  /** PhysicsDirectBodyState2D.get_contact_collider_position */
  final def getContactColliderPosition(contact_idx: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("PhysicsDirectBodyState2D", "get_contact_collider_position", 2299179447L), hostObject.objectPtr, contact_idx)
  ...
  final def getContactColliderVelocityAtPosition(contact_idx: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("PhysicsDirectBodyState2D", "get_contact_collider_velocity_at_position", 2299179447L), hostObject.objectPtr, contact_idx)

  /** PhysicsDirectBodyState2D.get_contact_impulse */
  final def getContactImpulse(contact_idx: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("PhysicsDirectBodyState2D", "get_contact_impulse", 2299179447L), hostObject.objectPtr, contact_idx)
