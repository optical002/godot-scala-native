...
abstract class VisualShaderNodeVec2Parameter extends VisualShaderNodeParameter {
  ...
  final def setDefaultValue(value: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getDefaultValue(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("VisualShaderNodeVec2Parameter", "get_default_value", 3341600327L), hostObject.objectPtr)
