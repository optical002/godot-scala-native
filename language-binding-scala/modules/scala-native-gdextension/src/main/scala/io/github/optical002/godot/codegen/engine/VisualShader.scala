...
abstract class VisualShader extends Shader {
  ...
  final def addNode(`type`: Long, node: VisualShaderNode, position: io.github.optical002.godot.builtin.Vector2, id: Long): Unit =
  ...
  final def setNodePosition(`type`: Long, id: Long, position: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getNodePosition(`type`: Long, id: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call2[Long, Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("VisualShader", "get_node_position", 2175036082L), hostObject.objectPtr, `type`, id)
  ...
  final def replaceNode(`type`: Long, id: Long, new_class: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def getGraphOffset(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("VisualShader", "get_graph_offset", 3341600327L), hostObject.objectPtr)
