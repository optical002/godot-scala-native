...
abstract class Script extends Resource {
  ...
  final def getInstanceBaseType(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("Script", "get_instance_base_type", 2002593661L), hostObject.objectPtr)

  /** Script.get_global_name */
  final def getGlobalName(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("Script", "get_global_name", 2002593661L), hostObject.objectPtr)

  /** Script.has_script_signal */
  final def hasScriptSignal(signal_name: io.github.optical002.godot.builtin.StringName): Boolean =
    Ptrcall.call1[io.github.optical002.godot.builtin.StringName, Boolean](MethodBind.get("Script", "has_script_signal", 2619796661L), hostObject.objectPtr, signal_name)
