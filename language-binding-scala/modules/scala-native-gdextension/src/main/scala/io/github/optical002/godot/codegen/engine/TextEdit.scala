...
abstract class TextEdit extends Control {
  ...
  final def getNextVisibleLineIndexOffsetFrom(line: Long, wrap_index: Long, visible_amount: Long): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call3[Long, Long, Long, io.github.optical002.godot.builtin.Vector2i](MethodBind.get("TextEdit", "get_next_visible_line_index_offset_from", 3386475622L), hostObject.objectPtr, line, wrap_index, visible_amount)
  ...
  /** TextEdit.search */
  final def search(text: String, flags: Long, from_line: Long, from_column: Long): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call4[String, Long, Long, Long, io.github.optical002.godot.builtin.Vector2i](MethodBind.get("TextEdit", "search", 1203739136L), hostObject.objectPtr, text, flags, from_line, from_column)

  /** TextEdit.get_local_mouse_pos */
  final def getLocalMousePos(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("TextEdit", "get_local_mouse_pos", 3341600327L), hostObject.objectPtr)

  /** TextEdit.get_word_at_pos */
  final def getWordAtPos(position: io.github.optical002.godot.builtin.Vector2): String =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2, String](MethodBind.get("TextEdit", "get_word_at_pos", 3674420000L), hostObject.objectPtr, position)

  /** TextEdit.get_line_column_at_pos */
  final def getLineColumnAtPos(position: io.github.optical002.godot.builtin.Vector2i, clamp_line: Boolean, clamp_column: Boolean): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call3[io.github.optical002.godot.builtin.Vector2i, Boolean, Boolean, io.github.optical002.godot.builtin.Vector2i](MethodBind.get("TextEdit", "get_line_column_at_pos", 3472935744L), hostObject.objectPtr, position, clamp_line, clamp_column)

  /** TextEdit.get_pos_at_line_column */
  final def getPosAtLineColumn(line: Long, column: Long): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call2[Long, Long, io.github.optical002.godot.builtin.Vector2i](MethodBind.get("TextEdit", "get_pos_at_line_column", 410388347L), hostObject.objectPtr, line, column)

  /** TextEdit.get_rect_at_line_column */
  final def getRectAtLineColumn(line: Long, column: Long): io.github.optical002.godot.builtin.Rect2i =
    Ptrcall.call2[Long, Long, io.github.optical002.godot.builtin.Rect2i](MethodBind.get("TextEdit", "get_rect_at_line_column", 3256618057L), hostObject.objectPtr, line, column)

  /** TextEdit.get_minimap_line_at_pos */
  final def getMinimapLineAtPos(position: io.github.optical002.godot.builtin.Vector2i): Long =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2i, Long](MethodBind.get("TextEdit", "get_minimap_line_at_pos", 2485466453L), hostObject.objectPtr, position)
  ...
  final def getCaretDrawPos(caret_index: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("TextEdit", "get_caret_draw_pos", 478253731L), hostObject.objectPtr, caret_index)
  ...
  final def setLineGutterItemColor(line: Long, gutter: Long, color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getLineGutterItemColor(line: Long, gutter: Long): io.github.optical002.godot.builtin.Color =
    Ptrcall.call2[Long, Long, io.github.optical002.godot.builtin.Color](MethodBind.get("TextEdit", "get_line_gutter_item_color", 2165839948L), hostObject.objectPtr, line, gutter)
  ...
  final def setLineBackgroundColor(line: Long, color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getLineBackgroundColor(line: Long): io.github.optical002.godot.builtin.Color =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Color](MethodBind.get("TextEdit", "get_line_background_color", 3457211756L), hostObject.objectPtr, line)
