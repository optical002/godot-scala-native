...
abstract class Font extends Resource {
  ...
  /** Font.get_char_size */
  final def getCharSize(char: Long, font_size: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call2[Long, Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("Font", "get_char_size", 3016396712L), hostObject.objectPtr, char, font_size)
