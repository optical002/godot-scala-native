...
abstract class PhysicsRayQueryParameters3D extends RefCounted {
  ...
  final def setFrom(from: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getFrom(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("PhysicsRayQueryParameters3D", "get_from", 3360562783L), hostObject.objectPtr)

  /** PhysicsRayQueryParameters3D.set_to */
  final def setTo(to: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getTo(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("PhysicsRayQueryParameters3D", "get_to", 3360562783L), hostObject.objectPtr)
