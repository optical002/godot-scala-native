...
abstract class ItemList extends Control {
  ...
  final def setItemIconRegion(idx: Long, rect: io.github.optical002.godot.builtin.Rect2): Unit =
  ...
  final def getItemIconRegion(idx: Long): io.github.optical002.godot.builtin.Rect2 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Rect2](MethodBind.get("ItemList", "get_item_icon_region", 3327874267L), hostObject.objectPtr, idx)

  /** ItemList.set_item_icon_modulate */
  final def setItemIconModulate(idx: Long, modulate: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getItemIconModulate(idx: Long): io.github.optical002.godot.builtin.Color =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Color](MethodBind.get("ItemList", "get_item_icon_modulate", 3457211756L), hostObject.objectPtr, idx)
  ...
  final def setItemCustomBgColor(idx: Long, custom_bg_color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getItemCustomBgColor(idx: Long): io.github.optical002.godot.builtin.Color =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Color](MethodBind.get("ItemList", "get_item_custom_bg_color", 3457211756L), hostObject.objectPtr, idx)

  /** ItemList.set_item_custom_fg_color */
  final def setItemCustomFgColor(idx: Long, custom_fg_color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getItemCustomFgColor(idx: Long): io.github.optical002.godot.builtin.Color =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Color](MethodBind.get("ItemList", "get_item_custom_fg_color", 3457211756L), hostObject.objectPtr, idx)

  /** ItemList.get_item_rect */
  final def getItemRect(idx: Long, expand: Boolean): io.github.optical002.godot.builtin.Rect2 =
    Ptrcall.call2[Long, Boolean, io.github.optical002.godot.builtin.Rect2](MethodBind.get("ItemList", "get_item_rect", 159227807L), hostObject.objectPtr, idx, expand)
  ...
  final def setFixedIconSize(size: io.github.optical002.godot.builtin.Vector2i): Unit =
  ...
  final def getFixedIconSize(): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2i](MethodBind.get("ItemList", "get_fixed_icon_size", 3690982128L), hostObject.objectPtr)
  ...
  final def getItemAtPosition(position: io.github.optical002.godot.builtin.Vector2, exact: Boolean): Long =
    Ptrcall.call2[io.github.optical002.godot.builtin.Vector2, Boolean, Long](MethodBind.get("ItemList", "get_item_at_position", 2300324924L), hostObject.objectPtr, position, exact)
