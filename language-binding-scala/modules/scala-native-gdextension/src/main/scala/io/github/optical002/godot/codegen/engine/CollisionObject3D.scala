...
abstract class CollisionObject3D extends Node3D {
  ...
  final def shapeOwnerSetTransform(owner_id: Long, transform: io.github.optical002.godot.builtin.Transform3D): Unit =
  ...
  final def shapeOwnerGetTransform(owner_id: Long): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Transform3D](MethodBind.get("CollisionObject3D", "shape_owner_get_transform", 1965739696L), hostObject.objectPtr, owner_id)
