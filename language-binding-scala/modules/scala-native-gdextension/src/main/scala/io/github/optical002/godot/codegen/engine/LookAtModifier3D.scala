...
abstract class LookAtModifier3D extends SkeletonModifier3D {
  ...
  final def setOriginOffset(offset: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getOriginOffset(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("LookAtModifier3D", "get_origin_offset", 3360562783L), hostObject.objectPtr)
