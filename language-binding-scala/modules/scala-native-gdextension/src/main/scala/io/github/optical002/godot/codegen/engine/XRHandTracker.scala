...
abstract class XRHandTracker extends XRPositionalTracker {
  ...
  final def setHandJointTransform(joint: Long, transform: io.github.optical002.godot.builtin.Transform3D): Unit =
  ...
  final def getHandJointTransform(joint: Long): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Transform3D](MethodBind.get("XRHandTracker", "get_hand_joint_transform", 1090840196L), hostObject.objectPtr, joint)
  ...
  final def setHandJointLinearVelocity(joint: Long, linear_velocity: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getHandJointLinearVelocity(joint: Long): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector3](MethodBind.get("XRHandTracker", "get_hand_joint_linear_velocity", 547240792L), hostObject.objectPtr, joint)

  /** XRHandTracker.set_hand_joint_angular_velocity */
  final def setHandJointAngularVelocity(joint: Long, angular_velocity: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getHandJointAngularVelocity(joint: Long): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector3](MethodBind.get("XRHandTracker", "get_hand_joint_angular_velocity", 547240792L), hostObject.objectPtr, joint)
