...
abstract class NavigationMesh extends Resource {
  ...
  final def setSourceGroupName(mask: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def getSourceGroupName(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("NavigationMesh", "get_source_group_name", 2002593661L), hostObject.objectPtr)
  ...
  final def setFilterBakingAabb(baking_aabb: io.github.optical002.godot.builtin.AABB): Unit =
  ...
  final def getFilterBakingAabb(): io.github.optical002.godot.builtin.AABB =
    Ptrcall.call0[io.github.optical002.godot.builtin.AABB](MethodBind.get("NavigationMesh", "get_filter_baking_aabb", 1068685055L), hostObject.objectPtr)

  /** NavigationMesh.set_filter_baking_aabb_offset */
  final def setFilterBakingAabbOffset(baking_aabb_offset: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getFilterBakingAabbOffset(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("NavigationMesh", "get_filter_baking_aabb_offset", 3360562783L), hostObject.objectPtr)
