...
abstract class Node2D extends CanvasItem {
  ...
  final def setTransform(xform: io.github.optical002.godot.builtin.Transform2D): Unit =
    Ptrcall.callVoid1(MethodBind.get("Node2D", "set_transform", 2761652528L), hostObject.objectPtr, xform)

  /** Node2D.set_global_transform */
  final def setGlobalTransform(xform: io.github.optical002.godot.builtin.Transform2D): Unit =
  ...
  final def getRelativeTransformToParent(parent: Node): io.github.optical002.godot.builtin.Transform2D =
    Ptrcall.call1[GodotObject, io.github.optical002.godot.builtin.Transform2D](MethodBind.get("Node2D", "get_relative_transform_to_parent", 904556875L), hostObject.objectPtr, parent.hostObject)
