...
abstract class OpenXRInterface extends XRInterface {
  ...
  final def getHandJointRotation(hand: Long, joint: Long): io.github.optical002.godot.builtin.Quaternion =
    Ptrcall.call2[Long, Long, io.github.optical002.godot.builtin.Quaternion](MethodBind.get("OpenXRInterface", "get_hand_joint_rotation", 1974618321L), hostObject.objectPtr, hand, joint)

  /** OpenXRInterface.get_hand_joint_position */
  final def getHandJointPosition(hand: Long, joint: Long): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call2[Long, Long, io.github.optical002.godot.builtin.Vector3](MethodBind.get("OpenXRInterface", "get_hand_joint_position", 3529194242L), hostObject.objectPtr, hand, joint)
  ...
  final def getHandJointLinearVelocity(hand: Long, joint: Long): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call2[Long, Long, io.github.optical002.godot.builtin.Vector3](MethodBind.get("OpenXRInterface", "get_hand_joint_linear_velocity", 3529194242L), hostObject.objectPtr, hand, joint)

  /** OpenXRInterface.get_hand_joint_angular_velocity */
  final def getHandJointAngularVelocity(hand: Long, joint: Long): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call2[Long, Long, io.github.optical002.godot.builtin.Vector3](MethodBind.get("OpenXRInterface", "get_hand_joint_angular_velocity", 3529194242L), hostObject.objectPtr, hand, joint)
