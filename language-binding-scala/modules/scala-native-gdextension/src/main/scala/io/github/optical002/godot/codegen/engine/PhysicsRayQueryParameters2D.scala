...
abstract class PhysicsRayQueryParameters2D extends RefCounted {
  ...
  final def setFrom(from: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getFrom(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("PhysicsRayQueryParameters2D", "get_from", 3341600327L), hostObject.objectPtr)

  /** PhysicsRayQueryParameters2D.set_to */
  final def setTo(to: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getTo(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("PhysicsRayQueryParameters2D", "get_to", 3341600327L), hostObject.objectPtr)
