...
abstract class Light3D extends VisualInstance3D {
  ...
  final def getColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("Light3D", "get_color", 3444240500L), hostObject.objectPtr)
  ...
  final def getCorrelatedColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("Light3D", "get_correlated_color", 3444240500L), hostObject.objectPtr)
