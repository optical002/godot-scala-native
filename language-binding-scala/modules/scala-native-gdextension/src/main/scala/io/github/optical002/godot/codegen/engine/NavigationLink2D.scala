...
abstract class NavigationLink2D extends Node2D {
  ...
  final def setStartPosition(position: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getStartPosition(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("NavigationLink2D", "get_start_position", 3341600327L), hostObject.objectPtr)

  /** NavigationLink2D.set_end_position */
  final def setEndPosition(position: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getEndPosition(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("NavigationLink2D", "get_end_position", 3341600327L), hostObject.objectPtr)

  /** NavigationLink2D.set_global_start_position */
  final def setGlobalStartPosition(position: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getGlobalStartPosition(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("NavigationLink2D", "get_global_start_position", 3341600327L), hostObject.objectPtr)

  /** NavigationLink2D.set_global_end_position */
  final def setGlobalEndPosition(position: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getGlobalEndPosition(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("NavigationLink2D", "get_global_end_position", 3341600327L), hostObject.objectPtr)
