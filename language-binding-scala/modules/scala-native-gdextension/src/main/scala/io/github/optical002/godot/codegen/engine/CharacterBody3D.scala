...
abstract class CharacterBody3D extends PhysicsBody3D {
  ...
  final def setVelocity(velocity: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getVelocity(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("CharacterBody3D", "get_velocity", 3360562783L), hostObject.objectPtr)
  ...
  final def getUpDirection(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("CharacterBody3D", "get_up_direction", 3360562783L), hostObject.objectPtr)

  /** CharacterBody3D.set_up_direction */
  final def setUpDirection(up_direction: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getFloorNormal(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("CharacterBody3D", "get_floor_normal", 3360562783L), hostObject.objectPtr)

  /** CharacterBody3D.get_wall_normal */
  final def getWallNormal(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("CharacterBody3D", "get_wall_normal", 3360562783L), hostObject.objectPtr)

  /** CharacterBody3D.get_last_motion */
  final def getLastMotion(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("CharacterBody3D", "get_last_motion", 3360562783L), hostObject.objectPtr)

  /** CharacterBody3D.get_position_delta */
  final def getPositionDelta(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("CharacterBody3D", "get_position_delta", 3360562783L), hostObject.objectPtr)

  /** CharacterBody3D.get_real_velocity */
  final def getRealVelocity(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("CharacterBody3D", "get_real_velocity", 3360562783L), hostObject.objectPtr)

  /** CharacterBody3D.get_floor_angle */
  final def getFloorAngle(up_direction: io.github.optical002.godot.builtin.Vector3): Double =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector3, Double](MethodBind.get("CharacterBody3D", "get_floor_angle", 2906300789L), hostObject.objectPtr, up_direction)

  /** CharacterBody3D.get_platform_velocity */
  final def getPlatformVelocity(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("CharacterBody3D", "get_platform_velocity", 3360562783L), hostObject.objectPtr)

  /** CharacterBody3D.get_platform_angular_velocity */
  final def getPlatformAngularVelocity(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("CharacterBody3D", "get_platform_angular_velocity", 3360562783L), hostObject.objectPtr)
