...
abstract class NavigationPathQueryParameters3D extends RefCounted {
  ...
  final def setStartPosition(start_position: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getStartPosition(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("NavigationPathQueryParameters3D", "get_start_position", 3360562783L), hostObject.objectPtr)

  /** NavigationPathQueryParameters3D.set_target_position */
  final def setTargetPosition(target_position: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getTargetPosition(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("NavigationPathQueryParameters3D", "get_target_position", 3360562783L), hostObject.objectPtr)
...
object NavigationPathQueryParameters3D {
  /** Class metadata for Gd[NavigationPathQueryParameters3D] lifetime management and casting. */
  given GodotClass[NavigationPathQueryParameters3D] with {
    def className = "NavigationPathQueryParameters3D"
    def isRefCounted = true
    def wrap(o: GodotObject): NavigationPathQueryParameters3D = new NavigationPathQueryParameters3D {}.withHost(o.objectPtr)
    def unwrap(t: NavigationPathQueryParameters3D): GodotObject = t.hostObject
  }
}
