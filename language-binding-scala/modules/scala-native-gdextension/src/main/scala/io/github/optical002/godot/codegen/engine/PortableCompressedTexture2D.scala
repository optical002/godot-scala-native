...
abstract class PortableCompressedTexture2D extends Texture2D {
  ...
  final def setSizeOverride(size: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getSizeOverride(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("PortableCompressedTexture2D", "get_size_override", 3341600327L), hostObject.objectPtr)
