...
abstract class SegmentShape2D extends Shape2D {
  ...
  final def setA(a: io.github.optical002.godot.builtin.Vector2): Unit =
    Ptrcall.callVoid1(MethodBind.get("SegmentShape2D", "set_a", 743155724L), hostObject.objectPtr, a)

  /** SegmentShape2D.get_a */
  final def getA(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("SegmentShape2D", "get_a", 3341600327L), hostObject.objectPtr)

  /** SegmentShape2D.set_b */
  final def setB(b: io.github.optical002.godot.builtin.Vector2): Unit =
    Ptrcall.callVoid1(MethodBind.get("SegmentShape2D", "set_b", 743155724L), hostObject.objectPtr, b)

  /** SegmentShape2D.get_b */
  final def getB(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("SegmentShape2D", "get_b", 3341600327L), hostObject.objectPtr)
