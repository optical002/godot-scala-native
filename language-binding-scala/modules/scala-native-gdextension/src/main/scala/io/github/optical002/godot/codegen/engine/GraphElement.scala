...
abstract class GraphElement extends Container {
  ...
  final def setPositionOffset(offset: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getPositionOffset(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("GraphElement", "get_position_offset", 3341600327L), hostObject.objectPtr)
