...
abstract class AudioListener3D extends Node3D {
  ...
  final def getListenerTransform(): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform3D](MethodBind.get("AudioListener3D", "get_listener_transform", 3229777777L), hostObject.objectPtr)
