...
abstract class XRPose extends RefCounted {
  ...
  final def getName(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("XRPose", "get_name", 2002593661L), hostObject.objectPtr)
  ...
  final def getTransform(): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform3D](MethodBind.get("XRPose", "get_transform", 3229777777L), hostObject.objectPtr)

  /** XRPose.get_adjusted_transform */
  final def getAdjustedTransform(): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform3D](MethodBind.get("XRPose", "get_adjusted_transform", 3229777777L), hostObject.objectPtr)
  ...
  final def getLinearVelocity(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("XRPose", "get_linear_velocity", 3360562783L), hostObject.objectPtr)
  ...
  final def getAngularVelocity(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("XRPose", "get_angular_velocity", 3360562783L), hostObject.objectPtr)
