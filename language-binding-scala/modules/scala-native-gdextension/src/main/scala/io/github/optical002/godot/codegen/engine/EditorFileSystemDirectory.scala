...
abstract class EditorFileSystemDirectory extends Object {
  ...
  final def getFileType(idx: Long): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.StringName](MethodBind.get("EditorFileSystemDirectory", "get_file_type", 659327637L), hostObject.objectPtr, idx)
