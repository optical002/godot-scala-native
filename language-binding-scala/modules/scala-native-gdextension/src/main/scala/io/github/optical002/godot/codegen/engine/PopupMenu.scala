...
abstract class PopupMenu extends Popup {
  ...
  final def setItemIconModulate(index: Long, modulate: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getItemIconModulate(index: Long): io.github.optical002.godot.builtin.Color =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Color](MethodBind.get("PopupMenu", "get_item_icon_modulate", 3457211756L), hostObject.objectPtr, index)
