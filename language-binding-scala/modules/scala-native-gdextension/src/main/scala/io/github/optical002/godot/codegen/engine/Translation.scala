...
abstract class Translation extends Resource {
  ...
  final def addMessage(src_message: io.github.optical002.godot.builtin.StringName, xlated_message: io.github.optical002.godot.builtin.StringName, context: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def getMessage(src_message: io.github.optical002.godot.builtin.StringName, context: io.github.optical002.godot.builtin.StringName): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call2[io.github.optical002.godot.builtin.StringName, io.github.optical002.godot.builtin.StringName, io.github.optical002.godot.builtin.StringName](MethodBind.get("Translation", "get_message", 1829228469L), hostObject.objectPtr, src_message, context)

  /** Translation.get_plural_message */
  final def getPluralMessage(src_message: io.github.optical002.godot.builtin.StringName, src_plural_message: io.github.optical002.godot.builtin.StringName, n: Long, context: io.github.optical002.godot.builtin.StringName): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call4[io.github.optical002.godot.builtin.StringName, io.github.optical002.godot.builtin.StringName, Long, io.github.optical002.godot.builtin.StringName, io.github.optical002.godot.builtin.StringName](MethodBind.get("Translation", "get_plural_message", 229954002L), hostObject.objectPtr, src_message, src_plural_message, n, context)

  /** Translation.erase_message */
  final def eraseMessage(src_message: io.github.optical002.godot.builtin.StringName, context: io.github.optical002.godot.builtin.StringName): Unit =
