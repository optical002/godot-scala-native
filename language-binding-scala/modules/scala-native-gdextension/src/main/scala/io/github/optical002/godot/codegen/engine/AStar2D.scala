...
abstract class AStar2D extends RefCounted {
  ...
  /** AStar2D.add_point */
  final def addPoint(id: Long, position: io.github.optical002.godot.builtin.Vector2, weight_scale: Double): Unit =
  ...
  final def getPointPosition(id: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("AStar2D", "get_point_position", 2299179447L), hostObject.objectPtr, id)

  /** AStar2D.set_point_position */
  final def setPointPosition(id: Long, position: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getClosestPoint(to_position: io.github.optical002.godot.builtin.Vector2, include_disabled: Boolean): Long =
    Ptrcall.call2[io.github.optical002.godot.builtin.Vector2, Boolean, Long](MethodBind.get("AStar2D", "get_closest_point", 2300324924L), hostObject.objectPtr, to_position, include_disabled)

  /** AStar2D.get_closest_position_in_segment */
  final def getClosestPositionInSegment(to_position: io.github.optical002.godot.builtin.Vector2): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2, io.github.optical002.godot.builtin.Vector2](MethodBind.get("AStar2D", "get_closest_position_in_segment", 2656412154L), hostObject.objectPtr, to_position)
