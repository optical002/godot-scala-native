...
abstract class SkeletonIK3D extends SkeletonModifier3D {
  ...
  final def setRootBone(root_bone: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def getRootBone(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("SkeletonIK3D", "get_root_bone", 2002593661L), hostObject.objectPtr)

  /** SkeletonIK3D.set_tip_bone */
  final def setTipBone(tip_bone: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def getTipBone(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("SkeletonIK3D", "get_tip_bone", 2002593661L), hostObject.objectPtr)

  /** SkeletonIK3D.set_target_transform */
  final def setTargetTransform(target: io.github.optical002.godot.builtin.Transform3D): Unit =
  ...
  final def getTargetTransform(): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform3D](MethodBind.get("SkeletonIK3D", "get_target_transform", 3229777777L), hostObject.objectPtr)
  ...
  final def setMagnetPosition(local_position: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getMagnetPosition(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("SkeletonIK3D", "get_magnet_position", 3360562783L), hostObject.objectPtr)
