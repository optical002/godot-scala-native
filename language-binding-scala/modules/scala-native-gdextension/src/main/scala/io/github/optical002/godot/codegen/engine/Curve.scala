...
abstract class Curve extends Resource {
  ...
  /** Curve.add_point */
  final def addPoint(position: io.github.optical002.godot.builtin.Vector2, left_tangent: Double, right_tangent: Double, left_mode: Long, right_mode: Long): Long =
    Ptrcall.call5[io.github.optical002.godot.builtin.Vector2, Double, Double, Long, Long, Long](MethodBind.get("Curve", "add_point", 434072736L), hostObject.objectPtr, position, left_tangent, right_tangent, left_mode, right_mode)
  ...
  final def getPointPosition(index: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("Curve", "get_point_position", 2299179447L), hostObject.objectPtr, index)
