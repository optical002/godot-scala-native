...
abstract class LabelSettings extends Resource {
  ...
  final def setFontColor(color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getFontColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("LabelSettings", "get_font_color", 3444240500L), hostObject.objectPtr)
  ...
  final def setOutlineColor(color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getOutlineColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("LabelSettings", "get_outline_color", 3444240500L), hostObject.objectPtr)
  ...
  final def setShadowColor(color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getShadowColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("LabelSettings", "get_shadow_color", 3444240500L), hostObject.objectPtr)

  /** LabelSettings.set_shadow_offset */
  final def setShadowOffset(offset: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getShadowOffset(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("LabelSettings", "get_shadow_offset", 3341600327L), hostObject.objectPtr)
  ...
  final def setStackedOutlineColor(index: Long, color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getStackedOutlineColor(index: Long): io.github.optical002.godot.builtin.Color =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Color](MethodBind.get("LabelSettings", "get_stacked_outline_color", 3457211756L), hostObject.objectPtr, index)
  ...
  final def setStackedShadowOffset(index: Long, offset: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getStackedShadowOffset(index: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("LabelSettings", "get_stacked_shadow_offset", 2299179447L), hostObject.objectPtr, index)

  /** LabelSettings.set_stacked_shadow_color */
  final def setStackedShadowColor(index: Long, color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getStackedShadowColor(index: Long): io.github.optical002.godot.builtin.Color =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Color](MethodBind.get("LabelSettings", "get_stacked_shadow_color", 3457211756L), hostObject.objectPtr, index)
