...
abstract class ColorPicker extends VBoxContainer {
  ...
  final def setPickColor(color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getPickColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("ColorPicker", "get_pick_color", 3444240500L), hostObject.objectPtr)
  ...
  final def addPreset(color: io.github.optical002.godot.builtin.Color): Unit =
    Ptrcall.callVoid1(MethodBind.get("ColorPicker", "add_preset", 2920490490L), hostObject.objectPtr, color)

  /** ColorPicker.erase_preset */
  final def erasePreset(color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def addRecentPreset(color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def eraseRecentPreset(color: io.github.optical002.godot.builtin.Color): Unit =
