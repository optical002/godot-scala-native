...
abstract class SurfaceTool extends RefCounted {
  ...
  final def addVertex(vertex: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getAabb(): io.github.optical002.godot.builtin.AABB =
    Ptrcall.call0[io.github.optical002.godot.builtin.AABB](MethodBind.get("SurfaceTool", "get_aabb", 1068685055L), hostObject.objectPtr)
  ...
  final def appendFrom(existing: Mesh, surface: Long, transform: io.github.optical002.godot.builtin.Transform3D): Unit =
