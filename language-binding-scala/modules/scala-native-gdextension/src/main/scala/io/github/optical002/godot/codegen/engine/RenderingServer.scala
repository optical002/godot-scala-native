...
abstract class RenderingServer extends Object {
  ...
  final def globalShaderParameterRemove(name: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def globalShaderParameterGetType(name: io.github.optical002.godot.builtin.StringName): Long =
    Ptrcall.call1[io.github.optical002.godot.builtin.StringName, Long](MethodBind.get("RenderingServer", "global_shader_parameter_get_type", 1601414142L), hostObject.objectPtr, name)
  ...
  final def setBootImageWithStretch(image: Image, color: io.github.optical002.godot.builtin.Color, stretch_mode: Long, use_filter: Boolean): Unit =
  ...
  final def setBootImage(image: Image, color: io.github.optical002.godot.builtin.Color, scale: Boolean, use_filter: Boolean): Unit =
  ...
  final def getDefaultClearColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("RenderingServer", "get_default_clear_color", 3200896285L), hostObject.objectPtr)

  /** RenderingServer.set_default_clear_color */
  final def setDefaultClearColor(color: io.github.optical002.godot.builtin.Color): Unit =
