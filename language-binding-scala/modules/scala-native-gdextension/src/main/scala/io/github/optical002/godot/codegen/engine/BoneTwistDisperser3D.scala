...
abstract class BoneTwistDisperser3D extends SkeletonModifier3D {
  ...
  final def setTwistFrom(index: Long, from: io.github.optical002.godot.builtin.Quaternion): Unit =
  ...
  final def getTwistFrom(index: Long): io.github.optical002.godot.builtin.Quaternion =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Quaternion](MethodBind.get("BoneTwistDisperser3D", "get_twist_from", 476865136L), hostObject.objectPtr, index)
