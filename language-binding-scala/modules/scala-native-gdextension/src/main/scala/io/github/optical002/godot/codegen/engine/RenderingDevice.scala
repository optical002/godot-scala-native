...
abstract class RenderingDevice extends Object {
  ...
  final def drawListBeginForScreen(screen: Long, clear_color: io.github.optical002.godot.builtin.Color): Long =
    Ptrcall.call2[Long, io.github.optical002.godot.builtin.Color, Long](MethodBind.get("RenderingDevice", "draw_list_begin_for_screen", 3988079995L), hostObject.objectPtr, screen, clear_color)

  /** RenderingDevice.draw_list_set_blend_constants */
  final def drawListSetBlendConstants(draw_list: Long, color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def drawListEnableScissor(draw_list: Long, rect: io.github.optical002.godot.builtin.Rect2): Unit =
  ...
  final def drawCommandBeginLabel(name: String, color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def drawCommandInsertLabel(name: String, color: io.github.optical002.godot.builtin.Color): Unit =
