...
abstract class OpenXRAPIExtension extends RefCounted {
  ...
  final def setVelocityTargetSize(target_size: io.github.optical002.godot.builtin.Vector2i): Unit =
  ...
  final def setRenderRegion(render_region: io.github.optical002.godot.builtin.Rect2i): Unit =
