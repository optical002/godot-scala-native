...
abstract class PhysicsShapeQueryParameters3D extends RefCounted {
  ...
  final def getTransform(): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform3D](MethodBind.get("PhysicsShapeQueryParameters3D", "get_transform", 3229777777L), hostObject.objectPtr)
  ...
  final def getMotion(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("PhysicsShapeQueryParameters3D", "get_motion", 3360562783L), hostObject.objectPtr)
