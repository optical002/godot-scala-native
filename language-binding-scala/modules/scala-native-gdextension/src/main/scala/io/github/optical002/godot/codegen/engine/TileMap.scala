...
abstract class TileMap extends Node2D {
  ...
  final def setLayerModulate(layer: Long, modulate: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getLayerModulate(layer: Long): io.github.optical002.godot.builtin.Color =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Color](MethodBind.get("TileMap", "get_layer_modulate", 3457211756L), hostObject.objectPtr, layer)
  ...
  /** TileMap.set_cell */
  final def setCell(layer: Long, coords: io.github.optical002.godot.builtin.Vector2i, source_id: Long, atlas_coords: io.github.optical002.godot.builtin.Vector2i, alternative_tile: Long): Unit =
  ...
  /** TileMap.erase_cell */
  final def eraseCell(layer: Long, coords: io.github.optical002.godot.builtin.Vector2i): Unit =
  ...
  final def getCellSourceId(layer: Long, coords: io.github.optical002.godot.builtin.Vector2i, use_proxies: Boolean): Long =
    Ptrcall.call3[Long, io.github.optical002.godot.builtin.Vector2i, Boolean, Long](MethodBind.get("TileMap", "get_cell_source_id", 551761942L), hostObject.objectPtr, layer, coords, use_proxies)

  /** TileMap.get_cell_atlas_coords */
  final def getCellAtlasCoords(layer: Long, coords: io.github.optical002.godot.builtin.Vector2i, use_proxies: Boolean): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call3[Long, io.github.optical002.godot.builtin.Vector2i, Boolean, io.github.optical002.godot.builtin.Vector2i](MethodBind.get("TileMap", "get_cell_atlas_coords", 1869815066L), hostObject.objectPtr, layer, coords, use_proxies)

  /** TileMap.get_cell_alternative_tile */
  final def getCellAlternativeTile(layer: Long, coords: io.github.optical002.godot.builtin.Vector2i, use_proxies: Boolean): Long =
    Ptrcall.call3[Long, io.github.optical002.godot.builtin.Vector2i, Boolean, Long](MethodBind.get("TileMap", "get_cell_alternative_tile", 551761942L), hostObject.objectPtr, layer, coords, use_proxies)

  /** TileMap.get_cell_tile_data */
  final def getCellTileData(layer: Long, coords: io.github.optical002.godot.builtin.Vector2i, use_proxies: Boolean): GodotObject =
    Ptrcall.call3[Long, io.github.optical002.godot.builtin.Vector2i, Boolean, GodotObject](MethodBind.get("TileMap", "get_cell_tile_data", 2849631287L), hostObject.objectPtr, layer, coords, use_proxies)

  /** TileMap.is_cell_flipped_h */
  final def isCellFlippedH(layer: Long, coords: io.github.optical002.godot.builtin.Vector2i, use_proxies: Boolean): Boolean =
    Ptrcall.call3[Long, io.github.optical002.godot.builtin.Vector2i, Boolean, Boolean](MethodBind.get("TileMap", "is_cell_flipped_h", 2908343862L), hostObject.objectPtr, layer, coords, use_proxies)

  /** TileMap.is_cell_flipped_v */
  final def isCellFlippedV(layer: Long, coords: io.github.optical002.godot.builtin.Vector2i, use_proxies: Boolean): Boolean =
    Ptrcall.call3[Long, io.github.optical002.godot.builtin.Vector2i, Boolean, Boolean](MethodBind.get("TileMap", "is_cell_flipped_v", 2908343862L), hostObject.objectPtr, layer, coords, use_proxies)

  /** TileMap.is_cell_transposed */
  final def isCellTransposed(layer: Long, coords: io.github.optical002.godot.builtin.Vector2i, use_proxies: Boolean): Boolean =
    Ptrcall.call3[Long, io.github.optical002.godot.builtin.Vector2i, Boolean, Boolean](MethodBind.get("TileMap", "is_cell_transposed", 2908343862L), hostObject.objectPtr, layer, coords, use_proxies)

  /** TileMap.map_pattern */
  final def mapPattern(position_in_tilemap: io.github.optical002.godot.builtin.Vector2i, coords_in_pattern: io.github.optical002.godot.builtin.Vector2i, pattern: TileMapPattern): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call3[io.github.optical002.godot.builtin.Vector2i, io.github.optical002.godot.builtin.Vector2i, GodotObject, io.github.optical002.godot.builtin.Vector2i](MethodBind.get("TileMap", "map_pattern", 1864516957L), hostObject.objectPtr, position_in_tilemap, coords_in_pattern, pattern.hostObject)

  /** TileMap.set_pattern */
  final def setPattern(layer: Long, position: io.github.optical002.godot.builtin.Vector2i, pattern: TileMapPattern): Unit =
  ...
  final def getUsedRect(): io.github.optical002.godot.builtin.Rect2i =
    Ptrcall.call0[io.github.optical002.godot.builtin.Rect2i](MethodBind.get("TileMap", "get_used_rect", 410525958L), hostObject.objectPtr)

  /** TileMap.map_to_local */
  final def mapToLocal(map_position: io.github.optical002.godot.builtin.Vector2i): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2i, io.github.optical002.godot.builtin.Vector2](MethodBind.get("TileMap", "map_to_local", 108438297L), hostObject.objectPtr, map_position)

  /** TileMap.local_to_map */
  final def localToMap(local_position: io.github.optical002.godot.builtin.Vector2): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2, io.github.optical002.godot.builtin.Vector2i](MethodBind.get("TileMap", "local_to_map", 837806996L), hostObject.objectPtr, local_position)

  /** TileMap.get_neighbor_cell */
  final def getNeighborCell(coords: io.github.optical002.godot.builtin.Vector2i, neighbor: Long): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call2[io.github.optical002.godot.builtin.Vector2i, Long, io.github.optical002.godot.builtin.Vector2i](MethodBind.get("TileMap", "get_neighbor_cell", 986575103L), hostObject.objectPtr, coords, neighbor)
