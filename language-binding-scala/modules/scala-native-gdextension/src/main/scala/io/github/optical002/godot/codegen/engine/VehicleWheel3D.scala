...
abstract class VehicleWheel3D extends Node3D {
  ...
  final def getContactPoint(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("VehicleWheel3D", "get_contact_point", 3360562783L), hostObject.objectPtr)

  /** VehicleWheel3D.get_contact_normal */
  final def getContactNormal(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("VehicleWheel3D", "get_contact_normal", 3360562783L), hostObject.objectPtr)
