...
abstract class AStarGrid2D extends RefCounted {
  ...
  final def setRegion(region: io.github.optical002.godot.builtin.Rect2i): Unit =
    Ptrcall.callVoid1(MethodBind.get("AStarGrid2D", "set_region", 1763793166L), hostObject.objectPtr, region)

  /** AStarGrid2D.get_region */
  final def getRegion(): io.github.optical002.godot.builtin.Rect2i =
    Ptrcall.call0[io.github.optical002.godot.builtin.Rect2i](MethodBind.get("AStarGrid2D", "get_region", 410525958L), hostObject.objectPtr)
  ...
  final def getSize(): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2i](MethodBind.get("AStarGrid2D", "get_size", 3690982128L), hostObject.objectPtr)
  ...
  final def getOffset(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("AStarGrid2D", "get_offset", 3341600327L), hostObject.objectPtr)

  /** AStarGrid2D.set_cell_size */
  final def setCellSize(cell_size: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getCellSize(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("AStarGrid2D", "get_cell_size", 3341600327L), hostObject.objectPtr)
  ...
  final def isInBoundsv(id: io.github.optical002.godot.builtin.Vector2i): Boolean =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2i, Boolean](MethodBind.get("AStarGrid2D", "is_in_boundsv", 3900751641L), hostObject.objectPtr, id)
  ...
  final def setPointSolid(id: io.github.optical002.godot.builtin.Vector2i, solid: Boolean): Unit =
  ...
  final def isPointSolid(id: io.github.optical002.godot.builtin.Vector2i): Boolean =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2i, Boolean](MethodBind.get("AStarGrid2D", "is_point_solid", 3900751641L), hostObject.objectPtr, id)

  /** AStarGrid2D.set_point_weight_scale */
  final def setPointWeightScale(id: io.github.optical002.godot.builtin.Vector2i, weight_scale: Double): Unit =
  ...
  final def getPointWeightScale(id: io.github.optical002.godot.builtin.Vector2i): Double =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2i, Double](MethodBind.get("AStarGrid2D", "get_point_weight_scale", 719993801L), hostObject.objectPtr, id)

  /** AStarGrid2D.fill_solid_region */
  final def fillSolidRegion(region: io.github.optical002.godot.builtin.Rect2i, solid: Boolean): Unit =
  ...
  final def fillWeightScaleRegion(region: io.github.optical002.godot.builtin.Rect2i, weight_scale: Double): Unit =
  ...
  final def getPointPosition(id: io.github.optical002.godot.builtin.Vector2i): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2i, io.github.optical002.godot.builtin.Vector2](MethodBind.get("AStarGrid2D", "get_point_position", 108438297L), hostObject.objectPtr, id)
