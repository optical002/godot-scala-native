...
abstract class AnimationPlayer extends AnimationMixer {
  ...
  final def animationSetNext(animation_from: io.github.optical002.godot.builtin.StringName, animation_to: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def animationGetNext(animation_from: io.github.optical002.godot.builtin.StringName): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call1[io.github.optical002.godot.builtin.StringName, io.github.optical002.godot.builtin.StringName](MethodBind.get("AnimationPlayer", "animation_get_next", 1965194235L), hostObject.objectPtr, animation_from)

  /** AnimationPlayer.set_blend_time */
  final def setBlendTime(animation_from: io.github.optical002.godot.builtin.StringName, animation_to: io.github.optical002.godot.builtin.StringName, sec: Double): Unit =
  ...
  final def getBlendTime(animation_from: io.github.optical002.godot.builtin.StringName, animation_to: io.github.optical002.godot.builtin.StringName): Double =
    Ptrcall.call2[io.github.optical002.godot.builtin.StringName, io.github.optical002.godot.builtin.StringName, Double](MethodBind.get("AnimationPlayer", "get_blend_time", 1958752504L), hostObject.objectPtr, animation_from, animation_to)
  ...
  final def play(name: io.github.optical002.godot.builtin.StringName, custom_blend: Double, custom_speed: Double, from_end: Boolean): Unit =
  ...
  final def playSectionWithMarkers(name: io.github.optical002.godot.builtin.StringName, start_marker: io.github.optical002.godot.builtin.StringName, end_marker: io.github.optical002.godot.builtin.StringName, custom_blend: Double, custom_speed: Double, from_end: Boolean): Unit =
  ...
  final def playSection(name: io.github.optical002.godot.builtin.StringName, start_time: Double, end_time: Double, custom_blend: Double, custom_speed: Double, from_end: Boolean): Unit =
  ...
  final def playBackwards(name: io.github.optical002.godot.builtin.StringName, custom_blend: Double): Unit =
  ...
  final def playSectionWithMarkersBackwards(name: io.github.optical002.godot.builtin.StringName, start_marker: io.github.optical002.godot.builtin.StringName, end_marker: io.github.optical002.godot.builtin.StringName, custom_blend: Double): Unit =
  ...
  final def playSectionBackwards(name: io.github.optical002.godot.builtin.StringName, start_time: Double, end_time: Double, custom_blend: Double): Unit =
  ...
  final def setCurrentAnimation(animation: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def getCurrentAnimation(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("AnimationPlayer", "get_current_animation", 2002593661L), hostObject.objectPtr)

  /** AnimationPlayer.set_assigned_animation */
  final def setAssignedAnimation(animation: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def getAssignedAnimation(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("AnimationPlayer", "get_assigned_animation", 2002593661L), hostObject.objectPtr)

  /** AnimationPlayer.queue */
  final def queue(name: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def setAutoplay(name: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def getAutoplay(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("AnimationPlayer", "get_autoplay", 2002593661L), hostObject.objectPtr)
  ...
  final def setSectionWithMarkers(start_marker: io.github.optical002.godot.builtin.StringName, end_marker: io.github.optical002.godot.builtin.StringName): Unit =
