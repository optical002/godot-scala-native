...
abstract class Label3D extends GeometryInstance3D {
  ...
  final def getModulate(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("Label3D", "get_modulate", 3444240500L), hostObject.objectPtr)

  /** Label3D.set_outline_modulate */
  final def setOutlineModulate(modulate: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getOutlineModulate(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("Label3D", "get_outline_modulate", 3444240500L), hostObject.objectPtr)
  ...
  final def getOffset(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("Label3D", "get_offset", 3341600327L), hostObject.objectPtr)
