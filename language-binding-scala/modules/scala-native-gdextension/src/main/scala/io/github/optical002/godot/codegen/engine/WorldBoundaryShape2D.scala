...
abstract class WorldBoundaryShape2D extends Shape2D {
  ...
  final def setNormal(normal: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getNormal(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("WorldBoundaryShape2D", "get_normal", 3341600327L), hostObject.objectPtr)
