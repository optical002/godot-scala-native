...
abstract class MultiMesh extends Resource {
  ...
  final def setInstanceTransform(instance: Long, transform: io.github.optical002.godot.builtin.Transform3D): Unit =
  ...
  final def setInstanceTransform2d(instance: Long, transform: io.github.optical002.godot.builtin.Transform2D): Unit =
  ...
  final def getInstanceTransform(instance: Long): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Transform3D](MethodBind.get("MultiMesh", "get_instance_transform", 1965739696L), hostObject.objectPtr, instance)

  /** MultiMesh.get_instance_transform_2d */
  final def getInstanceTransform2d(instance: Long): io.github.optical002.godot.builtin.Transform2D =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Transform2D](MethodBind.get("MultiMesh", "get_instance_transform_2d", 3836996910L), hostObject.objectPtr, instance)

  /** MultiMesh.set_instance_color */
  final def setInstanceColor(instance: Long, color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getInstanceColor(instance: Long): io.github.optical002.godot.builtin.Color =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Color](MethodBind.get("MultiMesh", "get_instance_color", 3457211756L), hostObject.objectPtr, instance)

  /** MultiMesh.set_instance_custom_data */
  final def setInstanceCustomData(instance: Long, custom_data: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getInstanceCustomData(instance: Long): io.github.optical002.godot.builtin.Color =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Color](MethodBind.get("MultiMesh", "get_instance_custom_data", 3457211756L), hostObject.objectPtr, instance)
  ...
  final def setCustomAabb(aabb: io.github.optical002.godot.builtin.AABB): Unit =
    Ptrcall.callVoid1(MethodBind.get("MultiMesh", "set_custom_aabb", 259215842L), hostObject.objectPtr, aabb)

  /** MultiMesh.get_custom_aabb */
  final def getCustomAabb(): io.github.optical002.godot.builtin.AABB =
    Ptrcall.call0[io.github.optical002.godot.builtin.AABB](MethodBind.get("MultiMesh", "get_custom_aabb", 1068685055L), hostObject.objectPtr)

  /** MultiMesh.get_aabb */
  final def getAabb(): io.github.optical002.godot.builtin.AABB =
    Ptrcall.call0[io.github.optical002.godot.builtin.AABB](MethodBind.get("MultiMesh", "get_aabb", 1068685055L), hostObject.objectPtr)
