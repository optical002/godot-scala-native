...
abstract class SpringBoneSimulator3D extends SkeletonModifier3D {
  ...
  final def setRotationAxisVector(index: Long, vector: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getRotationAxisVector(index: Long): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector3](MethodBind.get("SpringBoneSimulator3D", "get_rotation_axis_vector", 711720468L), hostObject.objectPtr, index)
  ...
  final def setGravityDirection(index: Long, gravity_direction: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getGravityDirection(index: Long): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector3](MethodBind.get("SpringBoneSimulator3D", "get_gravity_direction", 711720468L), hostObject.objectPtr, index)
  ...
  final def setJointRotationAxisVector(index: Long, joint: Long, vector: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getJointRotationAxisVector(index: Long, joint: Long): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call2[Long, Long, io.github.optical002.godot.builtin.Vector3](MethodBind.get("SpringBoneSimulator3D", "get_joint_rotation_axis_vector", 1592972041L), hostObject.objectPtr, index, joint)
  ...
  final def setJointGravityDirection(index: Long, joint: Long, gravity_direction: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getJointGravityDirection(index: Long, joint: Long): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call2[Long, Long, io.github.optical002.godot.builtin.Vector3](MethodBind.get("SpringBoneSimulator3D", "get_joint_gravity_direction", 1592972041L), hostObject.objectPtr, index, joint)
  ...
  final def setExternalForce(force: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getExternalForce(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("SpringBoneSimulator3D", "get_external_force", 3360562783L), hostObject.objectPtr)
