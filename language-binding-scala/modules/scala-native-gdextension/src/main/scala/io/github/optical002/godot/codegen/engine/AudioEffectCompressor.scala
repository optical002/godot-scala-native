...
abstract class AudioEffectCompressor extends AudioEffect {
  ...
  final def setSidechain(sidechain: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def getSidechain(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("AudioEffectCompressor", "get_sidechain", 2002593661L), hostObject.objectPtr)
