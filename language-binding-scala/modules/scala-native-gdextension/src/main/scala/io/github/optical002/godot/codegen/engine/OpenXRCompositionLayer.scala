...
abstract class OpenXRCompositionLayer extends Node3D {
  ...
  final def setAndroidSurfaceSize(size: io.github.optical002.godot.builtin.Vector2i): Unit =
  ...
  final def getAndroidSurfaceSize(): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2i](MethodBind.get("OpenXRCompositionLayer", "get_android_surface_size", 3690982128L), hostObject.objectPtr)
  ...
  final def getBorderColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("OpenXRCompositionLayer", "get_border_color", 3444240500L), hostObject.objectPtr)

  /** OpenXRCompositionLayer.intersects_ray */
  final def intersectsRay(origin: io.github.optical002.godot.builtin.Vector3, direction: io.github.optical002.godot.builtin.Vector3): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call2[io.github.optical002.godot.builtin.Vector3, io.github.optical002.godot.builtin.Vector3, io.github.optical002.godot.builtin.Vector2](MethodBind.get("OpenXRCompositionLayer", "intersects_ray", 1091262597L), hostObject.objectPtr, origin, direction)
