...
abstract class EditorProperty extends Container {
  ...
  final def getEditedProperty(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("EditorProperty", "get_edited_property", 2002593661L), hostObject.objectPtr)
  ...
  final def setObjectAndProperty(`object`: Object, property: io.github.optical002.godot.builtin.StringName): Unit =
