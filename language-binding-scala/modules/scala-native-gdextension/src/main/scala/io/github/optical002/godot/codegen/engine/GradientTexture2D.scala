...
abstract class GradientTexture2D extends Texture2D {
  ...
  final def setFillFrom(fill_from: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getFillFrom(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("GradientTexture2D", "get_fill_from", 3341600327L), hostObject.objectPtr)

  /** GradientTexture2D.set_fill_to */
  final def setFillTo(fill_to: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getFillTo(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("GradientTexture2D", "get_fill_to", 3341600327L), hostObject.objectPtr)
