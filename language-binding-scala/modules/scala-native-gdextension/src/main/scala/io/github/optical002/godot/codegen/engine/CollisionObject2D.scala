...
abstract class CollisionObject2D extends Node2D {
  ...
  final def shapeOwnerSetTransform(owner_id: Long, transform: io.github.optical002.godot.builtin.Transform2D): Unit =
  ...
  final def shapeOwnerGetTransform(owner_id: Long): io.github.optical002.godot.builtin.Transform2D =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Transform2D](MethodBind.get("CollisionObject2D", "shape_owner_get_transform", 3836996910L), hostObject.objectPtr, owner_id)
