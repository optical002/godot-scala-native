...
abstract class RenderSceneBuffersConfiguration extends RefCounted {
  ...
  final def getInternalSize(): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2i](MethodBind.get("RenderSceneBuffersConfiguration", "get_internal_size", 3690982128L), hostObject.objectPtr)

  /** RenderSceneBuffersConfiguration.set_internal_size */
  final def setInternalSize(internal_size: io.github.optical002.godot.builtin.Vector2i): Unit =
  ...
  final def getTargetSize(): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2i](MethodBind.get("RenderSceneBuffersConfiguration", "get_target_size", 3690982128L), hostObject.objectPtr)

  /** RenderSceneBuffersConfiguration.set_target_size */
  final def setTargetSize(target_size: io.github.optical002.godot.builtin.Vector2i): Unit =
