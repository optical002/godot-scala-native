...
abstract class SkeletonModification2DJiggle extends SkeletonModification2D {
  ...
  final def setGravity(gravity: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getGravity(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("SkeletonModification2DJiggle", "get_gravity", 3341600327L), hostObject.objectPtr)
  ...
  final def setJiggleJointGravity(joint_idx: Long, gravity: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getJiggleJointGravity(joint_idx: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("SkeletonModification2DJiggle", "get_jiggle_joint_gravity", 2299179447L), hostObject.objectPtr, joint_idx)
