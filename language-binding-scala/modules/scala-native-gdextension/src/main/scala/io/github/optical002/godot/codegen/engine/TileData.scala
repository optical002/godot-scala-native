...
abstract class TileData extends Object {
  ...
  final def setTextureOrigin(texture_origin: io.github.optical002.godot.builtin.Vector2i): Unit =
  ...
  final def getTextureOrigin(): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2i](MethodBind.get("TileData", "get_texture_origin", 3690982128L), hostObject.objectPtr)
  ...
  final def getModulate(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("TileData", "get_modulate", 3444240500L), hostObject.objectPtr)
  ...
  final def setConstantLinearVelocity(layer_id: Long, velocity: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getConstantLinearVelocity(layer_id: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("TileData", "get_constant_linear_velocity", 2299179447L), hostObject.objectPtr, layer_id)
