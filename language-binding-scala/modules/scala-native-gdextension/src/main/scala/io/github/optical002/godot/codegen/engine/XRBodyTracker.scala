...
abstract class XRBodyTracker extends XRPositionalTracker {
  ...
  final def setJointTransform(joint: Long, transform: io.github.optical002.godot.builtin.Transform3D): Unit =
  ...
  final def getJointTransform(joint: Long): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Transform3D](MethodBind.get("XRBodyTracker", "get_joint_transform", 3474811534L), hostObject.objectPtr, joint)
