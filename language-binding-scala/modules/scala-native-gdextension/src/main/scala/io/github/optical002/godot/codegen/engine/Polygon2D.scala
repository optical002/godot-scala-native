...
abstract class Polygon2D extends Node2D {
  ...
  final def getColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("Polygon2D", "get_color", 3444240500L), hostObject.objectPtr)
  ...
  final def setTextureOffset(texture_offset: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getTextureOffset(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("Polygon2D", "get_texture_offset", 3341600327L), hostObject.objectPtr)
  ...
  final def setTextureScale(texture_scale: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getTextureScale(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("Polygon2D", "get_texture_scale", 3341600327L), hostObject.objectPtr)
  ...
  final def getOffset(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("Polygon2D", "get_offset", 3341600327L), hostObject.objectPtr)
