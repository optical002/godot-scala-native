...
abstract class Node extends Object {
  ...
  /** Node.set_name */
  final def setName(name: io.github.optical002.godot.builtin.StringName): Unit =
    Ptrcall.callVoid1(MethodBind.get("Node", "set_name", 3304788590L), hostObject.objectPtr, name)

  /** Node.get_name */
  final def getName(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("Node", "get_name", 2002593661L), hostObject.objectPtr)
  ...
  /** Node.add_to_group */
  final def addToGroup(group: io.github.optical002.godot.builtin.StringName, persistent: Boolean): Unit =
  ...
  final def removeFromGroup(group: io.github.optical002.godot.builtin.StringName): Unit =
    Ptrcall.callVoid1(MethodBind.get("Node", "remove_from_group", 3304788590L), hostObject.objectPtr, group)

  /** Node.is_in_group */
  final def isInGroup(group: io.github.optical002.godot.builtin.StringName): Boolean =
    Ptrcall.call1[io.github.optical002.godot.builtin.StringName, Boolean](MethodBind.get("Node", "is_in_group", 2619796661L), hostObject.objectPtr, group)
  ...
  /** Node.atr */
  final def atr(message: String, context: io.github.optical002.godot.builtin.StringName): String =
    Ptrcall.call2[String, io.github.optical002.godot.builtin.StringName, String](MethodBind.get("Node", "atr", 3344478075L), hostObject.objectPtr, message, context)

  /** Node.atr_n */
  final def atrN(message: String, plural_message: io.github.optical002.godot.builtin.StringName, n: Long, context: io.github.optical002.godot.builtin.StringName): String =
    Ptrcall.call4[String, io.github.optical002.godot.builtin.StringName, Long, io.github.optical002.godot.builtin.StringName, String](MethodBind.get("Node", "atr_n", 259354841L), hostObject.objectPtr, message, plural_message, n, context)
