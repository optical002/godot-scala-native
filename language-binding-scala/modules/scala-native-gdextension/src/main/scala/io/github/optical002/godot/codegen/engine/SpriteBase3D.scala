...
abstract class SpriteBase3D extends GeometryInstance3D {
  ...
  final def getOffset(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("SpriteBase3D", "get_offset", 3341600327L), hostObject.objectPtr)
  ...
  final def getModulate(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("SpriteBase3D", "get_modulate", 3444240500L), hostObject.objectPtr)
  ...
  final def getItemRect(): io.github.optical002.godot.builtin.Rect2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Rect2](MethodBind.get("SpriteBase3D", "get_item_rect", 1639390495L), hostObject.objectPtr)
