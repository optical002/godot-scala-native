...
abstract class GridMap extends Node3D {
  ...
  final def setCellSize(size: io.github.optical002.godot.builtin.Vector3): Unit =
    Ptrcall.callVoid1(MethodBind.get("GridMap", "set_cell_size", 3460891852L), hostObject.objectPtr, size)

  /** GridMap.get_cell_size */
  final def getCellSize(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("GridMap", "get_cell_size", 3360562783L), hostObject.objectPtr)
  ...
  final def setCellItem(position: io.github.optical002.godot.builtin.Vector3i, item: Long, orientation: Long): Unit =
  ...
  final def getCellItem(position: io.github.optical002.godot.builtin.Vector3i): Long =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector3i, Long](MethodBind.get("GridMap", "get_cell_item", 3724960147L), hostObject.objectPtr, position)

  /** GridMap.get_cell_item_orientation */
  final def getCellItemOrientation(position: io.github.optical002.godot.builtin.Vector3i): Long =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector3i, Long](MethodBind.get("GridMap", "get_cell_item_orientation", 3724960147L), hostObject.objectPtr, position)

  /** GridMap.get_cell_item_basis */
  final def getCellItemBasis(position: io.github.optical002.godot.builtin.Vector3i): io.github.optical002.godot.builtin.Basis =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector3i, io.github.optical002.godot.builtin.Basis](MethodBind.get("GridMap", "get_cell_item_basis", 3493604918L), hostObject.objectPtr, position)

  /** GridMap.get_basis_with_orthogonal_index */
  final def getBasisWithOrthogonalIndex(index: Long): io.github.optical002.godot.builtin.Basis =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Basis](MethodBind.get("GridMap", "get_basis_with_orthogonal_index", 2816196998L), hostObject.objectPtr, index)

  /** GridMap.get_orthogonal_index_from_basis */
  final def getOrthogonalIndexFromBasis(basis: io.github.optical002.godot.builtin.Basis): Long =
    Ptrcall.call1[io.github.optical002.godot.builtin.Basis, Long](MethodBind.get("GridMap", "get_orthogonal_index_from_basis", 4210359952L), hostObject.objectPtr, basis)

  /** GridMap.local_to_map */
  final def localToMap(local_position: io.github.optical002.godot.builtin.Vector3): io.github.optical002.godot.builtin.Vector3i =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector3, io.github.optical002.godot.builtin.Vector3i](MethodBind.get("GridMap", "local_to_map", 1257687843L), hostObject.objectPtr, local_position)

  /** GridMap.map_to_local */
  final def mapToLocal(map_position: io.github.optical002.godot.builtin.Vector3i): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector3i, io.github.optical002.godot.builtin.Vector3](MethodBind.get("GridMap", "map_to_local", 1088329196L), hostObject.objectPtr, map_position)
