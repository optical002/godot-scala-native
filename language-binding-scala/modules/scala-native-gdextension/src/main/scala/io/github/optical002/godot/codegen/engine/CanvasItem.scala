...
abstract class CanvasItem extends Node {
  ...
  final def drawLine(from: io.github.optical002.godot.builtin.Vector2, to: io.github.optical002.godot.builtin.Vector2, color: io.github.optical002.godot.builtin.Color, width: Double, antialiased: Boolean): Unit =
  ...
  final def drawRect(rect: io.github.optical002.godot.builtin.Rect2, color: io.github.optical002.godot.builtin.Color, filled: Boolean, width: Double, antialiased: Boolean): Unit =
  ...
  final def drawCircle(position: io.github.optical002.godot.builtin.Vector2, radius: Double, color: io.github.optical002.godot.builtin.Color, filled: Boolean, width: Double, antialiased: Boolean): Unit =
  ...
  final def drawTexture(texture: Texture2D, position: io.github.optical002.godot.builtin.Vector2, modulate: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def drawTextureRect(texture: Texture2D, rect: io.github.optical002.godot.builtin.Rect2, tile: Boolean, modulate: io.github.optical002.godot.builtin.Color, transpose: Boolean): Unit =
  ...
  final def drawTextureRectRegion(texture: Texture2D, rect: io.github.optical002.godot.builtin.Rect2, src_rect: io.github.optical002.godot.builtin.Rect2, modulate: io.github.optical002.godot.builtin.Color, transpose: Boolean, clip_uv: Boolean): Unit =
  ...
  final def drawLcdTextureRectRegion(texture: Texture2D, rect: io.github.optical002.godot.builtin.Rect2, src_rect: io.github.optical002.godot.builtin.Rect2, modulate: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def drawStyleBox(style_box: StyleBox, rect: io.github.optical002.godot.builtin.Rect2): Unit =
  ...
  final def drawChar(font: Font, pos: io.github.optical002.godot.builtin.Vector2, char: String, font_size: Long, modulate: io.github.optical002.godot.builtin.Color, oversampling: Double): Unit =
  ...
  final def drawMesh(mesh: Mesh, texture: Texture2D, transform: io.github.optical002.godot.builtin.Transform2D, modulate: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def drawSetTransform(position: io.github.optical002.godot.builtin.Vector2, rotation: Double, scale: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def drawSetTransformMatrix(xform: io.github.optical002.godot.builtin.Transform2D): Unit =
  ...
  final def getTransform(): io.github.optical002.godot.builtin.Transform2D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform2D](MethodBind.get("CanvasItem", "get_transform", 3814499831L), hostObject.objectPtr)

  /** CanvasItem.get_global_transform */
  final def getGlobalTransform(): io.github.optical002.godot.builtin.Transform2D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform2D](MethodBind.get("CanvasItem", "get_global_transform", 3814499831L), hostObject.objectPtr)

  /** CanvasItem.get_global_transform_with_canvas */
  final def getGlobalTransformWithCanvas(): io.github.optical002.godot.builtin.Transform2D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform2D](MethodBind.get("CanvasItem", "get_global_transform_with_canvas", 3814499831L), hostObject.objectPtr)

  /** CanvasItem.get_viewport_transform */
  final def getViewportTransform(): io.github.optical002.godot.builtin.Transform2D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform2D](MethodBind.get("CanvasItem", "get_viewport_transform", 3814499831L), hostObject.objectPtr)

  /** CanvasItem.get_viewport_rect */
  final def getViewportRect(): io.github.optical002.godot.builtin.Rect2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Rect2](MethodBind.get("CanvasItem", "get_viewport_rect", 1639390495L), hostObject.objectPtr)

  /** CanvasItem.get_canvas_transform */
  final def getCanvasTransform(): io.github.optical002.godot.builtin.Transform2D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform2D](MethodBind.get("CanvasItem", "get_canvas_transform", 3814499831L), hostObject.objectPtr)

  /** CanvasItem.get_screen_transform */
  final def getScreenTransform(): io.github.optical002.godot.builtin.Transform2D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform2D](MethodBind.get("CanvasItem", "get_screen_transform", 3814499831L), hostObject.objectPtr)
