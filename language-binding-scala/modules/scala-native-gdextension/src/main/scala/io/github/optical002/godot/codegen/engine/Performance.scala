...
abstract class Performance extends Object {
  ...
  final def removeCustomMonitor(id: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def hasCustomMonitor(id: io.github.optical002.godot.builtin.StringName): Boolean =
    Ptrcall.call1[io.github.optical002.godot.builtin.StringName, Boolean](MethodBind.get("Performance", "has_custom_monitor", 2041966384L), hostObject.objectPtr, id)
