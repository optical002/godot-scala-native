...
abstract class TextServer extends RefCounted {
  ...
  final def getHexCodeBoxSize(size: Long, index: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call2[Long, Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("TextServer", "get_hex_code_box_size", 3016396712L), hostObject.objectPtr, size, index)
