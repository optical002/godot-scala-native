...
abstract class BitMap extends Resource {
  ...
  /** BitMap.create */
  final def create(size: io.github.optical002.godot.builtin.Vector2i): Unit =
  ...
  /** BitMap.set_bitv */
  final def setBitv(position: io.github.optical002.godot.builtin.Vector2i, bit: Boolean): Unit =
  ...
  /** BitMap.get_bitv */
  final def getBitv(position: io.github.optical002.godot.builtin.Vector2i): Boolean =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2i, Boolean](MethodBind.get("BitMap", "get_bitv", 3900751641L), hostObject.objectPtr, position)
  ...
  /** BitMap.set_bit_rect */
  final def setBitRect(rect: io.github.optical002.godot.builtin.Rect2i, bit: Boolean): Unit =
  ...
  final def getSize(): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2i](MethodBind.get("BitMap", "get_size", 3690982128L), hostObject.objectPtr)

  /** BitMap.resize */
  final def resize(new_size: io.github.optical002.godot.builtin.Vector2i): Unit =
    Ptrcall.callVoid1(MethodBind.get("BitMap", "resize", 1130785943L), hostObject.objectPtr, new_size)

  /** BitMap.grow_mask */
  final def growMask(pixels: Long, rect: io.github.optical002.godot.builtin.Rect2i): Unit =
