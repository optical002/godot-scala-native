...
abstract class TileMapLayer extends Node2D {
  ...
  final def eraseCell(coords: io.github.optical002.godot.builtin.Vector2i): Unit =
  ...
  final def getCellSourceId(coords: io.github.optical002.godot.builtin.Vector2i): Long =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2i, Long](MethodBind.get("TileMapLayer", "get_cell_source_id", 2485466453L), hostObject.objectPtr, coords)
  ...
  final def getCellAtlasCoords(coords: io.github.optical002.godot.builtin.Vector2i): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2i, io.github.optical002.godot.builtin.Vector2i](MethodBind.get("TileMapLayer", "get_cell_atlas_coords", 3050897911L), hostObject.objectPtr, coords)
  ...
  final def getCellAlternativeTile(coords: io.github.optical002.godot.builtin.Vector2i): Long =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2i, Long](MethodBind.get("TileMapLayer", "get_cell_alternative_tile", 2485466453L), hostObject.objectPtr, coords)

  /** TileMapLayer.get_cell_tile_data */
  final def getCellTileData(coords: io.github.optical002.godot.builtin.Vector2i): GodotObject =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2i, GodotObject](MethodBind.get("TileMapLayer", "get_cell_tile_data", 205084707L), hostObject.objectPtr, coords)

  /** TileMapLayer.is_cell_flipped_h */
  final def isCellFlippedH(coords: io.github.optical002.godot.builtin.Vector2i): Boolean =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2i, Boolean](MethodBind.get("TileMapLayer", "is_cell_flipped_h", 3900751641L), hostObject.objectPtr, coords)

  /** TileMapLayer.is_cell_flipped_v */
  final def isCellFlippedV(coords: io.github.optical002.godot.builtin.Vector2i): Boolean =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2i, Boolean](MethodBind.get("TileMapLayer", "is_cell_flipped_v", 3900751641L), hostObject.objectPtr, coords)

  /** TileMapLayer.is_cell_transposed */
  final def isCellTransposed(coords: io.github.optical002.godot.builtin.Vector2i): Boolean =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2i, Boolean](MethodBind.get("TileMapLayer", "is_cell_transposed", 3900751641L), hostObject.objectPtr, coords)

  /** TileMapLayer.get_used_rect */
  final def getUsedRect(): io.github.optical002.godot.builtin.Rect2i =
    Ptrcall.call0[io.github.optical002.godot.builtin.Rect2i](MethodBind.get("TileMapLayer", "get_used_rect", 410525958L), hostObject.objectPtr)

  /** TileMapLayer.set_pattern */
  final def setPattern(position: io.github.optical002.godot.builtin.Vector2i, pattern: TileMapPattern): Unit =
  ...
  final def mapPattern(position_in_tilemap: io.github.optical002.godot.builtin.Vector2i, coords_in_pattern: io.github.optical002.godot.builtin.Vector2i, pattern: TileMapPattern): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call3[io.github.optical002.godot.builtin.Vector2i, io.github.optical002.godot.builtin.Vector2i, GodotObject, io.github.optical002.godot.builtin.Vector2i](MethodBind.get("TileMapLayer", "map_pattern", 1864516957L), hostObject.objectPtr, position_in_tilemap, coords_in_pattern, pattern.hostObject)
  ...
  final def getNeighborCell(coords: io.github.optical002.godot.builtin.Vector2i, neighbor: Long): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call2[io.github.optical002.godot.builtin.Vector2i, Long, io.github.optical002.godot.builtin.Vector2i](MethodBind.get("TileMapLayer", "get_neighbor_cell", 986575103L), hostObject.objectPtr, coords, neighbor)
  ...
  final def mapToLocal(map_position: io.github.optical002.godot.builtin.Vector2i): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2i, io.github.optical002.godot.builtin.Vector2](MethodBind.get("TileMapLayer", "map_to_local", 108438297L), hostObject.objectPtr, map_position)
  ...
  final def localToMap(local_position: io.github.optical002.godot.builtin.Vector2): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2, io.github.optical002.godot.builtin.Vector2i](MethodBind.get("TileMapLayer", "local_to_map", 837806996L), hostObject.objectPtr, local_position)
