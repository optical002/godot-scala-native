...
abstract class NavigationLink3D extends Node3D {
  ...
  final def setStartPosition(position: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getStartPosition(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("NavigationLink3D", "get_start_position", 3360562783L), hostObject.objectPtr)

  /** NavigationLink3D.set_end_position */
  final def setEndPosition(position: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getEndPosition(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("NavigationLink3D", "get_end_position", 3360562783L), hostObject.objectPtr)

  /** NavigationLink3D.set_global_start_position */
  final def setGlobalStartPosition(position: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getGlobalStartPosition(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("NavigationLink3D", "get_global_start_position", 3360562783L), hostObject.objectPtr)

  /** NavigationLink3D.set_global_end_position */
  final def setGlobalEndPosition(position: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getGlobalEndPosition(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("NavigationLink3D", "get_global_end_position", 3360562783L), hostObject.objectPtr)
