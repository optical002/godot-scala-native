...
abstract class VoxelGIData extends Resource {
  ...
  final def getBounds(): io.github.optical002.godot.builtin.AABB =
    Ptrcall.call0[io.github.optical002.godot.builtin.AABB](MethodBind.get("VoxelGIData", "get_bounds", 1068685055L), hostObject.objectPtr)

  /** VoxelGIData.get_octree_size */
  final def getOctreeSize(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("VoxelGIData", "get_octree_size", 3360562783L), hostObject.objectPtr)

  /** VoxelGIData.get_to_cell_xform */
  final def getToCellXform(): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform3D](MethodBind.get("VoxelGIData", "get_to_cell_xform", 3229777777L), hostObject.objectPtr)
