...
abstract class GraphEdit extends Control {
  ...
  final def connectNode(from_node: io.github.optical002.godot.builtin.StringName, from_port: Long, to_node: io.github.optical002.godot.builtin.StringName, to_port: Long, keep_alive: Boolean): Long =
    Ptrcall.call5[io.github.optical002.godot.builtin.StringName, Long, io.github.optical002.godot.builtin.StringName, Long, Boolean, Long](MethodBind.get("GraphEdit", "connect_node", 1376144231L), hostObject.objectPtr, from_node, from_port, to_node, to_port, keep_alive)

  /** GraphEdit.is_node_connected */
  final def isNodeConnected(from_node: io.github.optical002.godot.builtin.StringName, from_port: Long, to_node: io.github.optical002.godot.builtin.StringName, to_port: Long): Boolean =
    Ptrcall.call4[io.github.optical002.godot.builtin.StringName, Long, io.github.optical002.godot.builtin.StringName, Long, Boolean](MethodBind.get("GraphEdit", "is_node_connected", 4216241294L), hostObject.objectPtr, from_node, from_port, to_node, to_port)

  /** GraphEdit.disconnect_node */
  final def disconnectNode(from_node: io.github.optical002.godot.builtin.StringName, from_port: Long, to_node: io.github.optical002.godot.builtin.StringName, to_port: Long): Unit =
  ...
  final def setConnectionActivity(from_node: io.github.optical002.godot.builtin.StringName, from_port: Long, to_node: io.github.optical002.godot.builtin.StringName, to_port: Long, amount: Double): Unit =
  ...
  final def getConnectionCount(from_node: io.github.optical002.godot.builtin.StringName, from_port: Long): Long =
    Ptrcall.call2[io.github.optical002.godot.builtin.StringName, Long, Long](MethodBind.get("GraphEdit", "get_connection_count", 861718734L), hostObject.objectPtr, from_node, from_port)
  ...
  final def getScrollOffset(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("GraphEdit", "get_scroll_offset", 3341600327L), hostObject.objectPtr)
  ...
  final def attachGraphElementToFrame(element: io.github.optical002.godot.builtin.StringName, frame: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def detachGraphElementFromFrame(element: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def getElementFrame(element: io.github.optical002.godot.builtin.StringName): GodotObject =
    Ptrcall.call1[io.github.optical002.godot.builtin.StringName, GodotObject](MethodBind.get("GraphEdit", "get_element_frame", 988084372L), hostObject.objectPtr, element)
  ...
  final def setMinimapSize(size: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getMinimapSize(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("GraphEdit", "get_minimap_size", 3341600327L), hostObject.objectPtr)
