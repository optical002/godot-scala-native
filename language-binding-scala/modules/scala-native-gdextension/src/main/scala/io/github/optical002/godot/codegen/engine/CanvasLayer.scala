...
abstract class CanvasLayer extends Node {
  ...
  final def getTransform(): io.github.optical002.godot.builtin.Transform2D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform2D](MethodBind.get("CanvasLayer", "get_transform", 3814499831L), hostObject.objectPtr)

  /** CanvasLayer.get_final_transform */
  final def getFinalTransform(): io.github.optical002.godot.builtin.Transform2D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform2D](MethodBind.get("CanvasLayer", "get_final_transform", 3814499831L), hostObject.objectPtr)
  ...
  final def getOffset(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("CanvasLayer", "get_offset", 3341600327L), hostObject.objectPtr)
  ...
  final def getScale(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("CanvasLayer", "get_scale", 3341600327L), hostObject.objectPtr)
