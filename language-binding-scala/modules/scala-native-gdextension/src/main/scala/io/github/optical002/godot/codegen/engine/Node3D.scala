...
abstract class Node3D extends Node {
  ...
  final def setTransform(local: io.github.optical002.godot.builtin.Transform3D): Unit =
  ...
  final def getTransform(): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform3D](MethodBind.get("Node3D", "get_transform", 3229777777L), hostObject.objectPtr)
  ...
  final def getPosition(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("Node3D", "get_position", 3360562783L), hostObject.objectPtr)

  /** Node3D.set_rotation */
  final def setRotation(euler_radians: io.github.optical002.godot.builtin.Vector3): Unit =
    Ptrcall.callVoid1(MethodBind.get("Node3D", "set_rotation", 3460891852L), hostObject.objectPtr, euler_radians)

  /** Node3D.get_rotation */
  final def getRotation(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("Node3D", "get_rotation", 3360562783L), hostObject.objectPtr)

  /** Node3D.set_rotation_degrees */
  final def setRotationDegrees(euler_degrees: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getRotationDegrees(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("Node3D", "get_rotation_degrees", 3360562783L), hostObject.objectPtr)
  ...
  final def getScale(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("Node3D", "get_scale", 3360562783L), hostObject.objectPtr)

  /** Node3D.set_quaternion */
  final def setQuaternion(quaternion: io.github.optical002.godot.builtin.Quaternion): Unit =
    Ptrcall.callVoid1(MethodBind.get("Node3D", "set_quaternion", 1727505552L), hostObject.objectPtr, quaternion)

  /** Node3D.get_quaternion */
  final def getQuaternion(): io.github.optical002.godot.builtin.Quaternion =
    Ptrcall.call0[io.github.optical002.godot.builtin.Quaternion](MethodBind.get("Node3D", "get_quaternion", 1222331677L), hostObject.objectPtr)

  /** Node3D.set_basis */
  final def setBasis(basis: io.github.optical002.godot.builtin.Basis): Unit =
    Ptrcall.callVoid1(MethodBind.get("Node3D", "set_basis", 1055510324L), hostObject.objectPtr, basis)

  /** Node3D.get_basis */
  final def getBasis(): io.github.optical002.godot.builtin.Basis =
    Ptrcall.call0[io.github.optical002.godot.builtin.Basis](MethodBind.get("Node3D", "get_basis", 2716978435L), hostObject.objectPtr)

  /** Node3D.set_global_transform */
  final def setGlobalTransform(global: io.github.optical002.godot.builtin.Transform3D): Unit =
  ...
  final def getGlobalTransform(): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform3D](MethodBind.get("Node3D", "get_global_transform", 3229777777L), hostObject.objectPtr)

  /** Node3D.get_global_transform_interpolated */
  final def getGlobalTransformInterpolated(): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform3D](MethodBind.get("Node3D", "get_global_transform_interpolated", 4183770049L), hostObject.objectPtr)

  /** Node3D.set_global_position */
  final def setGlobalPosition(position: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getGlobalPosition(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("Node3D", "get_global_position", 3360562783L), hostObject.objectPtr)

  /** Node3D.set_global_basis */
  final def setGlobalBasis(basis: io.github.optical002.godot.builtin.Basis): Unit =
    Ptrcall.callVoid1(MethodBind.get("Node3D", "set_global_basis", 1055510324L), hostObject.objectPtr, basis)

  /** Node3D.get_global_basis */
  final def getGlobalBasis(): io.github.optical002.godot.builtin.Basis =
    Ptrcall.call0[io.github.optical002.godot.builtin.Basis](MethodBind.get("Node3D", "get_global_basis", 2716978435L), hostObject.objectPtr)

  /** Node3D.set_global_rotation */
  final def setGlobalRotation(euler_radians: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getGlobalRotation(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("Node3D", "get_global_rotation", 3360562783L), hostObject.objectPtr)

  /** Node3D.set_global_rotation_degrees */
  final def setGlobalRotationDegrees(euler_degrees: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getGlobalRotationDegrees(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("Node3D", "get_global_rotation_degrees", 3360562783L), hostObject.objectPtr)
  ...
  final def setSubgizmoSelection(gizmo: Node3DGizmo, id: Long, transform: io.github.optical002.godot.builtin.Transform3D): Unit =
  ...
  /** Node3D.rotate */
  final def rotate(axis: io.github.optical002.godot.builtin.Vector3, angle: Double): Unit =
    Ptrcall.callVoid2(MethodBind.get("Node3D", "rotate", 3436291937L), hostObject.objectPtr, axis, angle)

  /** Node3D.global_rotate */
  final def globalRotate(axis: io.github.optical002.godot.builtin.Vector3, angle: Double): Unit =
    Ptrcall.callVoid2(MethodBind.get("Node3D", "global_rotate", 3436291937L), hostObject.objectPtr, axis, angle)

  /** Node3D.global_scale */
  final def globalScale(scale: io.github.optical002.godot.builtin.Vector3): Unit =
    Ptrcall.callVoid1(MethodBind.get("Node3D", "global_scale", 3460891852L), hostObject.objectPtr, scale)

  /** Node3D.global_translate */
  final def globalTranslate(offset: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def rotateObjectLocal(axis: io.github.optical002.godot.builtin.Vector3, angle: Double): Unit =
  ...
  final def scaleObjectLocal(scale: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def translateObjectLocal(offset: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  /** Node3D.translate */
  final def translate(offset: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  /** Node3D.look_at */
  final def lookAt(target: io.github.optical002.godot.builtin.Vector3, up: io.github.optical002.godot.builtin.Vector3, use_model_front: Boolean): Unit =
  ...
  final def lookAtFromPosition(position: io.github.optical002.godot.builtin.Vector3, target: io.github.optical002.godot.builtin.Vector3, up: io.github.optical002.godot.builtin.Vector3, use_model_front: Boolean): Unit =
  ...
  /** Node3D.to_local */
  final def toLocal(global_point: io.github.optical002.godot.builtin.Vector3): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector3, io.github.optical002.godot.builtin.Vector3](MethodBind.get("Node3D", "to_local", 192990374L), hostObject.objectPtr, global_point)

  /** Node3D.to_global */
  final def toGlobal(local_point: io.github.optical002.godot.builtin.Vector3): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector3, io.github.optical002.godot.builtin.Vector3](MethodBind.get("Node3D", "to_global", 192990374L), hostObject.objectPtr, local_point)
