...
abstract class MeshLibrary extends Resource {
  ...
  final def setItemMeshTransform(id: Long, mesh_transform: io.github.optical002.godot.builtin.Transform3D): Unit =
  ...
  final def setItemNavigationMeshTransform(id: Long, navigation_mesh: io.github.optical002.godot.builtin.Transform3D): Unit =
  ...
  final def getItemMeshTransform(id: Long): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Transform3D](MethodBind.get("MeshLibrary", "get_item_mesh_transform", 1965739696L), hostObject.objectPtr, id)
  ...
  final def getItemNavigationMeshTransform(id: Long): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Transform3D](MethodBind.get("MeshLibrary", "get_item_navigation_mesh_transform", 1965739696L), hostObject.objectPtr, id)
