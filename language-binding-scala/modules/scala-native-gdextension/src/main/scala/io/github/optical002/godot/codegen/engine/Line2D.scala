...
abstract class Line2D extends Node2D {
  ...
  final def setPointPosition(index: Long, position: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getPointPosition(index: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("Line2D", "get_point_position", 2299179447L), hostObject.objectPtr, index)
  ...
  /** Line2D.add_point */
  final def addPoint(position: io.github.optical002.godot.builtin.Vector2, index: Long): Unit =
  ...
  final def setDefaultColor(color: io.github.optical002.godot.builtin.Color): Unit =
    Ptrcall.callVoid1(MethodBind.get("Line2D", "set_default_color", 2920490490L), hostObject.objectPtr, color)

  /** Line2D.get_default_color */
  final def getDefaultColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("Line2D", "get_default_color", 3444240500L), hostObject.objectPtr)
