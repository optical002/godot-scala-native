...
abstract class SceneTree extends MainLoop {
  ...
  /** SceneTree.has_group */
  final def hasGroup(name: io.github.optical002.godot.builtin.StringName): Boolean =
    Ptrcall.call1[io.github.optical002.godot.builtin.StringName, Boolean](MethodBind.get("SceneTree", "has_group", 2619796661L), hostObject.objectPtr, name)
  ...
  final def notifyGroupFlags(call_flags: Long, group: io.github.optical002.godot.builtin.StringName, notification: Long): Unit =
  ...
  final def notifyGroup(group: io.github.optical002.godot.builtin.StringName, notification: Long): Unit =
  ...
  final def getFirstNodeInGroup(group: io.github.optical002.godot.builtin.StringName): GodotObject =
    Ptrcall.call1[io.github.optical002.godot.builtin.StringName, GodotObject](MethodBind.get("SceneTree", "get_first_node_in_group", 4071044623L), hostObject.objectPtr, group)

  /** SceneTree.get_node_count_in_group */
  final def getNodeCountInGroup(group: io.github.optical002.godot.builtin.StringName): Long =
    Ptrcall.call1[io.github.optical002.godot.builtin.StringName, Long](MethodBind.get("SceneTree", "get_node_count_in_group", 2458036349L), hostObject.objectPtr, group)
