...
abstract class NavigationPathQueryParameters2D extends RefCounted {
  ...
  final def setStartPosition(start_position: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getStartPosition(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("NavigationPathQueryParameters2D", "get_start_position", 3341600327L), hostObject.objectPtr)

  /** NavigationPathQueryParameters2D.set_target_position */
  final def setTargetPosition(target_position: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getTargetPosition(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("NavigationPathQueryParameters2D", "get_target_position", 3341600327L), hostObject.objectPtr)
