...
abstract class AudioServer extends Object {
  ...
  final def getBusIndex(bus_name: io.github.optical002.godot.builtin.StringName): Long =
    Ptrcall.call1[io.github.optical002.godot.builtin.StringName, Long](MethodBind.get("AudioServer", "get_bus_index", 2458036349L), hostObject.objectPtr, bus_name)
  ...
  final def setBusSend(bus_idx: Long, send: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def getBusSend(bus_idx: Long): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.StringName](MethodBind.get("AudioServer", "get_bus_send", 659327637L), hostObject.objectPtr, bus_idx)
