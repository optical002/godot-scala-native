...
abstract class Skeleton3D extends Node3D {
  ...
  final def hasBoneMeta(bone_idx: Long, key: io.github.optical002.godot.builtin.StringName): Boolean =
    Ptrcall.call2[Long, io.github.optical002.godot.builtin.StringName, Boolean](MethodBind.get("Skeleton3D", "has_bone_meta", 921227809L), hostObject.objectPtr, bone_idx, key)

  /** Skeleton3D.get_concatenated_bone_names */
  final def getConcatenatedBoneNames(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("Skeleton3D", "get_concatenated_bone_names", 2002593661L), hostObject.objectPtr)
  ...
  final def getBoneRest(bone_idx: Long): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Transform3D](MethodBind.get("Skeleton3D", "get_bone_rest", 1965739696L), hostObject.objectPtr, bone_idx)

  /** Skeleton3D.set_bone_rest */
  final def setBoneRest(bone_idx: Long, rest: io.github.optical002.godot.builtin.Transform3D): Unit =
  ...
  final def getBoneGlobalRest(bone_idx: Long): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Transform3D](MethodBind.get("Skeleton3D", "get_bone_global_rest", 1965739696L), hostObject.objectPtr, bone_idx)
  ...
  final def getBonePose(bone_idx: Long): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Transform3D](MethodBind.get("Skeleton3D", "get_bone_pose", 1965739696L), hostObject.objectPtr, bone_idx)

  /** Skeleton3D.set_bone_pose */
  final def setBonePose(bone_idx: Long, pose: io.github.optical002.godot.builtin.Transform3D): Unit =
  ...
  final def setBonePosePosition(bone_idx: Long, position: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def setBonePoseRotation(bone_idx: Long, rotation: io.github.optical002.godot.builtin.Quaternion): Unit =
  ...
  final def setBonePoseScale(bone_idx: Long, scale: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getBonePosePosition(bone_idx: Long): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector3](MethodBind.get("Skeleton3D", "get_bone_pose_position", 711720468L), hostObject.objectPtr, bone_idx)

  /** Skeleton3D.get_bone_pose_rotation */
  final def getBonePoseRotation(bone_idx: Long): io.github.optical002.godot.builtin.Quaternion =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Quaternion](MethodBind.get("Skeleton3D", "get_bone_pose_rotation", 476865136L), hostObject.objectPtr, bone_idx)

  /** Skeleton3D.get_bone_pose_scale */
  final def getBonePoseScale(bone_idx: Long): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector3](MethodBind.get("Skeleton3D", "get_bone_pose_scale", 711720468L), hostObject.objectPtr, bone_idx)
  ...
  final def getBoneGlobalPose(bone_idx: Long): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Transform3D](MethodBind.get("Skeleton3D", "get_bone_global_pose", 1965739696L), hostObject.objectPtr, bone_idx)

  /** Skeleton3D.set_bone_global_pose */
  final def setBoneGlobalPose(bone_idx: Long, pose: io.github.optical002.godot.builtin.Transform3D): Unit =
  ...
  final def setBoneGlobalPoseOverride(bone_idx: Long, pose: io.github.optical002.godot.builtin.Transform3D, amount: Double, persistent: Boolean): Unit =
  ...
  final def getBoneGlobalPoseOverride(bone_idx: Long): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Transform3D](MethodBind.get("Skeleton3D", "get_bone_global_pose_override", 1965739696L), hostObject.objectPtr, bone_idx)

  /** Skeleton3D.get_bone_global_pose_no_override */
  final def getBoneGlobalPoseNoOverride(bone_idx: Long): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Transform3D](MethodBind.get("Skeleton3D", "get_bone_global_pose_no_override", 1965739696L), hostObject.objectPtr, bone_idx)
