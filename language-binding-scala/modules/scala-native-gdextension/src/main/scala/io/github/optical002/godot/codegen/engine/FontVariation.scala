...
abstract class FontVariation extends Font {
  ...
  final def setVariationTransform(transform: io.github.optical002.godot.builtin.Transform2D): Unit =
  ...
  final def getVariationTransform(): io.github.optical002.godot.builtin.Transform2D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform2D](MethodBind.get("FontVariation", "get_variation_transform", 3814499831L), hostObject.objectPtr)
