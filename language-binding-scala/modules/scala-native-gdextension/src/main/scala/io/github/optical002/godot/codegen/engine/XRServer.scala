...
abstract class XRServer extends Object {
  ...
  final def getWorldOrigin(): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform3D](MethodBind.get("XRServer", "get_world_origin", 3229777777L), hostObject.objectPtr)

  /** XRServer.set_world_origin */
  final def setWorldOrigin(world_origin: io.github.optical002.godot.builtin.Transform3D): Unit =
  ...
  final def getReferenceFrame(): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform3D](MethodBind.get("XRServer", "get_reference_frame", 3229777777L), hostObject.objectPtr)
  ...
  final def getHmdTransform(): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform3D](MethodBind.get("XRServer", "get_hmd_transform", 4183770049L), hostObject.objectPtr)
  ...
  final def getTracker(tracker_name: io.github.optical002.godot.builtin.StringName): GodotObject =
    Ptrcall.call1[io.github.optical002.godot.builtin.StringName, GodotObject](MethodBind.get("XRServer", "get_tracker", 147382240L), hostObject.objectPtr, tracker_name)
