...
abstract class EditorFeatureProfile extends RefCounted {
  ...
  final def setDisableClass(class_name: io.github.optical002.godot.builtin.StringName, disable: Boolean): Unit =
  ...
  final def isClassDisabled(class_name: io.github.optical002.godot.builtin.StringName): Boolean =
    Ptrcall.call1[io.github.optical002.godot.builtin.StringName, Boolean](MethodBind.get("EditorFeatureProfile", "is_class_disabled", 2619796661L), hostObject.objectPtr, class_name)

  /** EditorFeatureProfile.set_disable_class_editor */
  final def setDisableClassEditor(class_name: io.github.optical002.godot.builtin.StringName, disable: Boolean): Unit =
  ...
  final def isClassEditorDisabled(class_name: io.github.optical002.godot.builtin.StringName): Boolean =
    Ptrcall.call1[io.github.optical002.godot.builtin.StringName, Boolean](MethodBind.get("EditorFeatureProfile", "is_class_editor_disabled", 2619796661L), hostObject.objectPtr, class_name)

  /** EditorFeatureProfile.set_disable_class_property */
  final def setDisableClassProperty(class_name: io.github.optical002.godot.builtin.StringName, property: io.github.optical002.godot.builtin.StringName, disable: Boolean): Unit =
  ...
  final def isClassPropertyDisabled(class_name: io.github.optical002.godot.builtin.StringName, property: io.github.optical002.godot.builtin.StringName): Boolean =
    Ptrcall.call2[io.github.optical002.godot.builtin.StringName, io.github.optical002.godot.builtin.StringName, Boolean](MethodBind.get("EditorFeatureProfile", "is_class_property_disabled", 471820014L), hostObject.objectPtr, class_name, property)
