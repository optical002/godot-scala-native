...
abstract class EditorInterface extends Object {
  ...
  final def popupDialog(dialog: Window, rect: io.github.optical002.godot.builtin.Rect2i): Unit =
  ...
  final def popupDialogCentered(dialog: Window, minsize: io.github.optical002.godot.builtin.Vector2i): Unit =
  ...
  final def popupDialogCenteredClamped(dialog: Window, minsize: io.github.optical002.godot.builtin.Vector2i, fallback_ratio: Double): Unit =
