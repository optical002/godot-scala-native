...
abstract class Skeleton2D extends Node2D {
  ...
  final def setBoneLocalPoseOverride(bone_idx: Long, override_pose: io.github.optical002.godot.builtin.Transform2D, strength: Double, persistent: Boolean): Unit =
  ...
  final def getBoneLocalPoseOverride(bone_idx: Long): io.github.optical002.godot.builtin.Transform2D =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Transform2D](MethodBind.get("Skeleton2D", "get_bone_local_pose_override", 2995540667L), hostObject.objectPtr, bone_idx)
