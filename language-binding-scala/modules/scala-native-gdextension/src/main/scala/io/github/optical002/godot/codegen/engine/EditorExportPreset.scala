...
abstract class EditorExportPreset extends RefCounted {
  ...
  final def has(property: io.github.optical002.godot.builtin.StringName): Boolean =
    Ptrcall.call1[io.github.optical002.godot.builtin.StringName, Boolean](MethodBind.get("EditorExportPreset", "has", 2619796661L), hostObject.objectPtr, property)
  ...
  final def getVersion(name: io.github.optical002.godot.builtin.StringName, windows_version: Boolean): String =
    Ptrcall.call2[io.github.optical002.godot.builtin.StringName, Boolean, String](MethodBind.get("EditorExportPreset", "get_version", 1132184663L), hostObject.objectPtr, name, windows_version)
