...
abstract class Bone2D extends Node2D {
  ...
  /** Bone2D.set_rest */
  final def setRest(rest: io.github.optical002.godot.builtin.Transform2D): Unit =
    Ptrcall.callVoid1(MethodBind.get("Bone2D", "set_rest", 2761652528L), hostObject.objectPtr, rest)

  /** Bone2D.get_rest */
  final def getRest(): io.github.optical002.godot.builtin.Transform2D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform2D](MethodBind.get("Bone2D", "get_rest", 3814499831L), hostObject.objectPtr)
  ...
  final def getSkeletonRest(): io.github.optical002.godot.builtin.Transform2D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform2D](MethodBind.get("Bone2D", "get_skeleton_rest", 3814499831L), hostObject.objectPtr)
