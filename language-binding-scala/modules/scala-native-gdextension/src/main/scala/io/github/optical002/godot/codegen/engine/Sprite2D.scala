...
abstract class Sprite2D extends Node2D {
  ...
  final def getOffset(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("Sprite2D", "get_offset", 3341600327L), hostObject.objectPtr)
  ...
  final def isPixelOpaque(pos: io.github.optical002.godot.builtin.Vector2): Boolean =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2, Boolean](MethodBind.get("Sprite2D", "is_pixel_opaque", 556197845L), hostObject.objectPtr, pos)

  /** Sprite2D.set_region_rect */
  final def setRegionRect(rect: io.github.optical002.godot.builtin.Rect2): Unit =
    Ptrcall.callVoid1(MethodBind.get("Sprite2D", "set_region_rect", 2046264180L), hostObject.objectPtr, rect)

  /** Sprite2D.get_region_rect */
  final def getRegionRect(): io.github.optical002.godot.builtin.Rect2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Rect2](MethodBind.get("Sprite2D", "get_region_rect", 1639390495L), hostObject.objectPtr)
  ...
  final def setFrameCoords(coords: io.github.optical002.godot.builtin.Vector2i): Unit =
  ...
  final def getFrameCoords(): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2i](MethodBind.get("Sprite2D", "get_frame_coords", 3690982128L), hostObject.objectPtr)
  ...
  final def getRect(): io.github.optical002.godot.builtin.Rect2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Rect2](MethodBind.get("Sprite2D", "get_rect", 1639390495L), hostObject.objectPtr)
