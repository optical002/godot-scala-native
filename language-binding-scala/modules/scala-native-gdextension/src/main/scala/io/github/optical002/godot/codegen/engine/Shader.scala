...
abstract class Shader extends Resource {
  ...
  final def setDefaultTextureParameter(name: io.github.optical002.godot.builtin.StringName, texture: Texture, index: Long): Unit =
  ...
  final def getDefaultTextureParameter(name: io.github.optical002.godot.builtin.StringName, index: Long): GodotObject =
    Ptrcall.call2[io.github.optical002.godot.builtin.StringName, Long, GodotObject](MethodBind.get("Shader", "get_default_texture_parameter", 4213877425L), hostObject.objectPtr, name, index)
