...
abstract class AnimationMixer extends Node {
  ...
  final def addAnimationLibrary(name: io.github.optical002.godot.builtin.StringName, library: AnimationLibrary): Long =
    Ptrcall.call2[io.github.optical002.godot.builtin.StringName, GodotObject, Long](MethodBind.get("AnimationMixer", "add_animation_library", 618909818L), hostObject.objectPtr, name, library.hostObject)

  /** AnimationMixer.remove_animation_library */
  final def removeAnimationLibrary(name: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def renameAnimationLibrary(name: io.github.optical002.godot.builtin.StringName, newname: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def hasAnimationLibrary(name: io.github.optical002.godot.builtin.StringName): Boolean =
    Ptrcall.call1[io.github.optical002.godot.builtin.StringName, Boolean](MethodBind.get("AnimationMixer", "has_animation_library", 2619796661L), hostObject.objectPtr, name)

  /** AnimationMixer.get_animation_library */
  final def getAnimationLibrary(name: io.github.optical002.godot.builtin.StringName): GodotObject =
    Ptrcall.call1[io.github.optical002.godot.builtin.StringName, GodotObject](MethodBind.get("AnimationMixer", "get_animation_library", 147342321L), hostObject.objectPtr, name)

  /** AnimationMixer.has_animation */
  final def hasAnimation(name: io.github.optical002.godot.builtin.StringName): Boolean =
    Ptrcall.call1[io.github.optical002.godot.builtin.StringName, Boolean](MethodBind.get("AnimationMixer", "has_animation", 2619796661L), hostObject.objectPtr, name)

  /** AnimationMixer.get_animation */
  final def getAnimation(name: io.github.optical002.godot.builtin.StringName): GodotObject =
    Ptrcall.call1[io.github.optical002.godot.builtin.StringName, GodotObject](MethodBind.get("AnimationMixer", "get_animation", 2933122410L), hostObject.objectPtr, name)
  ...
  final def getRootMotionPosition(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("AnimationMixer", "get_root_motion_position", 3360562783L), hostObject.objectPtr)

  /** AnimationMixer.get_root_motion_rotation */
  final def getRootMotionRotation(): io.github.optical002.godot.builtin.Quaternion =
    Ptrcall.call0[io.github.optical002.godot.builtin.Quaternion](MethodBind.get("AnimationMixer", "get_root_motion_rotation", 1222331677L), hostObject.objectPtr)

  /** AnimationMixer.get_root_motion_scale */
  final def getRootMotionScale(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("AnimationMixer", "get_root_motion_scale", 3360562783L), hostObject.objectPtr)

  /** AnimationMixer.get_root_motion_position_accumulator */
  final def getRootMotionPositionAccumulator(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("AnimationMixer", "get_root_motion_position_accumulator", 3360562783L), hostObject.objectPtr)

  /** AnimationMixer.get_root_motion_rotation_accumulator */
  final def getRootMotionRotationAccumulator(): io.github.optical002.godot.builtin.Quaternion =
    Ptrcall.call0[io.github.optical002.godot.builtin.Quaternion](MethodBind.get("AnimationMixer", "get_root_motion_rotation_accumulator", 1222331677L), hostObject.objectPtr)

  /** AnimationMixer.get_root_motion_scale_accumulator */
  final def getRootMotionScaleAccumulator(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("AnimationMixer", "get_root_motion_scale_accumulator", 3360562783L), hostObject.objectPtr)
  ...
  final def capture(name: io.github.optical002.godot.builtin.StringName, duration: Double, trans_type: Long, ease_type: Long): Unit =
  ...
  final def findAnimation(animation: Animation): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call1[GodotObject, io.github.optical002.godot.builtin.StringName](MethodBind.get("AnimationMixer", "find_animation", 1559484580L), hostObject.objectPtr, animation.hostObject)

  /** AnimationMixer.find_animation_library */
  final def findAnimationLibrary(animation: Animation): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call1[GodotObject, io.github.optical002.godot.builtin.StringName](MethodBind.get("AnimationMixer", "find_animation_library", 1559484580L), hostObject.objectPtr, animation.hostObject)
