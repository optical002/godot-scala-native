...
abstract class Gradient extends Resource {
  ...
  /** Gradient.add_point */
  final def addPoint(offset: Double, color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  /** Gradient.set_color */
  final def setColor(point: Long, color: io.github.optical002.godot.builtin.Color): Unit =
    Ptrcall.callVoid2(MethodBind.get("Gradient", "set_color", 2878471219L), hostObject.objectPtr, point, color)

  /** Gradient.get_color */
  final def getColor(point: Long): io.github.optical002.godot.builtin.Color =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Color](MethodBind.get("Gradient", "get_color", 2624840992L), hostObject.objectPtr, point)

  /** Gradient.sample */
  final def sample(offset: Double): io.github.optical002.godot.builtin.Color =
    Ptrcall.call1[Double, io.github.optical002.godot.builtin.Color](MethodBind.get("Gradient", "sample", 1250405064L), hostObject.objectPtr, offset)
