...
abstract class CPUParticles3D extends GeometryInstance3D {
  ...
  final def setVisibilityAabb(aabb: io.github.optical002.godot.builtin.AABB): Unit =
  ...
  final def getVisibilityAabb(): io.github.optical002.godot.builtin.AABB =
    Ptrcall.call0[io.github.optical002.godot.builtin.AABB](MethodBind.get("CPUParticles3D", "get_visibility_aabb", 1068685055L), hostObject.objectPtr)
  ...
  final def captureAabb(): io.github.optical002.godot.builtin.AABB =
    Ptrcall.call0[io.github.optical002.godot.builtin.AABB](MethodBind.get("CPUParticles3D", "capture_aabb", 1068685055L), hostObject.objectPtr)

  /** CPUParticles3D.set_direction */
  final def setDirection(direction: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getDirection(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("CPUParticles3D", "get_direction", 3360562783L), hostObject.objectPtr)
  ...
  final def getColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("CPUParticles3D", "get_color", 3444240500L), hostObject.objectPtr)
  ...
  final def getEmissionBoxExtents(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("CPUParticles3D", "get_emission_box_extents", 3360562783L), hostObject.objectPtr)
  ...
  final def getEmissionRingAxis(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("CPUParticles3D", "get_emission_ring_axis", 3360562783L), hostObject.objectPtr)
  ...
  final def getGravity(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("CPUParticles3D", "get_gravity", 3360562783L), hostObject.objectPtr)
