...
abstract class XRBodyModifier3D extends SkeletonModifier3D {
  ...
  final def setBodyTracker(tracker_name: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def getBodyTracker(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("XRBodyModifier3D", "get_body_tracker", 2002593661L), hostObject.objectPtr)
