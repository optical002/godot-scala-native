...
abstract class Light2D extends Node2D {
  ...
  final def getColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("Light2D", "get_color", 3444240500L), hostObject.objectPtr)
  ...
  final def setShadowColor(shadow_color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getShadowColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("Light2D", "get_shadow_color", 3444240500L), hostObject.objectPtr)
