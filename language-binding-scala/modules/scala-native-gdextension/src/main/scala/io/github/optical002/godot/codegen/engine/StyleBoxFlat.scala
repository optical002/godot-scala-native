...
abstract class StyleBoxFlat extends StyleBox {
  ...
  final def getBgColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("StyleBoxFlat", "get_bg_color", 3444240500L), hostObject.objectPtr)
  ...
  final def getBorderColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("StyleBoxFlat", "get_border_color", 3444240500L), hostObject.objectPtr)
  ...
  final def setSkew(skew: io.github.optical002.godot.builtin.Vector2): Unit =
    Ptrcall.callVoid1(MethodBind.get("StyleBoxFlat", "set_skew", 743155724L), hostObject.objectPtr, skew)

  /** StyleBoxFlat.get_skew */
  final def getSkew(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("StyleBoxFlat", "get_skew", 3341600327L), hostObject.objectPtr)
  ...
  final def getShadowColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("StyleBoxFlat", "get_shadow_color", 3444240500L), hostObject.objectPtr)
  ...
  final def getShadowOffset(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("StyleBoxFlat", "get_shadow_offset", 3341600327L), hostObject.objectPtr)
