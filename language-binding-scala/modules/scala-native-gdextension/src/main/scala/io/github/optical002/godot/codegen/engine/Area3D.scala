...
abstract class Area3D extends CollisionObject3D {
  ...
  final def setGravityPointCenter(center: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getGravityPointCenter(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("Area3D", "get_gravity_point_center", 3360562783L), hostObject.objectPtr)

  /** Area3D.set_gravity_direction */
  final def setGravityDirection(direction: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getGravityDirection(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("Area3D", "get_gravity_direction", 3360562783L), hostObject.objectPtr)
  ...
  final def setAudioBusName(name: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def getAudioBusName(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("Area3D", "get_audio_bus_name", 2002593661L), hostObject.objectPtr)
  ...
  final def setReverbBusName(name: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def getReverbBusName(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("Area3D", "get_reverb_bus_name", 2002593661L), hostObject.objectPtr)
