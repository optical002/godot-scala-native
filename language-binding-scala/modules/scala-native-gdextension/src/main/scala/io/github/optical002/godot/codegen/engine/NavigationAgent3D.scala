...
abstract class NavigationAgent3D extends Node {
  ...
  final def setTargetPosition(position: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getTargetPosition(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("NavigationAgent3D", "get_target_position", 3360562783L), hostObject.objectPtr)
  ...
  final def getNextPathPosition(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("NavigationAgent3D", "get_next_path_position", 3783033775L), hostObject.objectPtr)

  /** NavigationAgent3D.set_velocity_forced */
  final def setVelocityForced(velocity: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getVelocity(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("NavigationAgent3D", "get_velocity", 3783033775L), hostObject.objectPtr)
  ...
  final def getFinalPosition(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("NavigationAgent3D", "get_final_position", 3783033775L), hostObject.objectPtr)
  ...
  final def setDebugPathCustomColor(color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getDebugPathCustomColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("NavigationAgent3D", "get_debug_path_custom_color", 3444240500L), hostObject.objectPtr)
