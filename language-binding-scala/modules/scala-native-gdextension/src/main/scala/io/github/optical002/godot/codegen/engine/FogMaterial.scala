...
abstract class FogMaterial extends Material {
  ...
  final def getAlbedo(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("FogMaterial", "get_albedo", 3444240500L), hostObject.objectPtr)
  ...
  final def getEmission(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("FogMaterial", "get_emission", 3444240500L), hostObject.objectPtr)
