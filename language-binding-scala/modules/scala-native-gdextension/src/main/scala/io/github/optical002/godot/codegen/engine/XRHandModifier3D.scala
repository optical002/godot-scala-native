...
abstract class XRHandModifier3D extends SkeletonModifier3D {
  ...
  final def setHandTracker(tracker_name: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def getHandTracker(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("XRHandModifier3D", "get_hand_tracker", 2002593661L), hostObject.objectPtr)
