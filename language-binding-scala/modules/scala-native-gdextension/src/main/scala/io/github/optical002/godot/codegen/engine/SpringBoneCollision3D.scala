...
abstract class SpringBoneCollision3D extends Node3D {
  ...
  final def setPositionOffset(offset: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getPositionOffset(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("SpringBoneCollision3D", "get_position_offset", 3360562783L), hostObject.objectPtr)

  /** SpringBoneCollision3D.set_rotation_offset */
  final def setRotationOffset(offset: io.github.optical002.godot.builtin.Quaternion): Unit =
  ...
  final def getRotationOffset(): io.github.optical002.godot.builtin.Quaternion =
    Ptrcall.call0[io.github.optical002.godot.builtin.Quaternion](MethodBind.get("SpringBoneCollision3D", "get_rotation_offset", 1222331677L), hostObject.objectPtr)
