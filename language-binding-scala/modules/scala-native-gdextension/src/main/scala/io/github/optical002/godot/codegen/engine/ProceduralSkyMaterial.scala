...
abstract class ProceduralSkyMaterial extends Material {
  ...
  final def setSkyTopColor(color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getSkyTopColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("ProceduralSkyMaterial", "get_sky_top_color", 3444240500L), hostObject.objectPtr)

  /** ProceduralSkyMaterial.set_sky_horizon_color */
  final def setSkyHorizonColor(color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getSkyHorizonColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("ProceduralSkyMaterial", "get_sky_horizon_color", 3444240500L), hostObject.objectPtr)
  ...
  final def setSkyCoverModulate(color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getSkyCoverModulate(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("ProceduralSkyMaterial", "get_sky_cover_modulate", 3444240500L), hostObject.objectPtr)

  /** ProceduralSkyMaterial.set_ground_bottom_color */
  final def setGroundBottomColor(color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getGroundBottomColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("ProceduralSkyMaterial", "get_ground_bottom_color", 3444240500L), hostObject.objectPtr)

  /** ProceduralSkyMaterial.set_ground_horizon_color */
  final def setGroundHorizonColor(color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getGroundHorizonColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("ProceduralSkyMaterial", "get_ground_horizon_color", 3444240500L), hostObject.objectPtr)
