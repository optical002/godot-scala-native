...
abstract class GPUParticles3D extends GeometryInstance3D {
  ...
  final def getVisibilityAabb(): io.github.optical002.godot.builtin.AABB =
    Ptrcall.call0[io.github.optical002.godot.builtin.AABB](MethodBind.get("GPUParticles3D", "get_visibility_aabb", 1068685055L), hostObject.objectPtr)
  ...
  final def captureAabb(): io.github.optical002.godot.builtin.AABB =
    Ptrcall.call0[io.github.optical002.godot.builtin.AABB](MethodBind.get("GPUParticles3D", "capture_aabb", 1068685055L), hostObject.objectPtr)

  /** GPUParticles3D.emit_particle */
  final def emitParticle(xform: io.github.optical002.godot.builtin.Transform3D, velocity: io.github.optical002.godot.builtin.Vector3, color: io.github.optical002.godot.builtin.Color, custom: io.github.optical002.godot.builtin.Color, flags: Long): Unit =
