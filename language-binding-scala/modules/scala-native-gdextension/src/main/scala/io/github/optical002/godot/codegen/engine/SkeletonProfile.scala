...
abstract class SkeletonProfile extends Resource {
  ...
  final def setRootBone(bone_name: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def getRootBone(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("SkeletonProfile", "get_root_bone", 2737447660L), hostObject.objectPtr)

  /** SkeletonProfile.set_scale_base_bone */
  final def setScaleBaseBone(bone_name: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def getScaleBaseBone(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("SkeletonProfile", "get_scale_base_bone", 2737447660L), hostObject.objectPtr)
  ...
  final def getGroupName(group_idx: Long): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.StringName](MethodBind.get("SkeletonProfile", "get_group_name", 659327637L), hostObject.objectPtr, group_idx)

  /** SkeletonProfile.set_group_name */
  final def setGroupName(group_idx: Long, group_name: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def findBone(bone_name: io.github.optical002.godot.builtin.StringName): Long =
    Ptrcall.call1[io.github.optical002.godot.builtin.StringName, Long](MethodBind.get("SkeletonProfile", "find_bone", 2458036349L), hostObject.objectPtr, bone_name)

  /** SkeletonProfile.get_bone_name */
  final def getBoneName(bone_idx: Long): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.StringName](MethodBind.get("SkeletonProfile", "get_bone_name", 659327637L), hostObject.objectPtr, bone_idx)

  /** SkeletonProfile.set_bone_name */
  final def setBoneName(bone_idx: Long, bone_name: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def getBoneParent(bone_idx: Long): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.StringName](MethodBind.get("SkeletonProfile", "get_bone_parent", 659327637L), hostObject.objectPtr, bone_idx)

  /** SkeletonProfile.set_bone_parent */
  final def setBoneParent(bone_idx: Long, bone_parent: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def getBoneTail(bone_idx: Long): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.StringName](MethodBind.get("SkeletonProfile", "get_bone_tail", 659327637L), hostObject.objectPtr, bone_idx)

  /** SkeletonProfile.set_bone_tail */
  final def setBoneTail(bone_idx: Long, bone_tail: io.github.optical002.godot.builtin.StringName): Unit =
  ...
  final def getReferencePose(bone_idx: Long): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Transform3D](MethodBind.get("SkeletonProfile", "get_reference_pose", 1965739696L), hostObject.objectPtr, bone_idx)

  /** SkeletonProfile.set_reference_pose */
  final def setReferencePose(bone_idx: Long, bone_name: io.github.optical002.godot.builtin.Transform3D): Unit =
  ...
  final def getHandleOffset(bone_idx: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("SkeletonProfile", "get_handle_offset", 2299179447L), hostObject.objectPtr, bone_idx)

  /** SkeletonProfile.set_handle_offset */
  final def setHandleOffset(bone_idx: Long, handle_offset: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getGroup(bone_idx: Long): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.StringName](MethodBind.get("SkeletonProfile", "get_group", 659327637L), hostObject.objectPtr, bone_idx)

  /** SkeletonProfile.set_group */
  final def setGroup(bone_idx: Long, group: io.github.optical002.godot.builtin.StringName): Unit =
