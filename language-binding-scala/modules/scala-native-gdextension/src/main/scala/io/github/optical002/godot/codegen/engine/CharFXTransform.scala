...
abstract class CharFXTransform extends RefCounted {
  ...
  final def getTransform(): io.github.optical002.godot.builtin.Transform2D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform2D](MethodBind.get("CharFXTransform", "get_transform", 3761352769L), hostObject.objectPtr)
  ...
  final def getRange(): io.github.optical002.godot.builtin.Vector2i =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2i](MethodBind.get("CharFXTransform", "get_range", 2741790807L), hostObject.objectPtr)

  /** CharFXTransform.set_range */
  final def setRange(range: io.github.optical002.godot.builtin.Vector2i): Unit =
  ...
  final def getOffset(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("CharFXTransform", "get_offset", 1497962370L), hostObject.objectPtr)
  ...
  final def getColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("CharFXTransform", "get_color", 3200896285L), hostObject.objectPtr)
