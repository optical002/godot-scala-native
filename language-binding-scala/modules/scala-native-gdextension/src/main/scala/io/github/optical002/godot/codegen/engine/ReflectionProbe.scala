...
abstract class ReflectionProbe extends VisualInstance3D {
  ...
  final def setAmbientColor(ambient: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getAmbientColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("ReflectionProbe", "get_ambient_color", 3444240500L), hostObject.objectPtr)
  ...
  final def getSize(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("ReflectionProbe", "get_size", 3360562783L), hostObject.objectPtr)

  /** ReflectionProbe.set_origin_offset */
  final def setOriginOffset(origin_offset: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getOriginOffset(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("ReflectionProbe", "get_origin_offset", 3360562783L), hostObject.objectPtr)
