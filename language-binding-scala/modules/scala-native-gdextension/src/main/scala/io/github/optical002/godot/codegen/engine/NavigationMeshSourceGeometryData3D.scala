...
abstract class NavigationMeshSourceGeometryData3D extends Resource {
  ...
  final def addMesh(mesh: Mesh, xform: io.github.optical002.godot.builtin.Transform3D): Unit =
  ...
  final def getBounds(): io.github.optical002.godot.builtin.AABB =
    Ptrcall.call0[io.github.optical002.godot.builtin.AABB](MethodBind.get("NavigationMeshSourceGeometryData3D", "get_bounds", 1021181044L), hostObject.objectPtr)
