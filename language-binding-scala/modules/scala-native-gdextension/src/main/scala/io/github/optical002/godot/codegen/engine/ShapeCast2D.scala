...
abstract class ShapeCast2D extends Node2D {
  ...
  final def setTargetPosition(local_point: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getTargetPosition(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("ShapeCast2D", "get_target_position", 3341600327L), hostObject.objectPtr)
  ...
  final def getCollisionPoint(index: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("ShapeCast2D", "get_collision_point", 2299179447L), hostObject.objectPtr, index)

  /** ShapeCast2D.get_collision_normal */
  final def getCollisionNormal(index: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("ShapeCast2D", "get_collision_normal", 2299179447L), hostObject.objectPtr, index)
