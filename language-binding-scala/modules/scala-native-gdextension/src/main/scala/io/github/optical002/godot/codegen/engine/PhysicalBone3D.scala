...
abstract class PhysicalBone3D extends PhysicsBody3D {
  ...
  final def setJointOffset(offset: io.github.optical002.godot.builtin.Transform3D): Unit =
  ...
  final def getJointOffset(): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform3D](MethodBind.get("PhysicalBone3D", "get_joint_offset", 3229777777L), hostObject.objectPtr)

  /** PhysicalBone3D.set_joint_rotation */
  final def setJointRotation(euler: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getJointRotation(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("PhysicalBone3D", "get_joint_rotation", 3360562783L), hostObject.objectPtr)

  /** PhysicalBone3D.set_body_offset */
  final def setBodyOffset(offset: io.github.optical002.godot.builtin.Transform3D): Unit =
  ...
  final def getBodyOffset(): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform3D](MethodBind.get("PhysicalBone3D", "get_body_offset", 3229777777L), hostObject.objectPtr)
  ...
  final def getLinearVelocity(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("PhysicalBone3D", "get_linear_velocity", 3360562783L), hostObject.objectPtr)
  ...
  final def getAngularVelocity(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("PhysicalBone3D", "get_angular_velocity", 3360562783L), hostObject.objectPtr)
