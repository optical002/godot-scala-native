...
abstract class StyleBoxTexture extends StyleBox {
  ...
  final def setRegionRect(region: io.github.optical002.godot.builtin.Rect2): Unit =
  ...
  final def getRegionRect(): io.github.optical002.godot.builtin.Rect2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Rect2](MethodBind.get("StyleBoxTexture", "get_region_rect", 1639390495L), hostObject.objectPtr)
  ...
  final def setModulate(color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getModulate(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("StyleBoxTexture", "get_modulate", 3444240500L), hostObject.objectPtr)
