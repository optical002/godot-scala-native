...
abstract class PhysicsTestMotionParameters2D extends RefCounted {
  ...
  final def getFrom(): io.github.optical002.godot.builtin.Transform2D =
    Ptrcall.call0[io.github.optical002.godot.builtin.Transform2D](MethodBind.get("PhysicsTestMotionParameters2D", "get_from", 3814499831L), hostObject.objectPtr)

  /** PhysicsTestMotionParameters2D.set_from */
  final def setFrom(from: io.github.optical002.godot.builtin.Transform2D): Unit =
  ...
  final def getMotion(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("PhysicsTestMotionParameters2D", "get_motion", 3341600327L), hostObject.objectPtr)
