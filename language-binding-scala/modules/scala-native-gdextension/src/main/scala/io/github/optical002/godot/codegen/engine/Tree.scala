...
abstract class Tree extends Control {
  ...
  final def getCustomPopupRect(): io.github.optical002.godot.builtin.Rect2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Rect2](MethodBind.get("Tree", "get_custom_popup_rect", 1639390495L), hostObject.objectPtr)

  /** Tree.get_item_area_rect */
  final def getItemAreaRect(item: TreeItem, column: Long, button_index: Long): io.github.optical002.godot.builtin.Rect2 =
    Ptrcall.call3[GodotObject, Long, Long, io.github.optical002.godot.builtin.Rect2](MethodBind.get("Tree", "get_item_area_rect", 47968679L), hostObject.objectPtr, item.hostObject, column, button_index)

  /** Tree.get_item_at_position */
  final def getItemAtPosition(position: io.github.optical002.godot.builtin.Vector2): GodotObject =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2, GodotObject](MethodBind.get("Tree", "get_item_at_position", 4193340126L), hostObject.objectPtr, position)

  /** Tree.get_column_at_position */
  final def getColumnAtPosition(position: io.github.optical002.godot.builtin.Vector2): Long =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2, Long](MethodBind.get("Tree", "get_column_at_position", 3820158470L), hostObject.objectPtr, position)

  /** Tree.get_drop_section_at_position */
  final def getDropSectionAtPosition(position: io.github.optical002.godot.builtin.Vector2): Long =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2, Long](MethodBind.get("Tree", "get_drop_section_at_position", 3820158470L), hostObject.objectPtr, position)

  /** Tree.get_button_id_at_position */
  final def getButtonIdAtPosition(position: io.github.optical002.godot.builtin.Vector2): Long =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2, Long](MethodBind.get("Tree", "get_button_id_at_position", 3820158470L), hostObject.objectPtr, position)
  ...
  /** Tree.get_scroll */
  final def getScroll(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("Tree", "get_scroll", 3341600327L), hostObject.objectPtr)
