...
abstract class ShapeCast3D extends Node3D {
  ...
  final def setTargetPosition(local_point: io.github.optical002.godot.builtin.Vector3): Unit =
  ...
  final def getTargetPosition(): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector3](MethodBind.get("ShapeCast3D", "get_target_position", 3360562783L), hostObject.objectPtr)
  ...
  final def getCollisionPoint(index: Long): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector3](MethodBind.get("ShapeCast3D", "get_collision_point", 711720468L), hostObject.objectPtr, index)

  /** ShapeCast3D.get_collision_normal */
  final def getCollisionNormal(index: Long): io.github.optical002.godot.builtin.Vector3 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector3](MethodBind.get("ShapeCast3D", "get_collision_normal", 711720468L), hostObject.objectPtr, index)
  ...
  final def setDebugShapeCustomColor(debug_shape_custom_color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getDebugShapeCustomColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("ShapeCast3D", "get_debug_shape_custom_color", 3444240500L), hostObject.objectPtr)
