...
abstract class PhysicalSkyMaterial extends Material {
  ...
  final def setRayleighColor(color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getRayleighColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("PhysicalSkyMaterial", "get_rayleigh_color", 3444240500L), hostObject.objectPtr)
  ...
  final def setMieColor(color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getMieColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("PhysicalSkyMaterial", "get_mie_color", 3444240500L), hostObject.objectPtr)
  ...
  final def setGroundColor(color: io.github.optical002.godot.builtin.Color): Unit =
  ...
  final def getGroundColor(): io.github.optical002.godot.builtin.Color =
    Ptrcall.call0[io.github.optical002.godot.builtin.Color](MethodBind.get("PhysicalSkyMaterial", "get_ground_color", 3444240500L), hostObject.objectPtr)
