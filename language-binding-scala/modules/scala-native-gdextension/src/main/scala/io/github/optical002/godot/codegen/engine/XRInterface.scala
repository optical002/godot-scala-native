...
abstract class XRInterface extends RefCounted {
  ...
  final def getName(): io.github.optical002.godot.builtin.StringName =
    Ptrcall.call0[io.github.optical002.godot.builtin.StringName](MethodBind.get("XRInterface", "get_name", 2002593661L), hostObject.objectPtr)
  ...
  final def getRenderTargetSize(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("XRInterface", "get_render_target_size", 1497962370L), hostObject.objectPtr)
  ...
  final def triggerHapticPulse(action_name: String, tracker_name: io.github.optical002.godot.builtin.StringName, frequency: Double, amplitude: Double, duration_sec: Double, delay_sec: Double): Unit =
  ...
  final def getTransformForView(view: Long, cam_transform: io.github.optical002.godot.builtin.Transform3D): io.github.optical002.godot.builtin.Transform3D =
    Ptrcall.call2[Long, io.github.optical002.godot.builtin.Transform3D, io.github.optical002.godot.builtin.Transform3D](MethodBind.get("XRInterface", "get_transform_for_view", 518934792L), hostObject.objectPtr, view, cam_transform)

  /** XRInterface.get_projection_for_view */
  final def getProjectionForView(view: Long, aspect: Double, near: Double, far: Double): io.github.optical002.godot.builtin.Projection =
    Ptrcall.call4[Long, Double, Double, Double, io.github.optical002.godot.builtin.Projection](MethodBind.get("XRInterface", "get_projection_for_view", 3766090294L), hostObject.objectPtr, view, aspect, near, far)
