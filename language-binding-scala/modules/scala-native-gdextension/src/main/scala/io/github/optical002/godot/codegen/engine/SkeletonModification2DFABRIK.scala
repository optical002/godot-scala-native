...
abstract class SkeletonModification2DFABRIK extends SkeletonModification2D {
  ...
  final def setFabrikJointMagnetPosition(joint_idx: Long, magnet_position: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getFabrikJointMagnetPosition(joint_idx: Long): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Vector2](MethodBind.get("SkeletonModification2DFABRIK", "get_fabrik_joint_magnet_position", 2299179447L), hostObject.objectPtr, joint_idx)
