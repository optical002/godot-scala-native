...
abstract class RigidBody2D extends PhysicsBody2D {
  ...
  final def setCenterOfMass(center_of_mass: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getCenterOfMass(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("RigidBody2D", "get_center_of_mass", 3341600327L), hostObject.objectPtr)
  ...
  final def setLinearVelocity(linear_velocity: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getLinearVelocity(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("RigidBody2D", "get_linear_velocity", 3341600327L), hostObject.objectPtr)
  ...
  final def setAxisVelocity(axis_velocity: io.github.optical002.godot.builtin.Vector2): Unit =
  ...
  final def getConstantForce(): io.github.optical002.godot.builtin.Vector2 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector2](MethodBind.get("RigidBody2D", "get_constant_force", 3341600327L), hostObject.objectPtr)
