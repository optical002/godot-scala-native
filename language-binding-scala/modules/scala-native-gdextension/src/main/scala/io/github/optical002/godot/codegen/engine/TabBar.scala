...
abstract class TabBar extends Control {
  ...
  final def getTabIdxAtPoint(point: io.github.optical002.godot.builtin.Vector2): Long =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2, Long](MethodBind.get("TabBar", "get_tab_idx_at_point", 3820158470L), hostObject.objectPtr, point)
  ...
  /** TabBar.get_tab_rect */
  final def getTabRect(tab_idx: Long): io.github.optical002.godot.builtin.Rect2 =
    Ptrcall.call1[Long, io.github.optical002.godot.builtin.Rect2](MethodBind.get("TabBar", "get_tab_rect", 3327874267L), hostObject.objectPtr, tab_idx)
