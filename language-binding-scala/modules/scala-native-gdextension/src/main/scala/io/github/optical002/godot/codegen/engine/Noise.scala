...
abstract class Noise extends Resource {
  ...
  /** Noise.get_noise_2dv */
  final def getNoise2dv(v: io.github.optical002.godot.builtin.Vector2): Double =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector2, Double](MethodBind.get("Noise", "get_noise_2dv", 2276447920L), hostObject.objectPtr, v)
  ...
  /** Noise.get_noise_3dv */
  final def getNoise3dv(v: io.github.optical002.godot.builtin.Vector3): Double =
    Ptrcall.call1[io.github.optical002.godot.builtin.Vector3, Double](MethodBind.get("Noise", "get_noise_3dv", 1109078154L), hostObject.objectPtr, v)
