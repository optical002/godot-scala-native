...
abstract class VisualShaderNodeVec4Parameter extends VisualShaderNodeParameter {
  ...
  final def setDefaultValue(value: io.github.optical002.godot.builtin.Vector4): Unit =
  ...
  final def getDefaultValue(): io.github.optical002.godot.builtin.Vector4 =
    Ptrcall.call0[io.github.optical002.godot.builtin.Vector4](MethodBind.get("VisualShaderNodeVec4Parameter", "get_default_value", 2435802345L), hostObject.objectPtr)
