...
abstract class RigidBody3D extends PhysicsBody3D {
  ...
  final def setInertia(inertia: gdext.builtin.Vector3): Unit =
    Ptrcall.callVoid1(MethodBind.get("RigidBody3D", "set_inertia", 3460891852L), hostObject.objectPtr, inertia)

  /** RigidBody3D.get_inertia */
  final def getInertia(): gdext.builtin.Vector3 =
    Ptrcall.call0[gdext.builtin.Vector3](MethodBind.get("RigidBody3D", "get_inertia", 3360562783L), hostObject.objectPtr)
  ...
  final def getCenterOfMass(): gdext.builtin.Vector3 =
    Ptrcall.call0[gdext.builtin.Vector3](MethodBind.get("RigidBody3D", "get_center_of_mass", 3360562783L), hostObject.objectPtr)
  ...
  final def getLinearVelocity(): gdext.builtin.Vector3 =
    Ptrcall.call0[gdext.builtin.Vector3](MethodBind.get("RigidBody3D", "get_linear_velocity", 3360562783L), hostObject.objectPtr)
  ...
  final def getAngularVelocity(): gdext.builtin.Vector3 =
    Ptrcall.call0[gdext.builtin.Vector3](MethodBind.get("RigidBody3D", "get_angular_velocity", 3360562783L), hostObject.objectPtr)

  /** RigidBody3D.get_inverse_inertia_tensor */
  final def getInverseInertiaTensor(): gdext.builtin.Basis =
    Ptrcall.call0[gdext.builtin.Basis](MethodBind.get("RigidBody3D", "get_inverse_inertia_tensor", 2716978435L), hostObject.objectPtr)
  ...
  final def setAxisVelocity(axis_velocity: gdext.builtin.Vector3): Unit =
  ...
  final def getConstantForce(): gdext.builtin.Vector3 =
    Ptrcall.call0[gdext.builtin.Vector3](MethodBind.get("RigidBody3D", "get_constant_force", 3360562783L), hostObject.objectPtr)
  ...
  final def getConstantTorque(): gdext.builtin.Vector3 =
    Ptrcall.call0[gdext.builtin.Vector3](MethodBind.get("RigidBody3D", "get_constant_torque", 3360562783L), hostObject.objectPtr)
