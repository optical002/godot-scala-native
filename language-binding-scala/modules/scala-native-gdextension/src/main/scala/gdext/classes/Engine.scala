...
abstract class Engine extends Object {
  ...
  final def hasSingleton(name: gdext.builtin.StringName): Boolean =
    Ptrcall.call1[gdext.builtin.StringName, Boolean](MethodBind.get("Engine", "has_singleton", 2619796661L), hostObject.objectPtr, name)

  /** Engine.get_singleton */
  final def getSingleton(name: gdext.builtin.StringName): GodotObject =
    Ptrcall.call1[gdext.builtin.StringName, GodotObject](MethodBind.get("Engine", "get_singleton", 1371597918L), hostObject.objectPtr, name)

  /** Engine.register_singleton */
  final def registerSingleton(name: gdext.builtin.StringName, instance: Object): Unit =
  ...
  final def unregisterSingleton(name: gdext.builtin.StringName): Unit =
