...
abstract class GLTFNode extends Resource {
  ...
  /** GLTFNode.get_xform */
  final def getXform(): gdext.builtin.Transform3D =
    Ptrcall.call0[gdext.builtin.Transform3D](MethodBind.get("GLTFNode", "get_xform", 4183770049L), hostObject.objectPtr)

  /** GLTFNode.set_xform */
  final def setXform(xform: gdext.builtin.Transform3D): Unit =
  ...
  final def getPosition(): gdext.builtin.Vector3 =
    Ptrcall.call0[gdext.builtin.Vector3](MethodBind.get("GLTFNode", "get_position", 3783033775L), hostObject.objectPtr)
  ...
  final def getRotation(): gdext.builtin.Quaternion =
    Ptrcall.call0[gdext.builtin.Quaternion](MethodBind.get("GLTFNode", "get_rotation", 2916281908L), hostObject.objectPtr)

  /** GLTFNode.set_rotation */
  final def setRotation(rotation: gdext.builtin.Quaternion): Unit =
  ...
  final def getScale(): gdext.builtin.Vector3 =
    Ptrcall.call0[gdext.builtin.Vector3](MethodBind.get("GLTFNode", "get_scale", 3783033775L), hostObject.objectPtr)
