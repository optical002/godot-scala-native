...
abstract class Parallax2D extends Node2D {
  ...
  final def getScrollScale(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("Parallax2D", "get_scroll_scale", 3341600327L), hostObject.objectPtr)

  /** Parallax2D.set_repeat_size */
  final def setRepeatSize(repeat_size: gdext.builtin.Vector2): Unit =
  ...
  final def getRepeatSize(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("Parallax2D", "get_repeat_size", 3341600327L), hostObject.objectPtr)
  ...
  final def setAutoscroll(autoscroll: gdext.builtin.Vector2): Unit =
  ...
  final def getAutoscroll(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("Parallax2D", "get_autoscroll", 3341600327L), hostObject.objectPtr)
  ...
  final def getScrollOffset(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("Parallax2D", "get_scroll_offset", 3341600327L), hostObject.objectPtr)

  /** Parallax2D.set_screen_offset */
  final def setScreenOffset(offset: gdext.builtin.Vector2): Unit =
  ...
  final def getScreenOffset(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("Parallax2D", "get_screen_offset", 3341600327L), hostObject.objectPtr)
  ...
  final def getLimitBegin(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("Parallax2D", "get_limit_begin", 3341600327L), hostObject.objectPtr)
  ...
  final def getLimitEnd(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("Parallax2D", "get_limit_end", 3341600327L), hostObject.objectPtr)
