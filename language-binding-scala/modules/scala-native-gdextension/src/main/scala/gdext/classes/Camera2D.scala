...
abstract class Camera2D extends Node2D {
  ...
  final def getOffset(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("Camera2D", "get_offset", 3341600327L), hostObject.objectPtr)
  ...
  final def getTargetPosition(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("Camera2D", "get_target_position", 3341600327L), hostObject.objectPtr)

  /** Camera2D.get_screen_center_position */
  final def getScreenCenterPosition(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("Camera2D", "get_screen_center_position", 3341600327L), hostObject.objectPtr)
  ...
  /** Camera2D.set_zoom */
  final def setZoom(zoom: gdext.builtin.Vector2): Unit =
    Ptrcall.callVoid1(MethodBind.get("Camera2D", "set_zoom", 743155724L), hostObject.objectPtr, zoom)

  /** Camera2D.get_zoom */
  final def getZoom(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("Camera2D", "get_zoom", 3341600327L), hostObject.objectPtr)
