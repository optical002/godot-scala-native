...
abstract class CodeEdit extends TextEdit {
  ...
  final def getDelimiterStartPosition(line: Long, column: Long): gdext.builtin.Vector2 =
    Ptrcall.call2[Long, Long, gdext.builtin.Vector2](MethodBind.get("CodeEdit", "get_delimiter_start_position", 3016396712L), hostObject.objectPtr, line, column)

  /** CodeEdit.get_delimiter_end_position */
  final def getDelimiterEndPosition(line: Long, column: Long): gdext.builtin.Vector2 =
    Ptrcall.call2[Long, Long, gdext.builtin.Vector2](MethodBind.get("CodeEdit", "get_delimiter_end_position", 3016396712L), hostObject.objectPtr, line, column)
