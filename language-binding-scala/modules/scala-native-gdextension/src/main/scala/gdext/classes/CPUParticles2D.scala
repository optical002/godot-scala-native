...
abstract class CPUParticles2D extends Node2D {
  ...
  final def setDirection(direction: gdext.builtin.Vector2): Unit =
  ...
  final def getDirection(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("CPUParticles2D", "get_direction", 3341600327L), hostObject.objectPtr)
  ...
  final def getColor(): gdext.builtin.Color =
    Ptrcall.call0[gdext.builtin.Color](MethodBind.get("CPUParticles2D", "get_color", 3444240500L), hostObject.objectPtr)
  ...
  final def setEmissionRectExtents(extents: gdext.builtin.Vector2): Unit =
  ...
  final def getEmissionRectExtents(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("CPUParticles2D", "get_emission_rect_extents", 3341600327L), hostObject.objectPtr)
  ...
  final def getGravity(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("CPUParticles2D", "get_gravity", 3341600327L), hostObject.objectPtr)

  /** CPUParticles2D.set_gravity */
  final def setGravity(accel_vec: gdext.builtin.Vector2): Unit =
