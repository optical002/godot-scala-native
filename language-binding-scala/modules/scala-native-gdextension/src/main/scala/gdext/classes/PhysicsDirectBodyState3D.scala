...
abstract class PhysicsDirectBodyState3D extends Object {
  override def godotClassName: String = "PhysicsDirectBodyState3D"

  /** PhysicsDirectBodyState3D.get_total_gravity */
  final def getTotalGravity(): gdext.builtin.Vector3 =
    Ptrcall.call0[gdext.builtin.Vector3](MethodBind.get("PhysicsDirectBodyState3D", "get_total_gravity", 3360562783L), hostObject.objectPtr)
  ...
  final def getCenterOfMass(): gdext.builtin.Vector3 =
    Ptrcall.call0[gdext.builtin.Vector3](MethodBind.get("PhysicsDirectBodyState3D", "get_center_of_mass", 3360562783L), hostObject.objectPtr)

  /** PhysicsDirectBodyState3D.get_center_of_mass_local */
  final def getCenterOfMassLocal(): gdext.builtin.Vector3 =
    Ptrcall.call0[gdext.builtin.Vector3](MethodBind.get("PhysicsDirectBodyState3D", "get_center_of_mass_local", 3360562783L), hostObject.objectPtr)

  /** PhysicsDirectBodyState3D.get_principal_inertia_axes */
  final def getPrincipalInertiaAxes(): gdext.builtin.Basis =
    Ptrcall.call0[gdext.builtin.Basis](MethodBind.get("PhysicsDirectBodyState3D", "get_principal_inertia_axes", 2716978435L), hostObject.objectPtr)
  ...
  final def getInverseInertia(): gdext.builtin.Vector3 =
    Ptrcall.call0[gdext.builtin.Vector3](MethodBind.get("PhysicsDirectBodyState3D", "get_inverse_inertia", 3360562783L), hostObject.objectPtr)

  /** PhysicsDirectBodyState3D.get_inverse_inertia_tensor */
  final def getInverseInertiaTensor(): gdext.builtin.Basis =
    Ptrcall.call0[gdext.builtin.Basis](MethodBind.get("PhysicsDirectBodyState3D", "get_inverse_inertia_tensor", 2716978435L), hostObject.objectPtr)
  ...
  final def getLinearVelocity(): gdext.builtin.Vector3 =
    Ptrcall.call0[gdext.builtin.Vector3](MethodBind.get("PhysicsDirectBodyState3D", "get_linear_velocity", 3360562783L), hostObject.objectPtr)
  ...
  final def getAngularVelocity(): gdext.builtin.Vector3 =
    Ptrcall.call0[gdext.builtin.Vector3](MethodBind.get("PhysicsDirectBodyState3D", "get_angular_velocity", 3360562783L), hostObject.objectPtr)
  ...
  final def getTransform(): gdext.builtin.Transform3D =
    Ptrcall.call0[gdext.builtin.Transform3D](MethodBind.get("PhysicsDirectBodyState3D", "get_transform", 3229777777L), hostObject.objectPtr)

  /** PhysicsDirectBodyState3D.get_velocity_at_local_position */
  final def getVelocityAtLocalPosition(local_position: gdext.builtin.Vector3): gdext.builtin.Vector3 =
    Ptrcall.call1[gdext.builtin.Vector3, gdext.builtin.Vector3](MethodBind.get("PhysicsDirectBodyState3D", "get_velocity_at_local_position", 192990374L), hostObject.objectPtr, local_position)
  ...
  final def applyTorqueImpulse(impulse: gdext.builtin.Vector3): Unit =
  ...
  final def applyForce(force: gdext.builtin.Vector3, position: gdext.builtin.Vector3): Unit =
  ...
  final def applyTorque(torque: gdext.builtin.Vector3): Unit =
  ...
  final def addConstantCentralForce(force: gdext.builtin.Vector3): Unit =
  ...
  final def addConstantForce(force: gdext.builtin.Vector3, position: gdext.builtin.Vector3): Unit =
  ...
  final def addConstantTorque(torque: gdext.builtin.Vector3): Unit =
  ...
  final def setConstantForce(force: gdext.builtin.Vector3): Unit =
  ...
  final def getConstantForce(): gdext.builtin.Vector3 =
    Ptrcall.call0[gdext.builtin.Vector3](MethodBind.get("PhysicsDirectBodyState3D", "get_constant_force", 3360562783L), hostObject.objectPtr)

  /** PhysicsDirectBodyState3D.set_constant_torque */
  final def setConstantTorque(torque: gdext.builtin.Vector3): Unit =
  ...
  final def getConstantTorque(): gdext.builtin.Vector3 =
    Ptrcall.call0[gdext.builtin.Vector3](MethodBind.get("PhysicsDirectBodyState3D", "get_constant_torque", 3360562783L), hostObject.objectPtr)
  ...
  final def getContactLocalPosition(contact_idx: Long): gdext.builtin.Vector3 =
    Ptrcall.call1[Long, gdext.builtin.Vector3](MethodBind.get("PhysicsDirectBodyState3D", "get_contact_local_position", 711720468L), hostObject.objectPtr, contact_idx)

  /** PhysicsDirectBodyState3D.get_contact_local_normal */
  final def getContactLocalNormal(contact_idx: Long): gdext.builtin.Vector3 =
    Ptrcall.call1[Long, gdext.builtin.Vector3](MethodBind.get("PhysicsDirectBodyState3D", "get_contact_local_normal", 711720468L), hostObject.objectPtr, contact_idx)

  /** PhysicsDirectBodyState3D.get_contact_impulse */
  final def getContactImpulse(contact_idx: Long): gdext.builtin.Vector3 =
    Ptrcall.call1[Long, gdext.builtin.Vector3](MethodBind.get("PhysicsDirectBodyState3D", "get_contact_impulse", 711720468L), hostObject.objectPtr, contact_idx)
  ...
  final def getContactLocalVelocityAtPosition(contact_idx: Long): gdext.builtin.Vector3 =
    Ptrcall.call1[Long, gdext.builtin.Vector3](MethodBind.get("PhysicsDirectBodyState3D", "get_contact_local_velocity_at_position", 711720468L), hostObject.objectPtr, contact_idx)

  /** PhysicsDirectBodyState3D.get_contact_collider_position */
  final def getContactColliderPosition(contact_idx: Long): gdext.builtin.Vector3 =
    Ptrcall.call1[Long, gdext.builtin.Vector3](MethodBind.get("PhysicsDirectBodyState3D", "get_contact_collider_position", 711720468L), hostObject.objectPtr, contact_idx)
  ...
  final def getContactColliderVelocityAtPosition(contact_idx: Long): gdext.builtin.Vector3 =
    Ptrcall.call1[Long, gdext.builtin.Vector3](MethodBind.get("PhysicsDirectBodyState3D", "get_contact_collider_velocity_at_position", 711720468L), hostObject.objectPtr, contact_idx)
