...
abstract class CharacterBody2D extends PhysicsBody2D {
  override def godotClassName: String = "CharacterBody2D"
  ...
  final def getVelocity(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("CharacterBody2D", "get_velocity", 3341600327L), hostObject.objectPtr)
  ...
  final def getUpDirection(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("CharacterBody2D", "get_up_direction", 3341600327L), hostObject.objectPtr)

  /** CharacterBody2D.set_up_direction */
  final def setUpDirection(up_direction: gdext.builtin.Vector2): Unit =
  ...
  final def getFloorNormal(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("CharacterBody2D", "get_floor_normal", 3341600327L), hostObject.objectPtr)

  /** CharacterBody2D.get_wall_normal */
  final def getWallNormal(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("CharacterBody2D", "get_wall_normal", 3341600327L), hostObject.objectPtr)

  /** CharacterBody2D.get_last_motion */
  final def getLastMotion(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("CharacterBody2D", "get_last_motion", 3341600327L), hostObject.objectPtr)

  /** CharacterBody2D.get_position_delta */
  final def getPositionDelta(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("CharacterBody2D", "get_position_delta", 3341600327L), hostObject.objectPtr)

  /** CharacterBody2D.get_real_velocity */
  final def getRealVelocity(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("CharacterBody2D", "get_real_velocity", 3341600327L), hostObject.objectPtr)

  /** CharacterBody2D.get_floor_angle */
  final def getFloorAngle(up_direction: gdext.builtin.Vector2): Double =
    Ptrcall.call1[gdext.builtin.Vector2, Double](MethodBind.get("CharacterBody2D", "get_floor_angle", 2841063350L), hostObject.objectPtr, up_direction)

  /** CharacterBody2D.get_platform_velocity */
  final def getPlatformVelocity(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("CharacterBody2D", "get_platform_velocity", 3341600327L), hostObject.objectPtr)
