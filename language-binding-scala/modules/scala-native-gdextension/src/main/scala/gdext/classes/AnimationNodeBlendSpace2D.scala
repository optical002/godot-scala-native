...
abstract class AnimationNodeBlendSpace2D extends AnimationRootNode {
  override def godotClassName: String = "AnimationNodeBlendSpace2D"

  /** AnimationNodeBlendSpace2D.add_blend_point */
  final def addBlendPoint(node: AnimationRootNode, pos: gdext.builtin.Vector2, at_index: Long): Unit =
  ...
  final def setBlendPointPosition(point: Long, pos: gdext.builtin.Vector2): Unit =
  ...
  final def getBlendPointPosition(point: Long): gdext.builtin.Vector2 =
    Ptrcall.call1[Long, gdext.builtin.Vector2](MethodBind.get("AnimationNodeBlendSpace2D", "get_blend_point_position", 2299179447L), hostObject.objectPtr, point)
  ...
  final def setMinSpace(min_space: gdext.builtin.Vector2): Unit =
  ...
  final def getMinSpace(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("AnimationNodeBlendSpace2D", "get_min_space", 3341600327L), hostObject.objectPtr)

  /** AnimationNodeBlendSpace2D.set_max_space */
  final def setMaxSpace(max_space: gdext.builtin.Vector2): Unit =
  ...
  final def getMaxSpace(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("AnimationNodeBlendSpace2D", "get_max_space", 3341600327L), hostObject.objectPtr)

  /** AnimationNodeBlendSpace2D.set_snap */
  final def setSnap(snap: gdext.builtin.Vector2): Unit =
  ...
  final def getSnap(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("AnimationNodeBlendSpace2D", "get_snap", 3341600327L), hostObject.objectPtr)
