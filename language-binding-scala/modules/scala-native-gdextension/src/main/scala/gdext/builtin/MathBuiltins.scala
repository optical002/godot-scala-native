...
object Vector2i {
  private[gdext] def writeType(v: Vector2i, p: GDExtensionTypePtr): Unit = {
    val i = p.asInstanceOf[Ptr[CInt]]; i(0) = v.x; i(1) = v.y
  }
  private[gdext] def readType(p: GDExtensionTypePtr): Vector2i = {
...
object Vector3i {
  private[gdext] def writeType(v: Vector3i, p: GDExtensionTypePtr): Unit = {
    val i = p.asInstanceOf[Ptr[CInt]]; i(0) = v.x; i(1) = v.y; i(2) = v.z
  }
  private[gdext] def readType(p: GDExtensionTypePtr): Vector3i = {
...
object Vector4i {
  private[gdext] def writeType(v: Vector4i, p: GDExtensionTypePtr): Unit = {
    val i = p.asInstanceOf[Ptr[CInt]]
    i(0) = v.x; i(1) = v.y; i(2) = v.z; i(3) = v.w
  }
  private[gdext] def readType(p: GDExtensionTypePtr): Vector4i = {
...
object Vector3 {
  ...
  private[gdext] def readType(p: GDExtensionTypePtr): Vector3 = {
...
object Vector4 {
  private[gdext] def writeType(v: Vector4, p: GDExtensionTypePtr): Unit = {
    val f = p.asInstanceOf[Ptr[CFloat]]
    f(0) = v.x; f(1) = v.y; f(2) = v.z; f(3) = v.w
  }
  private[gdext] def readType(p: GDExtensionTypePtr): Vector4 = {
...
object Rect2 {
  private[gdext] def writeType(r: Rect2, p: GDExtensionTypePtr): Unit = {
    val f = p.asInstanceOf[Ptr[CFloat]]
    f(0) = r.position.x; f(1) = r.position.y; f(2) = r.size.x; f(3) = r.size.y
  }
  private[gdext] def readType(p: GDExtensionTypePtr): Rect2 = {
    val f = p.asInstanceOf[Ptr[CFloat]]
...
object Rect2i {
  private[gdext] def writeType(r: Rect2i, p: GDExtensionTypePtr): Unit = {
    val i = p.asInstanceOf[Ptr[CInt]]
    i(0) = r.position.x; i(1) = r.position.y; i(2) = r.size.x; i(3) = r.size.y
  }
  private[gdext] def readType(p: GDExtensionTypePtr): Rect2i = {
    val i = p.asInstanceOf[Ptr[CInt]]
...
object Quaternion {
  private[gdext] def writeType(q: Quaternion, p: GDExtensionTypePtr): Unit = {
    val f = p.asInstanceOf[Ptr[CFloat]]
    f(0) = q.x; f(1) = q.y; f(2) = q.z; f(3) = q.w
  }
  private[gdext] def readType(p: GDExtensionTypePtr): Quaternion = {
...
object Plane {
  private[gdext] def writeType(pl: Plane, p: GDExtensionTypePtr): Unit = {
    val f = p.asInstanceOf[Ptr[CFloat]]
    f(0) = pl.x; f(1) = pl.y; f(2) = pl.z; f(3) = pl.d
  }
  private[gdext] def readType(p: GDExtensionTypePtr): Plane = {
...
object AABB {
  private[gdext] def writeType(a: AABB, p: GDExtensionTypePtr): Unit = {
    val f = p.asInstanceOf[Ptr[CFloat]]
    f(0) = a.position.x; f(1) = a.position.y; f(2) = a.position.z
    f(3) = a.size.x; f(4) = a.size.y; f(5) = a.size.z
  }
  private[gdext] def readType(p: GDExtensionTypePtr): AABB = {
    val f = p.asInstanceOf[Ptr[CFloat]]
...
object Basis {
  private[gdext] def writeType(b: Basis, p: GDExtensionTypePtr): Unit = {
    val f = p.asInstanceOf[Ptr[CFloat]]
    f(0) = b.row0.x; f(1) = b.row0.y; f(2) = b.row0.z
    f(3) = b.row1.x; f(4) = b.row1.y; f(5) = b.row1.z
    f(6) = b.row2.x; f(7) = b.row2.y; f(8) = b.row2.z
  }
  private[gdext] def readType(p: GDExtensionTypePtr): Basis = {
    val f = p.asInstanceOf[Ptr[CFloat]]
    Basis(
      Vector3(f(0), f(1), f(2)),
      Vector3(f(3), f(4), f(5)),
...
object Transform2D {
  private[gdext] def writeType(t: Transform2D, p: GDExtensionTypePtr): Unit = {
    val f = p.asInstanceOf[Ptr[CFloat]]
    f(0) = t.x.x; f(1) = t.x.y
    f(2) = t.y.x; f(3) = t.y.y
    f(4) = t.origin.x; f(5) = t.origin.y
  }
  private[gdext] def readType(p: GDExtensionTypePtr): Transform2D = {
    val f = p.asInstanceOf[Ptr[CFloat]]
...
object Transform3D {
  private[gdext] def writeType(t: Transform3D, p: GDExtensionTypePtr): Unit = {
    Basis.writeType(t.basis, p)
    val f = p.asInstanceOf[Ptr[CFloat]]
    f(9) = t.origin.x; f(10) = t.origin.y; f(11) = t.origin.z
  }
  private[gdext] def readType(p: GDExtensionTypePtr): Transform3D = {
...
object Projection {
  private[gdext] def writeType(pr: Projection, p: GDExtensionTypePtr): Unit = {
    val f = p.asInstanceOf[Ptr[CFloat]]
  ...
  private[gdext] def readType(p: GDExtensionTypePtr): Projection = {
    val f = p.asInstanceOf[Ptr[CFloat]]
    Projection(
