...
abstract class PhysicsTestMotionResult3D extends RefCounted {
  ...
  final def getTravel(): gdext.builtin.Vector3 =
    Ptrcall.call0[gdext.builtin.Vector3](MethodBind.get("PhysicsTestMotionResult3D", "get_travel", 3360562783L), hostObject.objectPtr)

  /** PhysicsTestMotionResult3D.get_remainder */
  final def getRemainder(): gdext.builtin.Vector3 =
    Ptrcall.call0[gdext.builtin.Vector3](MethodBind.get("PhysicsTestMotionResult3D", "get_remainder", 3360562783L), hostObject.objectPtr)
  ...
  final def getCollisionPoint(collision_index: Long): gdext.builtin.Vector3 =
    Ptrcall.call1[Long, gdext.builtin.Vector3](MethodBind.get("PhysicsTestMotionResult3D", "get_collision_point", 1914908202L), hostObject.objectPtr, collision_index)

  /** PhysicsTestMotionResult3D.get_collision_normal */
  final def getCollisionNormal(collision_index: Long): gdext.builtin.Vector3 =
    Ptrcall.call1[Long, gdext.builtin.Vector3](MethodBind.get("PhysicsTestMotionResult3D", "get_collision_normal", 1914908202L), hostObject.objectPtr, collision_index)

  /** PhysicsTestMotionResult3D.get_collider_velocity */
  final def getColliderVelocity(collision_index: Long): gdext.builtin.Vector3 =
    Ptrcall.call1[Long, gdext.builtin.Vector3](MethodBind.get("PhysicsTestMotionResult3D", "get_collider_velocity", 1914908202L), hostObject.objectPtr, collision_index)
