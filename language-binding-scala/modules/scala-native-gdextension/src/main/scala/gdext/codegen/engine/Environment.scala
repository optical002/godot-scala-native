...
abstract class Environment extends Resource {
  ...
  final def setSkyRotation(euler_radians: gdext.builtin.Vector3): Unit =
  ...
  final def getSkyRotation(): gdext.builtin.Vector3 =
    Ptrcall.call0[gdext.builtin.Vector3](MethodBind.get("Environment", "get_sky_rotation", 3360562783L), hostObject.objectPtr)
  ...
  final def getBgColor(): gdext.builtin.Color =
    Ptrcall.call0[gdext.builtin.Color](MethodBind.get("Environment", "get_bg_color", 3444240500L), hostObject.objectPtr)
  ...
  final def setAmbientLightColor(color: gdext.builtin.Color): Unit =
  ...
  final def getAmbientLightColor(): gdext.builtin.Color =
    Ptrcall.call0[gdext.builtin.Color](MethodBind.get("Environment", "get_ambient_light_color", 3444240500L), hostObject.objectPtr)
  ...
  final def setFogLightColor(light_color: gdext.builtin.Color): Unit =
  ...
  final def getFogLightColor(): gdext.builtin.Color =
    Ptrcall.call0[gdext.builtin.Color](MethodBind.get("Environment", "get_fog_light_color", 3444240500L), hostObject.objectPtr)
  ...
  final def setVolumetricFogEmission(color: gdext.builtin.Color): Unit =
  ...
  final def getVolumetricFogEmission(): gdext.builtin.Color =
    Ptrcall.call0[gdext.builtin.Color](MethodBind.get("Environment", "get_volumetric_fog_emission", 3444240500L), hostObject.objectPtr)

  /** Environment.set_volumetric_fog_albedo */
  final def setVolumetricFogAlbedo(color: gdext.builtin.Color): Unit =
  ...
  final def getVolumetricFogAlbedo(): gdext.builtin.Color =
    Ptrcall.call0[gdext.builtin.Color](MethodBind.get("Environment", "get_volumetric_fog_albedo", 3444240500L), hostObject.objectPtr)
