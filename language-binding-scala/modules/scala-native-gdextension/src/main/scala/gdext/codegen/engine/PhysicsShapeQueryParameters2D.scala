...
abstract class PhysicsShapeQueryParameters2D extends RefCounted {
  ...
  final def getTransform(): gdext.builtin.Transform2D =
    Ptrcall.call0[gdext.builtin.Transform2D](MethodBind.get("PhysicsShapeQueryParameters2D", "get_transform", 3814499831L), hostObject.objectPtr)
  ...
  final def getMotion(): gdext.builtin.Vector2 =
    Ptrcall.call0[gdext.builtin.Vector2](MethodBind.get("PhysicsShapeQueryParameters2D", "get_motion", 3341600327L), hostObject.objectPtr)
