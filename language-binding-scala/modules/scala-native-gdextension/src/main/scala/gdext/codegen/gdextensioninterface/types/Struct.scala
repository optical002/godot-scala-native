...
object GDExtensionInstanceBindingCallbacks {
  ...
  extension (struct: GDExtensionInstanceBindingCallbacks) {
    ...
    def create_callback_=(v: GDExtensionInstanceBindingCreateCallback) = struct._1_=(v)
    def at_create_callback: Ptr[GDExtensionInstanceBindingCreateCallback] = struct.at1

    def free_callback: GDExtensionInstanceBindingFreeCallback = struct._2
    def free_callback_=(v: GDExtensionInstanceBindingFreeCallback) = struct._2_=(v)
    def at_free_callback: Ptr[GDExtensionInstanceBindingFreeCallback] = struct.at2

    def reference_callback: GDExtensionInstanceBindingReferenceCallback = struct._3
    def reference_callback_=(v: GDExtensionInstanceBindingReferenceCallback) = struct._3_=(v)
    def at_reference_callback: Ptr[GDExtensionInstanceBindingReferenceCallback] = struct.at3
...
object GDExtensionClassCreationInfo {
  ...
  extension (struct: GDExtensionClassCreationInfo) {
    ...
    def get_property_list_func_=(v: GDExtensionClassGetPropertyList) = struct._5_=(v)
    def at_get_property_list_func: Ptr[GDExtensionClassGetPropertyList] = struct.at5

    def free_property_list_func: GDExtensionClassFreePropertyList = struct._6
    def free_property_list_func_=(v: GDExtensionClassFreePropertyList) = struct._6_=(v)
    def at_free_property_list_func: Ptr[GDExtensionClassFreePropertyList] = struct.at6

    def property_can_revert_func: GDExtensionClassPropertyCanRevert = struct._7
    def property_can_revert_func_=(v: GDExtensionClassPropertyCanRevert) = struct._7_=(v)
    def at_property_can_revert_func: Ptr[GDExtensionClassPropertyCanRevert] = struct.at7

    def property_get_revert_func: GDExtensionClassPropertyGetRevert = struct._8
    def property_get_revert_func_=(v: GDExtensionClassPropertyGetRevert) = struct._8_=(v)
    def at_property_get_revert_func: Ptr[GDExtensionClassPropertyGetRevert] = struct.at8
    ...
    def create_instance_func_=(v: GDExtensionClassCreateInstance) = struct._13_=(v)
    def at_create_instance_func: Ptr[GDExtensionClassCreateInstance] = struct.at13
    ...
    def class_userdata: CVoidPtr = struct._17
    def class_userdata_=(v: CVoidPtr) = struct._17_=(v)
    def at_class_userdata: Ptr[CVoidPtr] = struct.at17
...
object GDExtensionClassCreationInfo2 {
  ...
  extension (struct: GDExtensionClassCreationInfo2) {
    ...
    def get_property_list_func_=(v: GDExtensionClassGetPropertyList) = struct._6_=(v)
    def at_get_property_list_func: Ptr[GDExtensionClassGetPropertyList] = struct.at6

    def free_property_list_func: GDExtensionClassFreePropertyList = struct._7
    def free_property_list_func_=(v: GDExtensionClassFreePropertyList) = struct._7_=(v)
    def at_free_property_list_func: Ptr[GDExtensionClassFreePropertyList] = struct.at7

    def property_can_revert_func: GDExtensionClassPropertyCanRevert = struct._8
    def property_can_revert_func_=(v: GDExtensionClassPropertyCanRevert) = struct._8_=(v)
    def at_property_can_revert_func: Ptr[GDExtensionClassPropertyCanRevert] = struct.at8

    def property_get_revert_func: GDExtensionClassPropertyGetRevert = struct._9
    def property_get_revert_func_=(v: GDExtensionClassPropertyGetRevert) = struct._9_=(v)
    def at_property_get_revert_func: Ptr[GDExtensionClassPropertyGetRevert] = struct.at9

    def validate_property_func: GDExtensionClassValidateProperty = struct._10
    def validate_property_func_=(v: GDExtensionClassValidateProperty) = struct._10_=(v)
    def at_validate_property_func: Ptr[GDExtensionClassValidateProperty] = struct.at10
    ...
    def create_instance_func_=(v: GDExtensionClassCreateInstance) = struct._15_=(v)
    def at_create_instance_func: Ptr[GDExtensionClassCreateInstance] = struct.at15
    ...
    def recreate_instance_func_=(v: GDExtensionClassRecreateInstance) = struct._17_=(v)
    def at_recreate_instance_func: Ptr[GDExtensionClassRecreateInstance] = struct.at17
    ...
    def get_virtual_call_data_func: GDExtensionClassGetVirtualCallData = struct._19
    def get_virtual_call_data_func_=(v: GDExtensionClassGetVirtualCallData) = struct._19_=(v)
    def at_get_virtual_call_data_func: Ptr[GDExtensionClassGetVirtualCallData] = struct.at19

    def call_virtual_with_data_func: GDExtensionClassCallVirtualWithData = struct._20
    def call_virtual_with_data_func_=(v: GDExtensionClassCallVirtualWithData) = struct._20_=(v)
    def at_call_virtual_with_data_func: Ptr[GDExtensionClassCallVirtualWithData] = struct.at20
    ...
    def class_userdata: CVoidPtr = struct._22
    def class_userdata_=(v: CVoidPtr) = struct._22_=(v)
    def at_class_userdata: Ptr[CVoidPtr] = struct.at22
...
object GDExtensionClassCreationInfo3 {
  ...
  extension (struct: GDExtensionClassCreationInfo3) {
    ...
    def get_property_list_func_=(v: GDExtensionClassGetPropertyList) = struct._7_=(v)
    def at_get_property_list_func: Ptr[GDExtensionClassGetPropertyList] = struct.at7

    def free_property_list_func: GDExtensionClassFreePropertyList2 = struct._8
    def free_property_list_func_=(v: GDExtensionClassFreePropertyList2) = struct._8_=(v)
    def at_free_property_list_func: Ptr[GDExtensionClassFreePropertyList2] = struct.at8

    def property_can_revert_func: GDExtensionClassPropertyCanRevert = struct._9
    def property_can_revert_func_=(v: GDExtensionClassPropertyCanRevert) = struct._9_=(v)
    def at_property_can_revert_func: Ptr[GDExtensionClassPropertyCanRevert] = struct.at9

    def property_get_revert_func: GDExtensionClassPropertyGetRevert = struct._10
    def property_get_revert_func_=(v: GDExtensionClassPropertyGetRevert) = struct._10_=(v)
    def at_property_get_revert_func: Ptr[GDExtensionClassPropertyGetRevert] = struct.at10

    def validate_property_func: GDExtensionClassValidateProperty = struct._11
    def validate_property_func_=(v: GDExtensionClassValidateProperty) = struct._11_=(v)
    def at_validate_property_func: Ptr[GDExtensionClassValidateProperty] = struct.at11
    ...
    def create_instance_func_=(v: GDExtensionClassCreateInstance) = struct._16_=(v)
    def at_create_instance_func: Ptr[GDExtensionClassCreateInstance] = struct.at16
    ...
    def recreate_instance_func_=(v: GDExtensionClassRecreateInstance) = struct._18_=(v)
    def at_recreate_instance_func: Ptr[GDExtensionClassRecreateInstance] = struct.at18
    ...
    def get_virtual_call_data_func: GDExtensionClassGetVirtualCallData = struct._20
    def get_virtual_call_data_func_=(v: GDExtensionClassGetVirtualCallData) = struct._20_=(v)
    def at_get_virtual_call_data_func: Ptr[GDExtensionClassGetVirtualCallData] = struct.at20

    def call_virtual_with_data_func: GDExtensionClassCallVirtualWithData = struct._21
    def call_virtual_with_data_func_=(v: GDExtensionClassCallVirtualWithData) = struct._21_=(v)
    def at_call_virtual_with_data_func: Ptr[GDExtensionClassCallVirtualWithData] = struct.at21
    ...
    def class_userdata: CVoidPtr = struct._23
    def class_userdata_=(v: CVoidPtr) = struct._23_=(v)
    def at_class_userdata: Ptr[CVoidPtr] = struct.at23
...
object GDExtensionClassCreationInfo4 {
  ...
  extension (struct: GDExtensionClassCreationInfo4) {
    ...
    def get_property_list_func_=(v: GDExtensionClassGetPropertyList) = struct._8_=(v)
    def at_get_property_list_func: Ptr[GDExtensionClassGetPropertyList] = struct.at8

    def free_property_list_func: GDExtensionClassFreePropertyList2 = struct._9
    def free_property_list_func_=(v: GDExtensionClassFreePropertyList2) = struct._9_=(v)
    def at_free_property_list_func: Ptr[GDExtensionClassFreePropertyList2] = struct.at9

    def property_can_revert_func: GDExtensionClassPropertyCanRevert = struct._10
    def property_can_revert_func_=(v: GDExtensionClassPropertyCanRevert) = struct._10_=(v)
    def at_property_can_revert_func: Ptr[GDExtensionClassPropertyCanRevert] = struct.at10

    def property_get_revert_func: GDExtensionClassPropertyGetRevert = struct._11
    def property_get_revert_func_=(v: GDExtensionClassPropertyGetRevert) = struct._11_=(v)
    def at_property_get_revert_func: Ptr[GDExtensionClassPropertyGetRevert] = struct.at11

    def validate_property_func: GDExtensionClassValidateProperty = struct._12
    def validate_property_func_=(v: GDExtensionClassValidateProperty) = struct._12_=(v)
    def at_validate_property_func: Ptr[GDExtensionClassValidateProperty] = struct.at12
    ...
    def create_instance_func_=(v: GDExtensionClassCreateInstance2) = struct._17_=(v)
    def at_create_instance_func: Ptr[GDExtensionClassCreateInstance2] = struct.at17
    ...
    def recreate_instance_func_=(v: GDExtensionClassRecreateInstance) = struct._19_=(v)
    def at_recreate_instance_func: Ptr[GDExtensionClassRecreateInstance] = struct.at19
    ...
    def get_virtual_call_data_func: GDExtensionClassGetVirtualCallData2 = struct._21
    def get_virtual_call_data_func_=(v: GDExtensionClassGetVirtualCallData2) = struct._21_=(v)
    def at_get_virtual_call_data_func: Ptr[GDExtensionClassGetVirtualCallData2] = struct.at21

    def call_virtual_with_data_func: GDExtensionClassCallVirtualWithData = struct._22
    def call_virtual_with_data_func_=(v: GDExtensionClassCallVirtualWithData) = struct._22_=(v)
    def at_call_virtual_with_data_func: Ptr[GDExtensionClassCallVirtualWithData] = struct.at22
...
object GDExtensionClassMethodInfo {
  ...
  extension (struct: GDExtensionClassMethodInfo) {
    ...
    def method_userdata: CVoidPtr = struct._2
    def method_userdata_=(v: CVoidPtr) = struct._2_=(v)
    def at_method_userdata: Ptr[CVoidPtr] = struct.at2
    ...
    def return_value_metadata_=(v: GDExtensionClassMethodArgumentMetadata) = struct._8_=(v)
    def at_return_value_metadata: Ptr[GDExtensionClassMethodArgumentMetadata] = struct.at8
    ...
    def arguments_metadata_=(v: Ptr[GDExtensionClassMethodArgumentMetadata]) = struct._11_=(v)
    def at_arguments_metadata: Ptr[Ptr[GDExtensionClassMethodArgumentMetadata]] = struct.at11
...
object GDExtensionClassVirtualMethodInfo {
  ...
  extension (struct: GDExtensionClassVirtualMethodInfo) {
    ...
    def return_value_metadata: GDExtensionClassMethodArgumentMetadata = struct._4
    def return_value_metadata_=(v: GDExtensionClassMethodArgumentMetadata) = struct._4_=(v)
    def at_return_value_metadata: Ptr[GDExtensionClassMethodArgumentMetadata] = struct.at4
    ...
    def arguments_metadata: Ptr[GDExtensionClassMethodArgumentMetadata] = struct._7
    def arguments_metadata_=(v: Ptr[GDExtensionClassMethodArgumentMetadata]) = struct._7_=(v)
    def at_arguments_metadata: Ptr[Ptr[GDExtensionClassMethodArgumentMetadata]] = struct.at7
...
object GDExtensionCallableCustomInfo {
  ...
  extension (struct: GDExtensionCallableCustomInfo) {
    ...
    def callable_userdata: CVoidPtr = struct._1
    def callable_userdata_=(v: CVoidPtr) = struct._1_=(v)
    def at_callable_userdata: Ptr[CVoidPtr] = struct.at1

    def token: CVoidPtr = struct._2
    def token_=(v: CVoidPtr) = struct._2_=(v)
    def at_token: Ptr[CVoidPtr] = struct.at2
...
object GDExtensionCallableCustomInfo2 {
  ...
  extension (struct: GDExtensionCallableCustomInfo2) {
    ...
    def get_argument_count_func: GDExtensionCallableCustomGetArgumentCount = struct._11
    def get_argument_count_func_=(v: GDExtensionCallableCustomGetArgumentCount) = struct._11_=(v)
    def at_get_argument_count_func: Ptr[GDExtensionCallableCustomGetArgumentCount] = struct.at11
...
object GDExtensionScriptInstanceInfo {
  ...
  extension (struct: GDExtensionScriptInstanceInfo) {
    ...
    def get_property_list_func: GDExtensionScriptInstanceGetPropertyList = struct._3
    def get_property_list_func_=(v: GDExtensionScriptInstanceGetPropertyList) = struct._3_=(v)
    def at_get_property_list_func: Ptr[GDExtensionScriptInstanceGetPropertyList] = struct.at3

    def free_property_list_func: GDExtensionScriptInstanceFreePropertyList = struct._4
    def free_property_list_func_=(v: GDExtensionScriptInstanceFreePropertyList) = struct._4_=(v)
    def at_free_property_list_func: Ptr[GDExtensionScriptInstanceFreePropertyList] = struct.at4

    def property_can_revert_func: GDExtensionScriptInstancePropertyCanRevert = struct._5
    def property_can_revert_func_=(v: GDExtensionScriptInstancePropertyCanRevert) = struct._5_=(v)
    def at_property_can_revert_func: Ptr[GDExtensionScriptInstancePropertyCanRevert] = struct.at5

    def property_get_revert_func: GDExtensionScriptInstancePropertyGetRevert = struct._6
    def property_get_revert_func_=(v: GDExtensionScriptInstancePropertyGetRevert) = struct._6_=(v)
    def at_property_get_revert_func: Ptr[GDExtensionScriptInstancePropertyGetRevert] = struct.at6
    ...
    def get_property_state_func: GDExtensionScriptInstanceGetPropertyState = struct._8
    def get_property_state_func_=(v: GDExtensionScriptInstanceGetPropertyState) = struct._8_=(v)
    def at_get_property_state_func: Ptr[GDExtensionScriptInstanceGetPropertyState] = struct.at8

    def get_method_list_func: GDExtensionScriptInstanceGetMethodList = struct._9
    def get_method_list_func_=(v: GDExtensionScriptInstanceGetMethodList) = struct._9_=(v)
    def at_get_method_list_func: Ptr[GDExtensionScriptInstanceGetMethodList] = struct.at9

    def free_method_list_func: GDExtensionScriptInstanceFreeMethodList = struct._10
    def free_method_list_func_=(v: GDExtensionScriptInstanceFreeMethodList) = struct._10_=(v)
    def at_free_method_list_func: Ptr[GDExtensionScriptInstanceFreeMethodList] = struct.at10

    def get_property_type_func: GDExtensionScriptInstanceGetPropertyType = struct._11
    def get_property_type_func_=(v: GDExtensionScriptInstanceGetPropertyType) = struct._11_=(v)
    def at_get_property_type_func: Ptr[GDExtensionScriptInstanceGetPropertyType] = struct.at11

    def has_method_func: GDExtensionScriptInstanceHasMethod = struct._12
    def has_method_func_=(v: GDExtensionScriptInstanceHasMethod) = struct._12_=(v)
    def at_has_method_func: Ptr[GDExtensionScriptInstanceHasMethod] = struct.at12
    ...
    def notification_func_=(v: GDExtensionScriptInstanceNotification) = struct._14_=(v)
    def at_notification_func: Ptr[GDExtensionScriptInstanceNotification] = struct.at14
    ...
    def refcount_incremented_func: GDExtensionScriptInstanceRefCountIncremented = struct._16
    def refcount_incremented_func_=(v: GDExtensionScriptInstanceRefCountIncremented) = struct._16_=(v)
    def at_refcount_incremented_func: Ptr[GDExtensionScriptInstanceRefCountIncremented] = struct.at16

    def refcount_decremented_func: GDExtensionScriptInstanceRefCountDecremented = struct._17
    def refcount_decremented_func_=(v: GDExtensionScriptInstanceRefCountDecremented) = struct._17_=(v)
    def at_refcount_decremented_func: Ptr[GDExtensionScriptInstanceRefCountDecremented] = struct.at17

    def get_script_func: GDExtensionScriptInstanceGetScript = struct._18
    def get_script_func_=(v: GDExtensionScriptInstanceGetScript) = struct._18_=(v)
    def at_get_script_func: Ptr[GDExtensionScriptInstanceGetScript] = struct.at18

    def is_placeholder_func: GDExtensionScriptInstanceIsPlaceholder = struct._19
    def is_placeholder_func_=(v: GDExtensionScriptInstanceIsPlaceholder) = struct._19_=(v)
    def at_is_placeholder_func: Ptr[GDExtensionScriptInstanceIsPlaceholder] = struct.at19
    ...
    def get_language_func_=(v: GDExtensionScriptInstanceGetLanguage) = struct._22_=(v)
    def at_get_language_func: Ptr[GDExtensionScriptInstanceGetLanguage] = struct.at22
...
object GDExtensionScriptInstanceInfo2 {
  ...
  extension (struct: GDExtensionScriptInstanceInfo2) {
    ...
    def get_class_category_func: GDExtensionScriptInstanceGetClassCategory = struct._5
    def get_class_category_func_=(v: GDExtensionScriptInstanceGetClassCategory) = struct._5_=(v)
    def at_get_class_category_func: Ptr[GDExtensionScriptInstanceGetClassCategory] = struct.at5

    def property_can_revert_func: GDExtensionScriptInstancePropertyCanRevert = struct._6
    def property_can_revert_func_=(v: GDExtensionScriptInstancePropertyCanRevert) = struct._6_=(v)
    def at_property_can_revert_func: Ptr[GDExtensionScriptInstancePropertyCanRevert] = struct.at6

    def property_get_revert_func: GDExtensionScriptInstancePropertyGetRevert = struct._7
    def property_get_revert_func_=(v: GDExtensionScriptInstancePropertyGetRevert) = struct._7_=(v)
    def at_property_get_revert_func: Ptr[GDExtensionScriptInstancePropertyGetRevert] = struct.at7
    ...
    def get_property_state_func: GDExtensionScriptInstanceGetPropertyState = struct._9
    def get_property_state_func_=(v: GDExtensionScriptInstanceGetPropertyState) = struct._9_=(v)
    def at_get_property_state_func: Ptr[GDExtensionScriptInstanceGetPropertyState] = struct.at9

    def get_method_list_func: GDExtensionScriptInstanceGetMethodList = struct._10
    def get_method_list_func_=(v: GDExtensionScriptInstanceGetMethodList) = struct._10_=(v)
    def at_get_method_list_func: Ptr[GDExtensionScriptInstanceGetMethodList] = struct.at10

    def free_method_list_func: GDExtensionScriptInstanceFreeMethodList = struct._11
    def free_method_list_func_=(v: GDExtensionScriptInstanceFreeMethodList) = struct._11_=(v)
    def at_free_method_list_func: Ptr[GDExtensionScriptInstanceFreeMethodList] = struct.at11

    def get_property_type_func: GDExtensionScriptInstanceGetPropertyType = struct._12
    def get_property_type_func_=(v: GDExtensionScriptInstanceGetPropertyType) = struct._12_=(v)
    def at_get_property_type_func: Ptr[GDExtensionScriptInstanceGetPropertyType] = struct.at12

    def validate_property_func: GDExtensionScriptInstanceValidateProperty = struct._13
    def validate_property_func_=(v: GDExtensionScriptInstanceValidateProperty) = struct._13_=(v)
    def at_validate_property_func: Ptr[GDExtensionScriptInstanceValidateProperty] = struct.at13

    def has_method_func: GDExtensionScriptInstanceHasMethod = struct._14
    def has_method_func_=(v: GDExtensionScriptInstanceHasMethod) = struct._14_=(v)
    def at_has_method_func: Ptr[GDExtensionScriptInstanceHasMethod] = struct.at14
    ...
    def notification_func_=(v: GDExtensionScriptInstanceNotification2) = struct._16_=(v)
    def at_notification_func: Ptr[GDExtensionScriptInstanceNotification2] = struct.at16
    ...
    def refcount_incremented_func: GDExtensionScriptInstanceRefCountIncremented = struct._18
    def refcount_incremented_func_=(v: GDExtensionScriptInstanceRefCountIncremented) = struct._18_=(v)
    def at_refcount_incremented_func: Ptr[GDExtensionScriptInstanceRefCountIncremented] = struct.at18

    def refcount_decremented_func: GDExtensionScriptInstanceRefCountDecremented = struct._19
    def refcount_decremented_func_=(v: GDExtensionScriptInstanceRefCountDecremented) = struct._19_=(v)
    def at_refcount_decremented_func: Ptr[GDExtensionScriptInstanceRefCountDecremented] = struct.at19

    def get_script_func: GDExtensionScriptInstanceGetScript = struct._20
    def get_script_func_=(v: GDExtensionScriptInstanceGetScript) = struct._20_=(v)
    def at_get_script_func: Ptr[GDExtensionScriptInstanceGetScript] = struct.at20

    def is_placeholder_func: GDExtensionScriptInstanceIsPlaceholder = struct._21
    def is_placeholder_func_=(v: GDExtensionScriptInstanceIsPlaceholder) = struct._21_=(v)
    def at_is_placeholder_func: Ptr[GDExtensionScriptInstanceIsPlaceholder] = struct.at21
    ...
    def get_language_func_=(v: GDExtensionScriptInstanceGetLanguage) = struct._24_=(v)
    def at_get_language_func: Ptr[GDExtensionScriptInstanceGetLanguage] = struct.at24
...
object GDExtensionScriptInstanceInfo3 {
  ...
  extension (struct: GDExtensionScriptInstanceInfo3) {
    ...
    def free_property_list_func: GDExtensionScriptInstanceFreePropertyList2 = struct._4
    def free_property_list_func_=(v: GDExtensionScriptInstanceFreePropertyList2) = struct._4_=(v)
    def at_free_property_list_func: Ptr[GDExtensionScriptInstanceFreePropertyList2] = struct.at4
    ...
    def free_method_list_func: GDExtensionScriptInstanceFreeMethodList2 = struct._11
    def free_method_list_func_=(v: GDExtensionScriptInstanceFreeMethodList2) = struct._11_=(v)
    def at_free_method_list_func: Ptr[GDExtensionScriptInstanceFreeMethodList2] = struct.at11
    ...
    def get_method_argument_count_func: GDExtensionScriptInstanceGetMethodArgumentCount = struct._15
    def get_method_argument_count_func_=(v: GDExtensionScriptInstanceGetMethodArgumentCount) = struct._15_=(v)
    def at_get_method_argument_count_func: Ptr[GDExtensionScriptInstanceGetMethodArgumentCount] = struct.at15
    ...
    def notification_func_=(v: GDExtensionScriptInstanceNotification2) = struct._17_=(v)
    def at_notification_func: Ptr[GDExtensionScriptInstanceNotification2] = struct.at17
    ...
    def refcount_incremented_func: GDExtensionScriptInstanceRefCountIncremented = struct._19
    def refcount_incremented_func_=(v: GDExtensionScriptInstanceRefCountIncremented) = struct._19_=(v)
    def at_refcount_incremented_func: Ptr[GDExtensionScriptInstanceRefCountIncremented] = struct.at19

    def refcount_decremented_func: GDExtensionScriptInstanceRefCountDecremented = struct._20
    def refcount_decremented_func_=(v: GDExtensionScriptInstanceRefCountDecremented) = struct._20_=(v)
    def at_refcount_decremented_func: Ptr[GDExtensionScriptInstanceRefCountDecremented] = struct.at20

    def get_script_func: GDExtensionScriptInstanceGetScript = struct._21
    def get_script_func_=(v: GDExtensionScriptInstanceGetScript) = struct._21_=(v)
    def at_get_script_func: Ptr[GDExtensionScriptInstanceGetScript] = struct.at21

    def is_placeholder_func: GDExtensionScriptInstanceIsPlaceholder = struct._22
    def is_placeholder_func_=(v: GDExtensionScriptInstanceIsPlaceholder) = struct._22_=(v)
    def at_is_placeholder_func: Ptr[GDExtensionScriptInstanceIsPlaceholder] = struct.at22
    ...
    def get_language_func_=(v: GDExtensionScriptInstanceGetLanguage) = struct._25_=(v)
    def at_get_language_func: Ptr[GDExtensionScriptInstanceGetLanguage] = struct.at25
...
object GDExtensionInitialization {
  ...
  extension (struct: GDExtensionInitialization) {
    ...
    def minimum_initialization_level_=(v: GDExtensionInitializationLevel) = struct._1_=(v)
    def at_minimum_initialization_level: Ptr[GDExtensionInitializationLevel] = struct.at1

    def userdata: CVoidPtr = struct._2
    def userdata_=(v: CVoidPtr) = struct._2_=(v)
    def at_userdata: Ptr[CVoidPtr] = struct.at2
