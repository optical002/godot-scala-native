...
opaque type Object = GodotObject

object Object {
  /** Wrap a raw object handle as a `Object` (no checked cast). */
  def fromObject(o: GodotObject): Object = o

  /** Class metadata for Gd[Object] lifetime management and casting. */
  given GodotClass[Object] with {
    def className = "Object"
    def isRefCounted = false
    def wrap(o: GodotObject): Object = o
    def unwrap(t: Object): GodotObject = t
  }
